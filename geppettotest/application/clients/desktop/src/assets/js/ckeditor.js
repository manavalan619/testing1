...
(function () {
  window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function () {
      var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
        e = {
          ...
          basePath: function () {
            ...
            if (!b)
              for (var c = document.getElementsByTagName("script"), e = 0; e < c.length; e++) {
                var g = c[e].src.match(a);
                if (g) {
                  b = g[1];
                  break
                }
          ...
          on: function (b, d, e, k, g) {
            ...
            if (0 > f.getListenerIndex(d)) {
              ...
              for (var p = f.length - 1; 0 <= p; p--)
                if (f[p].priority <= g) return f.splice(p + 1, 0, h), {
                  removeListener: m
                };
              f.unshift(h)
            }
          ...
          fire: function () {
            ...
            return function (g, h, m) {
              ...
              if (f) {
                var p = f.listeners;
                if (p.length)
                  for (var p = p.slice(0), r, v = 0; v < p.length; v++) {
                    if (f.errorProof) try {
                      r = p[v].call(this, m, h, b, k)
                    } catch (x) {} else r = p[v].call(this, m, h, b, k);
      ...
      if (window.console && window.console.log) {
        ...
        console[e]("[CKEDITOR] For more information about this error go to https://docs.ckeditor.com/ckeditor4/docs/#!/guide/dev_errors-section-" + b)
      }
    }, null, null, 999), CKEDITOR.dom = {}, function () {
      var a = [],
        e = CKEDITOR.env.gecko ?
        ...
        h = function (a, f) {
          return "#" == f[0] ? String.fromCharCode(parseInt(f.slice(1), 10)) : g[f]
        };
      ...
      CKEDITOR.tools = {
        ...
        extend: function (a) {
          var f = arguments.length,
            b, g;
          "boolean" == typeof (b = arguments[f - 1]) ? f-- : "boolean" == typeof (b = arguments[f - 2]) && (g = arguments[f - 1], f -= 2);
          for (var h = 1; h < f; h++) {
            var c = arguments[h],
              d;
            for (d in c)
        ...
        cssStyleToDomStyle: function () {
          ...
          return function (a) {
            return "float" == a ? f : a.replace(/-./g, function (f) {
        ...
        buildStyleHtml: function (a) {
          a = [].concat(a);
          for (var f, b = [], g = 0; g < a.length; g++)
            if (f = a[g]) /@import|[{}]/.test(f) ? b.push("\x3cstyle\x3e" +
              f + "\x3c/style\x3e") : b.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + f + '"\x3e');
          return b.join("")
        },
        ...
        transformPlainTextToHtml: function (a, f) {
          ...
          if (!b) {
            var c = /\n{2}/g;
            if (c.test(g)) var d = "\x3c" + h + "\x3e",
              e = "\x3c/" + h + "\x3e",
              g = d + g.replace(c, function () {
                return e + d
              }) + e
          }
          g = g.replace(/\n/g, "\x3cbr\x3e");
          b || (g = g.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + h + "\x3e)"), function (f) {
            return CKEDITOR.tools.repeat(f, 2)
          }));
          g = g.replace(/^ | $/g, "\x26nbsp;");
          return g = g.replace(/(>|\s) /g, function (f, a) {
            return a + "\x26nbsp;"
          }).replace(/ (?=<)/g,
            "\x26nbsp;")
        },
        ...
        createClass: function (a) {
          ...
          if (g) var c = f,
            f = function () {
              ...
              for (a in g) {
                var b = g[a];
                f[a] = "function" == typeof b ? CKEDITOR.tools.bind(b, this) : b
              }
        ...
        normalizeCssText: function (a, f) {
          var b = [],
            g, h = CKEDITOR.tools.parseCssText(a, !0, f);
          for (g in h) b.push(g + ":" + h[g]);
          b.sort();
          return b.length ? b.join(";") + ";" : ""
        },
        convertRgbToHex: function (a) {
          return a.replace(/(?:rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\))/gi, function (f, a, b, g) {
            f = [a, b, g];
            for (a = 0; 3 > a; a++) f[a] = ("0" + parseInt(f[a], 10).toString(16)).slice(-2);
            return "#" + f.join("")
          })
        },
        ...
        parseCssText: function (a, f, b) {
          ...
          a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, b, h) {
            f && (b = b.toLowerCase(), "font-family" == b && (h = h.replace(/\s*,\s*/g,
        ...
        convertArrayToObject: function (a, f) {
          ...
          for (var g = 0, h = a.length; g < h; ++g) b[a[g]] = f;
          return b
        },
        fixDomain: function () {
          for (var a;;) try {
        ...
        enableHtml5Elements: function (a, f) {
          for (var b = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "),
              g = b.length, h; g--;) h = a.createElement(b[g]), f && a.appendChild(h)
        },
        checkIfAnyArrayItemMatches: function (a, f) {
          for (var b = 0, g = a.length; b < g; ++b)
            if (a[b].match(f)) return !0;
          return !1
        },
        checkIfAnyObjectPropertyMatches: function (a, f) {
          for (var b in a)
            if (b.match(f)) return !0;
          return !1
        },
        keystrokeToString: function (a, f) {
          var b = this.keystrokeToArray(a, f);
        ...
        keystrokeToArray: function (a, f) {
          ...
          b & CKEDITOR.CTRL && (c.push(h ?
            "⌘" : a[17]), d.push(h ? a[224] : a[17]));
          b & CKEDITOR.ALT && (c.push(h ? "⌥" : a[18]), d.push(a[18]));
          b & CKEDITOR.SHIFT && (c.push(h ? "⇧" : a[16]), d.push(a[16]));
          g && (a[g] ? (c.push(a[g]), d.push(a[g])) : (c.push(String.fromCharCode(g)), d.push(String.fromCharCode(g))));
          return {
            display: c,
            aria: d
          }
        ...
        getCookie: function (a) {
          a = a.toLowerCase();
          for (var f = document.cookie.split(";"), b, g, h = 0; h < f.length; h++)
            if (b = f[h].split("\x3d"),
              g = decodeURIComponent(CKEDITOR.tools.trim(b[0]).toLowerCase()), g === a) return decodeURIComponent(1 < b.length ? b[1] : "");
          return null
        },
        setCookie: function (a, f) {
          document.cookie = encodeURIComponent(a) + "\x3d" + encodeURIComponent(f) + ";path\x3d/"
        },
        getCsrfToken: function () {
          ...
          if (!a || 40 != a.length) {
            ...
            if (window.crypto && window.crypto.getRandomValues) a = new Uint8Array(40), window.crypto.getRandomValues(a);
              ...
              for (var b = 0; 40 > b; b++) a.push(Math.floor(256 * Math.random()));
            for (b = 0; b < a.length; b++) var g = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[b] % 36),
              f = f + (.5 < Math.random() ? g.toUpperCase() : g);
            a = f;
        ...
        convertHexStringToBytes: function (a) {
          var f = [],
            b = a.length / 2,
            g;
          for (g = 0; g < b; g++) f.push(parseInt(a.substr(2 * g, 2), 16));
          return f
        },
        convertBytesToBase64: function (a) {
          ...
          for (g = 0; g < b; g += 3) {
            ...
            d[3] = h[2] & 63;
            for (e = 0; 4 > e; e++) f = e <= c ? f + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d[e]) : f +
              "\x3d"
          }
          return f
        },
        style: {
          parse: {
            ...
            background: function (a) {
              var f = {},
                b = this._findColor(a);
              b.length && (f.color = b[0], CKEDITOR.tools.array.forEach(b, function (f) {
                a = a.replace(f, "")
              }));
            ...
            _findColor: function (a) {
              ...
              return f = f.concat(b.filter(a.split(/\s+/), function (a) {
        ...
        array: {
          filter: function (a, f, b) {
            var g = [];
            this.forEach(a, function (h, c) {
              f.call(b, h, c, a) && g.push(h)
            });
            return g
          },
          forEach: function (a, f, b) {
            var g = a.length,
              h;
            for (h = 0; h < g; h++) f.call(b,
              a[h], h, a)
          },
          map: function (a, f, b) {
            for (var g = [], h = 0; h < a.length; h++) g.push(f.call(b, a[h], h, a));
            return g
          },
          reduce: function (a, f, b, g) {
            for (var h = 0; h < a.length; h++) b = f.call(g, b, a[h], h, a);
            return b
          },
          every: function (a, f, b) {
        ...
        object: {
          ...
          merge: function (a, f) {
            var b = CKEDITOR.tools,
              g = b.clone(a),
              h = b.clone(f);
            b.array.forEach(b.objectKeys(h), function (a) {
              g[a] =
                "object" === typeof h[a] && "object" === typeof g[a] ? b.object.merge(g[a], h[a]) : h[a]
            });
            return g
          }
        }
    ...
    new CKEDITOR.dom.domObject, CKEDITOR.NODE_ELEMENT = 1, CKEDITOR.NODE_DOCUMENT = 9, CKEDITOR.NODE_TEXT = 3, CKEDITOR.NODE_COMMENT = 8, CKEDITOR.NODE_DOCUMENT_FRAGMENT = 11, CKEDITOR.POSITION_IDENTICAL = 0, CKEDITOR.POSITION_DISCONNECTED = 1, CKEDITOR.POSITION_FOLLOWING = 2, CKEDITOR.POSITION_PRECEDING = 4, CKEDITOR.POSITION_IS_CONTAINED = 8, CKEDITOR.POSITION_CONTAINS = 16, CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
      ...
      clone: function (a, e) {
        function b(c) {
          ...
          if (c.nodeType == CKEDITOR.NODE_ELEMENT || c.nodeType == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
            if (e || c.nodeType != CKEDITOR.NODE_ELEMENT || c.removeAttribute("id", !1), a) {
              c = c.childNodes;
      ...
      getIndex: function (a) {
        function e(a, g) {
          var h = g ? a.nextSibling : a.previousSibling;
          return h && h.nodeType == CKEDITOR.NODE_TEXT ? b(h) ? e(h, g) : h : null
        }
        ...
        var c = this.$,
          ...
          l;
        if (!this.$.parentNode ||
          a && c.nodeType == CKEDITOR.NODE_TEXT && b(c) && !e(c) && !e(c, !0)) return -1;
      ...
      getNextSourceNode: function (a, e, b) {
        ...
        return !a ||
          b && !1 === b(a) ? null : e && e != a.type ? a.getNextSourceNode(!1, e, b) : a
      },
      ...
      getPrevious: function (a) {
        var e = this.$,
          b;
        do b = (e =
          e.previousSibling) && 10 != e.nodeType && new CKEDITOR.dom.node(e); while (b && a && !a(b));
        return b
      },
      getNext: function (a) {
        var e = this.$,
        ...
        for (var b = this.$.documentElement, c = 0; b && c < a.length; c++) {
          ...
          if (e)
            for (var l = -1, k = 0; k < b.childNodes.length; k++) {
              ...
              if (!0 !== e || 3 != g.nodeType || !g.previousSibling || 3 != g.previousSibling.nodeType)
                if (l++, l == d) {
                  b = g;
                  break
                }
      ...
      _getHtml5ShivFrag: function () {
        ...
        a || (a = this.$.createDocumentFragment(), CKEDITOR.tools.enableHtml5Elements(a,
          !0), this.setCustomData("html5ShivFrag", a));
        return a
      }
    ...
    function () {
      ...
      var d = document.createElement("_").classList,
        d = "undefined" !==
        typeof d && null !== String(d.add).match(/\[Native code\]/gi),
        l = /[\n\t\r]/g;
      CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
        ...
        removeClass: d ? function (a) {
          ...
          var h = this.getAttribute("class");
          h && a(h, b) && ((h = h.replace(new RegExp("(?:^|\\s+)" +
            b + "(?\x3d\\s|$)"), "").replace(/^\s+/, "")) ? this.setAttribute("class", h) : this.removeAttribute("class"));
          return this
        },
        hasClass: function (b) {
        ...
        mergeSiblings: function () {
          function a(b, c, f) {
            if (c && c.type == CKEDITOR.NODE_ELEMENT) {
              for (var g = []; c.data("cke-bookmark") || c.isEmptyInlineRemoveable();)
                if (g.push(c), c = f ? c.getNext() : c.getPrevious(), !c || c.type != CKEDITOR.NODE_ELEMENT) return;
              if (b.isIdentical(c)) {
                for (var d = f ? b.getLast() : b.getFirst(); g.length;) g.shift().move(b, !f);
                c.moveChildren(b, !f);
                c.remove();
        ...
        getDocumentPosition: function (a) {
          ...
          if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
            ...
            var l = this.$.getBoundingClientRect(),
              k = f.$.documentElement,
              x = k.clientTop || d.$.clientTop || 0,
              q = k.clientLeft || d.$.clientLeft || 0,
              t = !0;
            CKEDITOR.env.ie && (t = f.getDocumentElement().contains(this), f = f.getBody().contains(this), t = e && f || !e && t);
            t && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || k.scrollLeft, c = d.$.scrollTop || k.scrollTop) : (c = e ? d.$ : k, b = c.scrollLeft, c = c.scrollTop), b = l.left + b - q, c = l.top + c - x)
          } else
            for (x = this, q = null; x && "body" != x.getName() &&
              "html" != x.getName();) {
              b += x.$.offsetLeft - x.$.scrollLeft;
              c += x.$.offsetTop - x.$.scrollTop;
              x.equals(this) || (b += x.$.clientLeft || 0, c += x.$.clientTop || 0);
              for (; q && !q.equals(x);) b -= q.$.scrollLeft, c -= q.$.scrollTop, q = q.getParent();
              q = x;
              x = (l = x.$.offsetParent) ? new CKEDITOR.dom.element(l) : null
            }
          a && (l = this.getWindow(), x = a.getWindow(), !l.equals(x) && l.$.frameElement && (a = (new CKEDITOR.dom.element(l.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
        ...
        scrollIntoParent: function (a, b, c) {
          ...
          function k(b, f) {
            /body|html/.test(a.getName()) ?
              a.getWindow().$.scrollBy(b, f) : (a.$.scrollLeft += b, a.$.scrollTop += f)
          }
          ...
          function x(a, b) {
            ...
            c = a.getWindow();
            c.equals(b) || (c = x(CKEDITOR.dom.element.get(c.$.frameElement), b), f.x += c.x, f.y += c.y);
            return f
          }
          ...
          e = a.getDocument();
          var t = "BackCompat" == e.$.compatMode;
          a instanceof CKEDITOR.dom.window && (a = t ? e.getBody() : e.getDocumentElement());
          ...
          var z = a.$.clientHeight,
            w = a.$.clientWidth;
          e = d.x - q(this, "left") - u.x || 0;
          l = d.y - q(this, "top") - u.y || 0;
          f = d.x + f + q(this, "right") - (u.x + w) || 0;
          d = d.y + A + q(this, "bottom") - (u.y + z) || 0;
          (0 > l || 0 < d) && k(0, !0 === b ? l : !1 === b ? d : 0 > l ? l : d);
          c && (0 > e || 0 < f) && k(0 > e ? e : f, 0)
        },
        ...
        copyAttributes: function (a, b) {
          ...
          for (var f = 0; f < c.length; f++) {
            var d = c[f],
              ...
              l;
            if (!(e in b))
              if ("checked" == e && (l = this.getAttribute(e))) a.setAttribute(e, l);
              else if (!CKEDITOR.env.ie || this.hasAttribute(e)) l = this.getAttribute(e), null === l && (l = d.nodeValue), a.setAttribute(e, l)
          }
          "" !== this.$.style.cssText &&
    ...
    function () {
      function a(a, b) {
        ...
        if (!a && !this._.guardLTR) {
          ...
          this._.guardLTR = function (a,
            b) {
            return (!b || !k.equals(a)) && (!B || !a.equals(B)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(f.root))
          }
        }
        if (a && !this._.guardRTL) {
          var G = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
            E = d.type == CKEDITOR.NODE_ELEMENT ? g ? d.getChild(g - 1) : null : d.getPrevious();
          this._.guardRTL = function (a, b) {
            return (!b || !G.equals(a)) && (!E || !a.equals(E)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(f.root))
          }
        }
        var F = a ? this._.guardRTL : this._.guardLTR;
        e = n ? function (a, b) {
          return !1 === F(a, b) ? !1 : n(a, b)
        } : F;
        this.current ? c = this.current[l](!1,
          m, e) : (a ? c.type == CKEDITOR.NODE_ELEMENT && (c = 0 < h ? c.getChild(h - 1) : !1 === e(c, !0) ? null : c.getPreviousSourceNode(!0, m, e)) : (c = d, c.type == CKEDITOR.NODE_ELEMENT && ((c = c.getChild(g)) || (c = !1 === e(d, !0) ? null : d.getNextSourceNode(!0, m, e)))), c && !1 === e(c) && (c = null));
        for (; c && !this._.end;) {
          this.current = c;
      ...
      CKEDITOR.dom.walker.bookmark = function (a, b) {
        ...
        return function (c) {
          var d, g;
          d = c && c.type != CKEDITOR.NODE_ELEMENT && (g = c.getParent()) && f(g);
          d = a ? d : d || f(c);
          return !!(b ^ d)
        }
      };
      CKEDITOR.dom.walker.whitespaces = function (a) {
        return function (b) {
          var f;
          b && b.type == CKEDITOR.NODE_TEXT && (f = !CKEDITOR.tools.trim(b.getText()) || CKEDITOR.env.webkit && b.getText() == CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE);
          return !!(a ^ f)
        }
      };
      CKEDITOR.dom.walker.invisible = function (a) {
        ...
        return function (c) {
          b(c) ? c = 1 : (c.type == CKEDITOR.NODE_TEXT && (c = c.getParent()), c = c.$.offsetWidth <= f);
          return !!(a ^ c)
        }
      };
      ...
      CKEDITOR.dom.walker.bogus = function (a) {
        ...
        return function (f) {
          var c = CKEDITOR.env.needsBrFiller ? f.is && f.is("br") : f.getText && d.test(f.getText());
          c && (c = f.getParent(),
            f = f.getNext(b), c = c.isBlockBoundary() && (!f || f.type == CKEDITOR.NODE_ELEMENT && f.isBlockBoundary()));
          return !!(a ^ c)
        }
      };
      ...
      CKEDITOR.dom.walker.editable =
        function (a) {
          return function (b) {
            b = m(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(n) && f(b)) ? !0 : !1;
            return !!(a ^ b)
          }
        };
    ...
    function () {
      ...
      function e(a, b, c, d, g) {
        function h(a, b, f, c) {
          var d = f ? a.getPrevious() : a.getNext();
          if (c && l) return d;
          z || c ? b.append(a.clone(!0, g), f) : (a.remove(), k && b.append(a, f));
          return d
        }

        function e() {
          var a, b, f, c = Math.min(J.length,
            D.length);
          for (a = 0; a < c; a++)
            if (b = J[a], f = D[a], !b.equals(f)) return a;
          return a - 1
        }
        ...
        var w = a.startContainer,
          ...
          B = a.endOffset,
          G, E, F, I, H, K;
        if (z && C.type == CKEDITOR.NODE_TEXT && (w.equals(C) || w.type === CKEDITOR.NODE_ELEMENT && w.getFirst().equals(C))) c.append(a.document.createText(C.substring(y, B)));
        else {
          C.type == CKEDITOR.NODE_TEXT ? z ? K = !0 : C = C.split(B) : 0 < C.getChildCount() ? B >= C.getChildCount() ? (C = C.getChild(B - 1), E = !0) : C = C.getChild(B) : I = E = !0;
          w.type ==
            CKEDITOR.NODE_TEXT ? z ? H = !0 : w.split(y) : 0 < w.getChildCount() ? 0 === y ? (w = w.getChild(y), G = !0) : w = w.getChild(y - 1) : F = G = !0;
          for (var J = w.getParents(), D = C.getParents(), R = e(), N = J.length - 1, S = D.length - 1, L = c, V, Z, X, da = -1, P = R; P <= N; P++) {
            Z = J[P];
            X = Z.getNext();
            for (P != N || Z.equals(D[P]) && N < S ? b && (V = L.append(Z.clone(0, g))) : G ? h(Z, L, !1, F) : H && L.append(a.document.createText(Z.substring(y))); X;) {
              if (X.equals(D[P])) {
                da = P;
                break
              }
          ...
          L = c;
          for (P = R; P <= S; P++)
            if (c = D[P], X = c.getPrevious(), c.equals(J[P])) b && (L = L.getChild(0));
            else {
              P !=
                S || c.equals(J[P]) && S < N ? b && (V = L.append(c.clone(0, g))) : E ? h(c, L, !1, I) : K && L.append(a.document.createText(c.substring(0, B)));
              if (P > da)
                for (; X;) X = h(X, L, !0);
              L = V
            } z || m()
      ...
      function b() {
        ...
        return function (g) {
          return c(g) || b(g) ? !0 : d(g) && !a ? a = !0 : g.type == CKEDITOR.NODE_TEXT && (g.hasAscendant("pre") || CKEDITOR.tools.trim(g.getText()).length) || g.type == CKEDITOR.NODE_ELEMENT && !g.is(l) ? !1 : !0
        }
      }
      ...
      CKEDITOR.dom.range.prototype = {
        ...
        createBookmark: function (a) {
          var b, c, d, g, h = this.collapsed;
          b = this.document.createElement("span");
          b.data("cke-bookmark", 1);
          b.setStyle("display", "none");
          b.setHtml("\x26nbsp;");
          a && (d = "cke_bm_" + CKEDITOR.tools.getNextNumber(), b.setAttribute("id", d + (h ? "C" : "S")));
          h || (c = b.clone(), c.setHtml("\x26nbsp;"), a && c.setAttribute("id", d + "E"), g = this.clone(), g.collapse(), g.insertNode(c));
          g = this.clone();
          g.collapse(!0);
          g.insertNode(b);
        ...
        createBookmark2: function () {
          function a(b) {
            ...
            g = f;
            var h = d;
            g = g.type != CKEDITOR.NODE_ELEMENT || 0 === h || h == g.getChildCount() ? 0 : g.getChild(h - 1).type == CKEDITOR.NODE_TEXT && g.getChild(h).type == CKEDITOR.NODE_TEXT;
            g && (f = f.getChild(d - 1), d = f.getLength());
            if (f.type == CKEDITOR.NODE_ELEMENT && 0 < d) {
              a: {
                for (g = f; d--;)
                  if (h = g.getChild(d).getIndex(!0), 0 <= h) {
                    d = h;
                    break a
                  } d = -1
              }
            ...
            if (f.type == CKEDITOR.NODE_TEXT) {
              g = f;
              for (h = 0;
                (g = g.getPrevious()) && g.type == CKEDITOR.NODE_TEXT;) h += g.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length;
              g = h;
              f.getText() ? d += g : (h = f.getPrevious(c), g ? (d = g, f = h ? h.getNext() : f.getParent().getFirst()) : (f = f.getParent(), d = h ? h.getIndex(!0) + 1 : 0))
            }
            b.container = f;
            b.offset = d
          }
          ...
          return function (c) {
            ...
            c && (a(g), b(g, this.root), d || (a(h), b(h, this.root)));
            return {
        ...
        trim: function (a, b) {
          ...
          c = this.endContainer;
          d = this.endOffset;
          b || g || !c || c.type != CKEDITOR.NODE_TEXT || (d ? (d >= c.getLength() || c.split(d), d = c.getIndex() + 1) : d = c.getIndex(), c = c.getParent(), this.setEnd(c, d))
        },
        enlarge: function (a, b) {
          ...
          switch (a) {
            ...
            case CKEDITOR.ENLARGE_ELEMENT:
              ...
              B.type == CKEDITOR.NODE_TEXT ? (E && (B = !CKEDITOR.tools.trim(B.substring(0, E)).length &&
                B, y = !!B), B && ((w = B.getPrevious()) || (z = B.getParent()))) : (E && (w = B.getChild(E - 1) || B.getLast()), w || (z = B));
              for (z = c(z); z || w;) {
                if (z && !w) {
                  !C && z.equals(e) && (C = !0);
                  if (g ? z.isBlockBoundary() : !m.contains(z)) break;
                  y && "inline" == z.getComputedStyle("display") || (y = !1, C ? l = z : this.setStartBefore(z));
                  w = z.getPrevious()
                }
                for (; w;)
                  if (B = !1, w.type == CKEDITOR.NODE_COMMENT) w = w.getPrevious();
                  else {
                    if (w.type == CKEDITOR.NODE_TEXT) G = w.getText(), d.test(G) && (w = null), B = /[\s\ufeff]$/.test(G);
                    else if ((w.$.offsetWidth > (CKEDITOR.env.webkit ? 1 :
                        0) || b && w.is("br")) && !w.data("cke-bookmark"))
                      if (y && CKEDITOR.dtd.$removeEmpty[w.getName()]) {
                        G = w.getText();
                        if (d.test(G)) w = null;
                        else
                          for (var E = w.$.getElementsByTagName("*"), F = 0, I; I = E[F++];)
                            if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                              w = null;
                              break
                            } w && (B = !!G.length)
                      } else w = null;
                    B && (y ? C ? l = z : z && this.setStartBefore(z) : y = !0);
                    if (w) {
                      B = w.getPrevious();
                      if (!z && !B) {
                        z = w;
              ...
              B.type == CKEDITOR.NODE_TEXT ?
                CKEDITOR.tools.trim(B.substring(E)).length ? y = !0 : (y = !B.getLength(), E == B.getLength() ? (w = B.getNext()) || (z = B.getParent()) : h(B, E) && (z = B.getParent())) : (w = B.getChild(E)) || (z = B);
              for (; z || w;) {
                if (z && !w) {
                  !C && z.equals(e) && (C = !0);
                  if (g ? z.isBlockBoundary() : !m.contains(z)) break;
                  y && "inline" == z.getComputedStyle("display") || (y = !1, C ? k = z : z && this.setEndAfter(z));
                  w = z.getNext()
                }
                for (; w;) {
                  B = !1;
                  if (w.type == CKEDITOR.NODE_TEXT) G = w.getText(), h(w, 0) || (w = null), B = /^[\s\ufeff]/.test(G);
                  else if (w.type == CKEDITOR.NODE_ELEMENT) {
                    if ((0 < w.$.offsetWidth ||
                        b && w.is("br")) && !w.data("cke-bookmark"))
                      if (y && CKEDITOR.dtd.$removeEmpty[w.getName()]) {
                        G = w.getText();
                        if (d.test(G)) w = null;
                        else
                          for (E = w.$.getElementsByTagName("*"), F = 0; I = E[F++];)
                            if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                              w = null;
                              break
                            } w && (B = !!G.length)
              ...
              l && k && (e = l.contains(k) ? k : l, this.setStartBefore(e), this.setEndAfter(e));
              break;
            ...
            case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
              ...
              m = this.root;
              z.setStartAt(m, CKEDITOR.POSITION_AFTER_START);
              z.setEnd(this.startContainer, this.startOffset);
              z = new CKEDITOR.dom.walker(z);
              var H, K, J = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                  br: 1
                } : null),
                D = null,
                R = function (a) {
              ...
              z = z.lastBackward();
              H = H || m;
              this.setStartAt(H, !H.is("br") && (!z && this.checkStartOfBlock() || z && H.contains(z)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
              if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                ...
                if ((z = z.previous()) && z.type == CKEDITOR.NODE_ELEMENT && z.is("br")) break
              }
              z = this.clone();
              z.collapse();
              z.setEndAt(m,
              ...
              z = new CKEDITOR.dom.walker(z);
              z.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? g : R;
              H = D = K = null;
              z = z.lastForward();
              H = H || m;
              this.setEndAt(H, !z && this.checkEndOfBlock() || z && H.contains(z) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
        ...
        shrink: function (a, b, c) {
          ...
          if (!this.collapsed) {
            ...
            var h = this.clone(),
              ...
              k = this.endOffset,
              z = c = 1;
            e && e.type == CKEDITOR.NODE_TEXT && (l ? l >= e.getLength() ? h.setStartAfter(e) : (h.setStartBefore(e), c = 0) : h.setStartBefore(e));
            m && m.type == CKEDITOR.NODE_TEXT && (k ? k >= m.getLength() ? h.setEndAfter(m) : (h.setEndAfter(m), z = 0) : h.setEndBefore(m));
            ...
            h.guard = function (b, c) {
              if (g && C(b) || w(b)) return !0;
              if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || c && b.equals(y) || !1 === d && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return !1;
              c || b.type != CKEDITOR.NODE_ELEMENT || (y = b);
              return !0
            };
            c && (e = h[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(e, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
            z && (h.reset(), (h = h[a == CKEDITOR.SHRINK_ELEMENT ?
              "lastBackward" : "previous"]()) && this.setEndAt(h, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
            return !(!c && !z)
          }
        },
        ...
        splitBlock: function (a, b) {
          ...
          "br" != a && (g || (g = this.fixBlock(!0, a), h = (new CKEDITOR.dom.elementPath(this.endContainer, this.root)).block), h || (h = this.fixBlock(!1, a)));
          c = g && this.checkStartOfBlock();
          d = h && this.checkEndOfBlock();
          this.deleteContents();
          g && g.equals(h) && (d ? (e = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(h, CKEDITOR.POSITION_AFTER_END), h = null) : c ? (e = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(g,
            CKEDITOR.POSITION_BEFORE_START), g = null) : (h = this.splitElement(g, b || !1), g.is("ul", "ol") || g.appendBogus()));
          return {
            previousBlock: g,
            nextBlock: h,
            wasStartOfBlock: c,
        ...
        removeEmptyBlocksAtEnd: function () {
          ...
          var b = CKEDITOR.dom.walker.whitespaces(),
            c = CKEDITOR.dom.walker.bookmark(!1);
          return function (b) {
            for (var c = this.createBookmark(), d = this[b ? "endPath" : "startPath"](), g = d.block || d.blockLimit, h; g && !g.equals(d.root) && !g.getFirst(a(g));) h = g.getParent(), this[b ? "setEndAt" : "setStartAt"](g, CKEDITOR.POSITION_AFTER_END), g.remove(1), g = h;
            this.moveToBookmark(c)
          }
        }(),
        startPath: function () {
        ...
        moveToElementEditablePosition: function (a, b) {
          ...
          for (var c = 0; a;) {
            ...
            h || e || (e = d[b ? "getPrevious" : "getNext"](m));
            a = e
          }
          return !!c
        },
        ...
        _getTableElement: function (a) {
          ...
          return CKEDITOR.env.safari && d && c.equals(this.root) ? b.getAscendant(a, !0) : this.getEnclosedNode() ? this.getEnclosedNode().getAscendant(a, !0) : d && g && (d.equals(g) || d.contains(g) || g.contains(d)) ? b.getAscendant(a, !0) : null
        },
        scrollIntoView: function () {
          var a = new CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", this.document),
            b, c, d, g = this.clone();
          g.optimize();
          (d = g.startContainer.type == CKEDITOR.NODE_TEXT) ? (c = g.startContainer.getText(),
            b = g.startContainer.split(g.startOffset), a.insertAfter(g.startContainer)) : g.insertNode(a);
          a.scrollIntoView();
          d && (g.startContainer.setText(c), b.remove());
          a.remove()
        },
        ...
        _find: function (a, b) {
          var c = this.getCommonAncestor(),
            ...
            h, e, m, l;
          if (c && c.find)
            for (e = c.find(a), h = 0; h < e.count(); h++)
              if (c = e.getItem(h), b || !c.isReadOnly()) m = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING ||
                d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED || d.endNode.equals(c), m && l && g.push(c);
          return g
        }
      };
      CKEDITOR.dom.range.mergeRanges = function (a) {
        return CKEDITOR.tools.array.reduce(a, function (a, b) {
          ...
          if (c) {
            ...
            for (d = f.next(); g(d) || b.endContainer.equals(d);) d = f.next();
            f = !d
          }
    ...
    function () {
      ...
      function b(a, c, d, g) {
        ...
        if (!g) return 0;
        if ((h = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !h.check(c)) return b(a, c, d, g.remaining);
        c = new CKEDITOR.dom.range(g.element);c.selectNodeContents(g.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = h;a._.nestedEditable = {
          element: g.element,
          container: d,
      ...
      a.prototype = {
        getNextParagraph: function (a) {
          ...
          if (this._.nestedEditable) {
            if (f = this._.nestedEditable.iterator.getNextParagraph(a)) return this.activeFilter = this._.nestedEditable.iterator.activeFilter, f;
          ...
          if (!this._.started) {
            ...
            e = x.startPath();
            var q = x.endPath(),
              t = !x.collapsed && c(x, e.block),
              u = !x.collapsed && c(x, q.block, 1);
            x.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
            t && x.setStartAt(e.block, CKEDITOR.POSITION_BEFORE_END);
            u && x.setEndAt(q.block, CKEDITOR.POSITION_AFTER_START);
            e = x.endContainer.hasAscendant("pre", !0) || x.startContainer.hasAscendant("pre", !0);
            ...
            x.collapsed || (e = new CKEDITOR.dom.walker(x.clone()),
              q = CKEDITOR.dom.walker.bookmark(!0, !0), e.evaluator = q, this._.nextNode = e.next(), e = new CKEDITOR.dom.walker(x.clone()), e.evaluator = q, e = e.previous(), this._.lastNode = e.getNextSourceNode(!0, null, x.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (q = this.range.clone(), q.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), q.checkEndOfBlock() && (q = new CKEDITOR.dom.elementPath(q.endContainer,
                q.root), this._.lastNode = (q.block || q.blockLimit).getNextSourceNode(!0))), this._.lastNode && x.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = x.document.createText(""), this._.lastNode.insertAfter(e)), x = null);
            this._.started = 1;
            e = x
          }
          q = this._.nextNode;
          ...
          for (this._.nextNode = null; q;) {
            var t = 0,
              u = q.hasAscendant("pre"),
              A = q.type != CKEDITOR.NODE_ELEMENT,
              z = 0;
            if (A) q.type == CKEDITOR.NODE_TEXT && d.test(q.getText()) && (A = 0);
            else {
              var w = q.getName();
              if (CKEDITOR.dtd.$block[w] && "false" == q.getAttribute("contenteditable")) {
                f =
                  q;
                b(this, a, f);
                break
              } else if (q.isBlockBoundary(this.forceBrBreak && !u && {
                  br: 1
                })) {
                if ("br" == w) A = 1;
                else if (!e && !q.getChildCount() && "hr" != w) {
                  f = q;
                  k = q.equals(x);
                  break
                }
                e && (e.setEndAt(q, CKEDITOR.POSITION_BEFORE_START), "br" != w && (this._.nextNode = q));
                t = 1
              } else {
                if (q.getFirst()) {
                  e || (e = this.range.clone(), e.setStartAt(q, CKEDITOR.POSITION_BEFORE_START));
                  q = q.getFirst();
                  continue
                }
                A = 1
            ...
            A && !e && (e = this.range.clone(), e.setStartAt(q, CKEDITOR.POSITION_BEFORE_START));
            k = (!t || A) && q.equals(x);
            if (e && !t)
              for (; !q.getNext(g) && !k;) {
                w =
                  q.getParent();
                if (w.isBlockBoundary(this.forceBrBreak && !u && {
                    br: 1
                  })) {
                  t = 1;
                  A = 0;
                  k || w.equals(x);
                  e.setEndAt(w, CKEDITOR.POSITION_BEFORE_END);
                  break
                }
                q = w;
                A = 1;
            ...
            A && e.setEndAt(q, CKEDITOR.POSITION_AFTER_END);
            q = this._getNextSourceNode(q, z, x);
            if ((k = !q) || t && e) break
          }
          if (!f) {
            if (!e) return this._.docEndMarker && this._.docEndMarker.remove(), this._.nextNode = null;
            f = new CKEDITOR.dom.elementPath(e.startContainer, e.root);
            q = f.blockLimit;
            t = {
              div: 1,
              th: 1,
            ...
            f = f.block;
            !f && q && !this.enforceRealBlocks && t[q.getName()] &&
              e.checkStartOfBlock() && e.checkEndOfBlock() && !q.equals(e.root) ? f = q : !f || this.enforceRealBlocks && f.is(h) ? (f = this.range.document.createElement(a), e.extractContents().appendTo(f), f.trim(), e.insertNode(f), r = v = !0) : "li" != f.getName() ? e.checkStartOfBlock() && e.checkEndOfBlock() || (f = f.clone(!1), e.extractContents().appendTo(f), f.trim(), v = e.splitBlock(), r = !v.wasStartOfBlock, v = !v.wasEndOfBlock, e.insertNode(f)) : k || (this._.nextNode = f.equals(x) ? null : this._getNextSourceNode(e.getBoundaryNodes().endNode, 1, x))
          }
          r && (r =
            f.getPrevious()) && r.type == CKEDITOR.NODE_ELEMENT && ("br" == r.getName() ? r.remove() : r.getLast() && "br" == r.getLast().$.nodeName.toLowerCase() && r.getLast().remove());
          v && (r = f.getLast()) && r.type == CKEDITOR.NODE_ELEMENT && "br" == r.getName() && (!CKEDITOR.env.needsBrFiller || r.getPrevious(l) || r.getNext(l)) && r.remove();
          this._.nextNode || (this._.nextNode = k || f.equals(x) || !x ? null : this._getNextSourceNode(f, 1, x));
          return f
        },
    ...
    function () {
      function a(a, b, c, f, d) {
        ...
        for (g in b) {
          ...
          for (l in K) {
            ...
            var n = e,
              ...
              y = void 0;
            w ? N = !1 : w = {};
            for (y in D) "!" == y.charAt(0) && (y = y.slice(1), z.push(y), w[y] = !0, N = !1);
            for (; y = z.pop();) D[y] = D["!" + y], delete D["!" + y];
            n[q] = (N ? !1 : w) || null
          }
        ...
        for (f = a.length; c < f; ++c) {
          ...
          for (l in J) {
            ...
            w = [];
            D = void 0;
            for (D in q) - 1 < D.indexOf("*") ? w.push(new RegExp("^" +
              D.replace(/\*/g, ".*") + "$")) : w.push(D);
            q = w;
            q.length && (e[m] = q, n = !1)
          }
          e.nothingRequired = n;
          e.noProperties = !(e.attributes || e.classes || e.styles);
          if (!0 === g.elements || null === g.elements) d[h ? "unshift" : "push"](g);
          else
            for (p in e = g.elements, delete g.elements, e)
              if (b[p]) b[p][h ? "unshift" : "push"](g);
              else b[p] = [g]
        }
      }
        ...
        if (!a.match || a.match(c))
          if (d || g(a, c))
            if (a.propertiesOnly || (f.valid = !0), f.allAttributes || (f.allAttributes = b(a.attributes, c.attributes, f.validAttributes)), f.allStyles || (f.allStyles = b(a.styles,
                c.styles, f.validStyles)), !f.allClasses) {
              a = a.classes;
              c = c.classes;
              d = f.validClasses;
              if (a)
                if (!0 === a) a = !0;
                  ...
                  for (var h = 0, e = c.length, m; h < e; ++h) m = c[h], d[m] || (d[m] = a(m));
                  a = !1
                }
              else a = !1;
              f.allClasses = a
      ...
      function c(a, b, c) {
        if (!a.match || a.match(b)) {
          ...
          b = b.classes;
          if (a) {
            for (var f = !1, g = !0 === a, h = b.length; h--;)
              if (g || a(b[h])) b.splice(h, 1), f = !0;
            a = f
          } else a = !1;
      ...
      function g(a, b) {
        ...
        if (d = a.requiredClasses)
          for (g = b.classes, c = 0; c < d.length; ++c)
            if (f = d[c], "string" == typeof f) {
              if (-1 == CKEDITOR.tools.indexOf(g, f)) return !1
            } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(g, f)) return !1;
      ...
      function h(a, b) {
        ...
        for (var c = 0, f; c < b.length; ++c)
          if (f = b[c], "string" ==
            typeof f) {
            if (!(f in a)) return !1
          } else if (!CKEDITOR.tools.checkIfAnyObjectPropertyMatches(a, f)) return !1;
        return !0
      }
      ...
      function f(a) {
        var b, c, f, d, g = {},
          h = 1;
        for (a = I(a); b = a.match(D);)(c = b[2]) ? (f = n(c, "styles"), d = n(c, "attrs"), c = n(c, "classes")) : f = d = c = null, g["$" + h++] = {
          elements: b[1],
          classes: c,
          styles: f,
          attributes: d
      ...
      function r(a, b, f, d) {
        ...
        if (d.doTransform && (h = a._.transformations[b.name])) {
          p(b);
          for (m = 0; m < h.length; ++m) w(a, b, h[m]);
          x(b)
        }
        if (d.doFilter) {
          a: {
            m =
            b.name;l = a._;a = l.allowedRules.elements[m];h = l.allowedRules.generic;m = l.disallowedRules.elements[m];l = l.disallowedRules.generic;k = d.skipRequired;
            var n = {
                valid: !1,
                validAttributes: {},
                validClasses: {},
            ...
            if (a || h) {
              p(b);
              if (m)
                for (D = 0, z = m.length; D < z; ++D)
                  if (!1 === c(m[D], b, n)) {
                    a = null;
                    break a
                  } if (l)
                for (D = 0, z = l.length; D < z; ++D) c(l[D], b, n);
              if (a)
                for (D = 0, z = a.length; D < z; ++D) e(a[D], b, n, k);
              if (h)
                for (D =
                  0, z = h.length; D < z; ++D) e(h[D], b, n, k);
              a = n
            } else a = null
          }
          if (!a || !a.valid) return f.push(b),
          1;z = a.validAttributes;
          var J = a.validStyles;h = a.validClasses;
          var m = b.attributes,
            t = b.styles,
            l = b.classes;k = b.classBackup;
          var y = b.styleBackup,
            u, E, C = [],
            n = [],
            B = /^data-cke-/;D = !1;delete m.style;delete m["class"];delete b.classBackup;delete b.styleBackup;
          if (!a.allAttributes)
            for (u in m) z[u] || (B.test(u) ? u == (E = u.replace(/^data-cke-saved-/, "")) || z[E] || (delete m[u], D = !0) : (delete m[u], D = !0));
          if (!a.allStyles || a.hadInvalidStyle) {
            for (u in t) a.allStyles ||
              J[u] ? C.push(u + ":" + t[u]) : D = !0;
            C.length && (m.style = C.sort().join("; "))
          } else y && (m.style = y);
          if (!a.allClasses || a.hadInvalidClass) {
            for (u = 0; u < l.length; ++u)(a.allClasses || h[l[u]]) && n.push(l[u]);
            n.length && (m["class"] = n.sort().join(" "));
            k && n.length < k.split(/\s+/).length && (D = !0)
          } else k && (m["class"] = k);D && (g = 1);
          if (!d.skipFinalValidation && !q(b)) return f.push(b),
          1
        }
        d.toHtml && (b.name = b.name.replace(S, "cke:$1"));
        return g
      }
      ...
      function z(a, b, c) {
        var f = a.name;
        if (E.$empty[f] || !a.children.length) "hr" == f && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({
          check: "it",
          el: a.parent
        }), a.remove());
        else if (E.$block[f] || "tr" == f)
          if ("br" == b) a.previous && !A(a.previous) && (b = u(), b.insertBefore(a)), a.next && !A(a.next) && (b = u(), b.insertAfter(a)), a.replaceWithChildren();
          else {
            var f = a.children,
              d;
            b: {
              d = E[b];
              for (var g = 0, h = f.length, e; g < h; ++g)
                if (e = f[g], e.type == CKEDITOR.NODE_ELEMENT &&
                  !d[e.name]) {
                  d = !1;
                  break b
                } d = !0
            ...
            if (d) a.name = b, a.attributes = {}, c.push({
              ...
              d = a.parent;
              for (var g = d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == d.name, m, l, h = f.length; 0 < h;) e = f[--h], g && (e.type == CKEDITOR.NODE_TEXT || e.type == CKEDITOR.NODE_ELEMENT && E.$inline[e.name]) ? (m || (m = new CKEDITOR.htmlParser.element(b), m.insertAfter(a), c.push({
                check: "parent-down",
                el: m
              })), m.add(e, 0)) : (m = null, l = E[d.name] || E.span, e.insertAfter(a), d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || e.type != CKEDITOR.NODE_ELEMENT ||
                l[e.name] || c.push({
                  check: "el-up",
                  el: e
                }));
      ...
      function w(a, b, c) {
        ...
        for (f = 0; f < c.length; ++f)
          if (d = c[f], !(d.check && !a.check(d.check, !1) || d.left && !d.left(b))) {
            d.right(b, L);
            break
          }
      }
      ...
      function C(a, b) {
        ...
        for (g in f)
          if ("class" == g)
            for (c = f[g].split(/\s+/), e = a.classes.join("|"); m = c.pop();) {
              if (-1 == e.indexOf(m)) return !1
            } else if (a.attributes[g] !=
              f[g]) return !1;
        for (h in d)
          if (a.styles[h] != d[h]) return !1;
        return !0
      }

      function y(a, b) {
        var c, f;
        "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? f = a : (c = a[0], f = a[1]);
        return [{
          element: c,
          left: f,
          right: function (a, c) {
      ...
      CKEDITOR.filter.prototype = {
        ...
        applyTo: function (a, b, c, f) {
                ...
                if (h)
                  for (n = 0; n < h.length; ++n)
                    if ((q = f.match(h[n])) &&
                      ...
                      c = !0;
                      break a
                    } f = CKEDITOR.htmlParser.fragment.fromHtml(f);1 == f.children.length && (k = f.children[0]).type == CKEDITOR.NODE_ELEMENT && r(d, k, c, l);c = !c.length
              }
              c || g.push(a)
            }
          }, null, !0);
          ...
          for (var n; c = g.pop();) c.type == CKEDITOR.NODE_ELEMENT ? z(c, f, a) : c.remove();
          for (; k = a.pop();)
            if (c = k.el, c.parent) switch (n = E[c.parent.name] || E.span, k.check) {
              case "it":
                E.$removeEmpty[c.name] && !c.children.length ? z(c, f, a) : q(c) ||
                  z(c, f, a);
                break;
              case "el-up":
                c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n[c.name] || z(c, f, a);
                break;
              case "parent-down":
                c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || n[c.name] || z(c.parent, f, a)
            }
          return m
        },
        ...
        addContentForms: function (a) {
          if (!this.disabled && a) {
            ...
            if (d) {
              for (b = 0; b < a.length; ++b) f.push(y(a[b], d));
          ...
          if (!this.disabled && a) {
            ...
            for (d = 0; d < a.length; ++d) {
              ...
              var g = void 0,
                ...
                k = void 0;
              c = [];
              for (h = 0; h < b.length; ++h) e = b[h], "string" == typeof e ? (e = e.split(/\s*:\s*/), m = e[0], l = null, k = e[1]) : (m = e.check, l = e.left,
                k = e.right), g || (g = e, g = g.element ? g.element : m ? m.match(/^([a-z0-9]+)/i)[0] : g.left.getDefinition().element), l instanceof CKEDITOR.style && (l = B(l)), c.push({
                check: m == g ? null : m,
                left: l,
                right: "string" == typeof k ? G(k) : k
              });
              b = g;
              f[b] || (f[b] = []);
              f[b].push(c)
        ...
        check: function (a, b, c) {
          ...
          if ("string" == typeof a) {
            ...
            g && (d.attributes.style = CKEDITOR.tools.writeCssText(d.styles));
            g = d
          } else d = a.getDefinition(), g = d.styles, e = d.attributes || {}, g && !CKEDITOR.tools.isEmpty(g) ? (g = F(g), e.style = CKEDITOR.tools.writeCssText(g, !0)) : g = {}, g = {
            name: d.element,
            attributes: e,
          ...
          if (!1 !== b && (k = this._.transformations[g.name])) {
            for (d = 0; d < k.length; ++d) w(this, g, k[d]);
            x(g)
          }
          r(this, e, l, {
            doFilter: !0,
          ...
          b = 0 < l.length ? !1 : CKEDITOR.tools.objectCompare(g.attributes, e.attributes, !0) ? !0 : !1;
          "string" == typeof a && (this._.cachedChecks[h] = b);
          return b
        },
      ...
      L = CKEDITOR.filter.transformationsTools = {
        ...
        lengthToAttribute: function (a, b, c) {
          ...
          if (!(c in a.attributes)) {
            var f = a.styles[b],
              d = f && f.match(/^(\d+)(?:\.\d*)?px$/);
            d ? a.attributes[c] = d[1] : "cke-test" == f && (a.attributes[c] = "cke-test")
          }
          delete a.styles[b]
        },
        ...
        transform: function (a, b) {
          if ("string" == typeof b) a.name = b;
            ...
            for (g in d)
              if ("class" == g)
                for (c =
                  a.classes.join("|"), e = d[g].split(/\s+/); m = e.pop();) - 1 == c.indexOf(m) && a.classes.push(m);
    ...
    function () {
      ...
      return {
        load: function (b, c, d, l) {
          ...
          var g = b.length,
            ...
            m = [],
            f = function (a) {
              c && (k ? c.call(d, a) : c.call(d, h, m))
            };
          if (0 === g) f(!0);
          else {
            var n = function (a, b) {
                (b ? h : m).push(a);
                0 >= --g && (l && CKEDITOR.document.getDocumentElement().removeStyle("cursor"),
                  f(b))
              },
              p = function (b, c) {
                a[b] = 1;
                var f = e[b];
                delete e[b];
                for (var d = 0; d < f.length; d++) f[d](b, c)
              },
              r = function (b) {
                if (a[b]) n(b, !0);
                else {
                  ...
                  if (!(1 < f.length)) {
                    ...
                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? d.$.onreadystatechange = function () {
                      if ("loaded" == d.$.readyState || "complete" == d.$.readyState) d.$.onreadystatechange = null, p(b, !0)
                    } : (d.$.onload = function () {
                      setTimeout(function () {
                        p(b,
                          !0)
      ...
      load: function (a, e, b) {
        ...
        for (var c = this.loaded, d = this.registered, l = [], k = {}, g = {}, h = 0; h < a.length; h++) {
          var m = a[h];
          if (m)
            if (c[m] ||
              d[m]) g[m] = this.get(m);
            ...
            k = function (b) {
              a.call(this, b, function (a) {
                ...
                for (f in a) {
                  ...
                  if (!e[f]) {
                    if (g.icons)
                      for (var r = g.icons.split(","), v = r.length; v--;) CKEDITOR.skin.addIcon(r[v], g.path + "icons/" + (CKEDITOR.env.hidpi && g.hidpi ? "hidpi/" : "") + r[v] + ".png");
                    e[f] = 1
                  }
                  if (p)
                    for (p.split && (p = p.split(",")), g = 0; g < p.length; g++) l[p[g]] || b.push(p[g])
                }
                if (b.length) k.call(this, b);
                else {
                  for (f in l) g = l[f], g.onLoad && !g.onLoad._called && (!1 ===
                    g.onLoad() && delete l[f], g.onLoad._called = 1);
                  c && c.call(d || window, l)
                }
              }, this)
            };
    ...
    function () {
      ...
      function l(a, b, c) {
        if (b) {
          var f, d, g = a.commands;
          for (d in g) f = g[d], (c || f.contextSensitive) && f.refresh(a, b)
        }
      }
      ...
      function n(a) {
        ...
        CKEDITOR.plugins.load(c.split(","), function (c) {
          ...
          for (var e in c) {
            ...
            if (n && (D = n.match(h)))
              for (; n = D.pop();) CKEDITOR.error("editor-plugin-required", {
                plugin: n.replace(",", ""),
                requiredBy: e
              });
            l && !a.lang[e] && (l.split && (l = l.split(",")), 0 <= CKEDITOR.tools.indexOf(l, a.langCode) ? k = a.langCode : (k = a.langCode.replace(/-.*/, ""), k = k != a.langCode && 0 <= CKEDITOR.tools.indexOf(l, k) ? k : 0 <= CKEDITOR.tools.indexOf(l, "en") ? "en" : l[0]), m.langEntries && m.langEntries[k] ? (a.lang[e] =
              m.langEntries[k], k = null) : g.push(CKEDITOR.getUrl(m.path + "lang/" + k + ".js")));
            d.push(k);
            f.push(m)
          }
          CKEDITOR.scriptLoader.load(g, function () {
            for (var c = ["beforeInit", "init", "afterInit"], g = 0; g < c.length; g++)
              for (var h = 0; h < f.length; h++) {
                var e = f[h];
                0 === g && d[h] && e.lang && e.langEntries && (a.lang[e.name] = e.langEntries[d[h]]);
                if (e[c[g]]) e[c[g]](a)
              }
      ...
      function r(a, b) {
        ...
        for (var d = new CKEDITOR.dom.documentFragment, g, h, e, m = 0; m < a.length; m++) {
          var l = a[m],
          ...
          c(l) ? (g || (g = k.getAscendant("table").clone(), g.append(k.getAscendant({
            ...
            tbody: 1,
            tfoot: 1
          }).clone()), d.append(g), g = g.findOne("thead, tbody, tfoot")), h && h.equals(k) || (h = k, e = k.clone(), g.append(e)), e.append(f(l))) : d.append(l.cloneContents())
        }
      ...
      CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
        ...
        _attachToForm: function () {
          ...
          var c = this,
            f = c.element,
            d = new CKEDITOR.dom.element(f.$.form);
          f.is("textarea") && d && (d.on("submit", a), b(d.$.submit) && (d.$.submit = CKEDITOR.tools.override(d.$.submit,
            function (b) {
              return function () {
                a();
        ...
        execCommand: function (a, b) {
          ...
          return c && c.state != CKEDITOR.TRISTATE_DISABLED && !1 !== this.fire("beforeCommandExec", f) && (f.returnValue = c.exec(f.commandData), !c.async && !1 !== this.fire("afterCommandExec", f)) ? f.returnValue : !1
        },
        ...
        setData: function (a, b, c) {
          var f = !0,
            d = b;
          b && "object" == typeof b && (c = b.internal, d = b.callback, f = !b.noSnapshot);
          !c && f && this.fire("saveSnapshot");
          if (d || !c) this.once("dataReady", function (a) {
            !c && f && this.fire("saveSnapshot");
            d && d.call(a.editor)
          });
          a = {
        ...
        extractSelectedHtml: function (a, b) {
          ...
          for (g = 0; g < f.length; g++) d.append(c.extractHtmlFromRange(f[g],
            b));
        ...
        setKeystroke: function () {
          for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [
            ...
            ], c, f, d = b.length; d--;) c = b[d], f = 0, CKEDITOR.tools.isArray(c) &&
        ...
        getCommandKeystroke: function (a) {
          if (a = "string" === typeof a ? this.getCommand(a) : a) {
            ...
            for (f in c)
              if (c.hasOwnProperty(f) && c[f] == b) return f
          }
          return null
        },
        addFeature: function (a) {
    ...
    0, CKEDITOR.ELEMENT_MODE_REPLACE = 1, CKEDITOR.ELEMENT_MODE_APPENDTO = 2, CKEDITOR.ELEMENT_MODE_INLINE = 3, CKEDITOR.htmlParser = function () {
      this._ = {
      ...
      CKEDITOR.htmlParser.prototype = {
        ...
        parse: function (b) {
          for (var c, d, l = 0, k; c = this._.htmlPartsRegex.exec(b);) {
            d = c.index;
            if (d > l)
              if (l = b.substring(l, d), k) k.push(l);
              else this.onText(l);
            l = this._.htmlPartsRegex.lastIndex;
            if (d = c[1])
              if (d = d.toLowerCase(), k && CKEDITOR.dtd.$cdata[d] && (this.onCDATA(k.join("")), k = null), !k) {
                this.onTagClose(d);
                continue
              } if (k) k.push(c[0]);
            else if (d =
              ...
              if (d = d.toLowerCase(), !/="/.test(d)) {
                ...
                if (m)
                  for (; h = a.exec(m);) {
                    var f = h[1].toLowerCase();
                    h = h[2] || h[3] || h[4] || "";
                    g[f] = !h && e[f] ? f : CKEDITOR.tools.htmlDecodeAttr(h)
                  }
                this.onTagOpen(d, g, c);
                !k && CKEDITOR.dtd.$cdata[d] && (k = [])
              }
    ...
    function () {
      ...
      CKEDITOR.htmlParser.text.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
        ...
        filter: function (a, e) {
          if (!(this.value = a.onText(e, this.value, this))) return this.remove(),
            !1
        },
        writeHtml: function (a, e) {
          e && this.filter(e);
    ...
    function () {
      ...
      CKEDITOR.htmlParser.fragment.fromHtml = function (l, k, g) {
          ...
          if (0 < q.length)
            for (var c = 0; c < q.length; c++) {
              var f =
                ...
                d = f.name,
                g = CKEDITOR.dtd[d],
                h = u.name && CKEDITOR.dtd[u.name];
              h && !h[d] || a && g && !g[a] && CKEDITOR.dtd[a] ? d == u.name && (n(u, u.parent, 1), c--) : (b || (m(), b = 1), f = f.clone(), f.parent = u, u = f, q.splice(c, 1), c--)
            }
        }

        function m() {
          for (; t.length;) n(t.shift(), u)
        }
        ...
        function n(b, c, d) {
          ...
          var h = u;
          void 0 === b.previous &&
            (p(c, b) && (u = c, v.onTagOpen(g, {}), b.returnPoint = c = u), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (z = !1), "textarea" == b.name && (A = !1));
          b.returnPoint ? (u = b.returnPoint, delete b.returnPoint) : u = d ? c : h
        }
        ...
        var v = new CKEDITOR.htmlParser,
          ...
          A = "textarea" == x.name,
          z = "pre" == x.name;
        v.onTagOpen = function (f, d, g, l) {
          d = new CKEDITOR.htmlParser.element(f, d);
          d.isUnknown && g && (d.isEmpty = !0);
          d.isOptionalClose = l;
          if (a(d)) q.push(d);
          else {
            if ("pre" == f) z = !0;
            ...
            if ("br" == f) t.push(d);
              ...
              for (; !(l = (g = u.name) ? CKEDITOR.dtd[g] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, d.isUnknown || u.isUnknown || l[f]);)
                if (u.isOptionalClose) v.onTagClose(g);
                else if (f in b && g in b) g = u.children, (g = g[g.length - 1]) && "li" == g.name || n(g = new CKEDITOR.htmlParser.element("li"), u), !d.returnPoint && (d.returnPoint = u), u = g;
              else if (f in CKEDITOR.dtd.$listItem && !r(f, g)) v.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1);
              else if (g in e && !r(f, g)) !d.returnPoint && (d.returnPoint =
                u), u = u.parent;
              else if (g in CKEDITOR.dtd.$inline && q.unshift(u), u.parent) n(u, u.parent, 1);
              else {
                d.isOrphan = 1;
                break
              }
        ...
        v.onTagClose = function (a) {
          for (var b = q.length - 1; 0 <= b; b--)
            if (a == q[b].name) {
              q.splice(b, 1);
              return
            } for (var c = [], f = [], d = u; d != x && d.name != a;) d._.isBlockLike || f.unshift(d), c.push(d), d = d.returnPoint || d.parent;
          if (d != x) {
        ...
        v.onText =
          function (a) {
            if (!(u._.hasInlineStarted && !t.length || z || A) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
            var b = u.name,
              f = b ? CKEDITOR.dtd[b] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
            if (!A && !f["#"] && b in e) v.onTagOpen(d[b] || ""), v.onText(a);
            else {
              m();
              h();
              z || A || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
              a = new CKEDITOR.htmlParser.text(a);
              if (p(u, a)) this.onTagOpen(g, {}, 0, 1);
              u.add(a)
            }
          };
    ...
    function () {
      ...
      function e(b, c, d, e) {
        var k, g;
        for (k in c)(g = b[k]) || (g = b[k] = new a), g.add(c[k], d, e)
      }
        ...
        CKEDITOR.tools.createClass({
          ...
          proto: {
            addRules: function (a, c) {
              ...
              a.attributeNames &&
                this.attributeNameRules.addMany(a.attributeNames, d, c);
            ...
            onElement: function (a, c) {
              for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], e, k = 0; 3 > k; k++)
                if (e = d[k]) {
                  e = e.exec(a, c, this);
                  if (!1 === e) return null;
            ...
            onNode: function (a, c) {
              var d = c.type;
              return d == CKEDITOR.NODE_ELEMENT ? this.onElement(a, c) : d == CKEDITOR.NODE_TEXT ? new CKEDITOR.htmlParser.text(this.onText(a,
                c.value)) : d == CKEDITOR.NODE_COMMENT ? new CKEDITOR.htmlParser.comment(this.onComment(a, c.value)) : null
            },
      ...
      a.prototype = {
        ...
        addMany: function (a, c, d) {
          for (var e = [this.findIndex(c), 0], k = 0, g = a.length; k < g; k++) e.push({
            value: a[k],
            priority: c,
            options: d
          });
        ...
        findIndex: function (a) {
          for (var c =
              this.rules, d = c.length - 1; 0 <= d && a < c[d].priority;) d--;
          return d + 1
        },
        exec: function (a, c) {
          var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
            ...
            h, m, f, n;
          for (n = 0; n < g; n++)
            if (d && (h = c.type, m = c.name), f = k[n], !(a.nonEditable && !f.options.applyToAll || a.nestedEditable && f.options.excludeNestedEditable)) {
              f = f.value.apply(null, e);
              if (!1 === f || d && f && (f.name != m || f.type != h)) return f;
              null != f && (e[0] = c = f)
            } return c
        },
        execOnName: function (a,
          c) {
          for (var d = 0, e = this.rules, k = e.length, g; c && d < k; d++) g = e[d], a.nonEditable && !g.options.applyToAll || a.nestedEditable && g.options.excludeNestedEditable || (c = c.replace(g.value[0], g.value[1]));
          return c
        }
      }
    }(),
    function () {
      function a(a, f) {
          ...
          return function (d) {
            if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
              var e = [],
                ...
                k, D;
              if (m)
                for (h(m, 1) && e.push(m); m;) l(m) &&
                  (k = c(m)) && h(k) && ((D = c(k)) && !l(D) ? e.push(k) : (g(n).insertAfter(k), k.remove())), m = m.previous;
              for (m = 0; m < e.length; m++) e[m].remove();
              if (e = !a || !1 !== ("function" == typeof f ? f(d) : f)) n || CKEDITOR.env.needsBrFiller || d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? n || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || d.name in CKEDITOR.dtd.tr || d.name in CKEDITOR.dtd.$listItem) ? (e = b(d), e = !e || "form" == d.name && "input" == e.name) : e = !1 : e = !1;
              e && d.add(g(a))
            }
          }
        }
        ...
        function h(a, b) {
          ...
          var c;
          return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(q)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && n && (!b || a.parent.name in D) || !n && ((c = a.previous) && "br" == c.name || !c || l(c))) ? !0 : !1
        }
        var m = {
            elements: {}
          },
          n = "html" == f,
          D = CKEDITOR.tools.extend({}, z),
          J;
        for (J in D) "#" in u[J] || delete D[J];
        for (J in D) m.elements[J] = e(n, a.config.fillEmptyBlocks);
        m.root = e(n, !1);
        m.elements.br =
          function (a) {
            return function (b) {
              if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                var f = b.attributes;
                if ("data-cke-bogus" in f || "data-cke-eol" in f) delete f["data-cke-bogus"];
                else {
                  for (f = b.next; f && d(f);) f = f.next;
                  var e = c(b);
                  !f && l(b.parent) ? k(b.parent, g(a)) : l(f) && e && !l(e) && g(a).insertBefore(f)
                }
              }
            }
          }(n);
      ...
      function f(a, b) {
        return a.replace(b, function (a, b, c) {
          0 === a.indexOf("\x3ctextarea") && (a = b + r(c).replace(/</g, "\x26lt;").replace(/>/g,
      ...
      function x(a, b) {
        ...
        for (var e = 0; e < f.length; e++) a = a.replace(f[e], function (a) {
        ...
        a = a.replace(g, function (a, b, f) {
          return "\x3c!--" + t + (b ? "{C}" : "") + encodeURIComponent(c[f]).replace(/--/g, "%2D%2D") + "--\x3e"
        });
        ...
        return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, f, d) {
          return "\x3c" + c + f + "\x3e" + v(r(d), b) + "\x3c/" + c + "\x3e"
        })
      }
      CKEDITOR.htmlDataProcessor = function (b) {
        ...
        b.on("toHtml", function (a) {
          ...
          var g;
          CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == d && (d = "div", c = "\x3cpre\x3e" + c + "\x3c/pre\x3e",
            g = 1);
          ...
          d && (g = c, !g.children.length && CKEDITOR.dtd[g.name][d] && (d = new CKEDITOR.htmlParser.element(d), g.add(d)));
          a.dataValue = c
        }, null, null, 5);
        b.on("toHtml", function (a) {
          a.data.filter.applyTo(a.data.dataValue,
            !0, a.data.dontFilter, a.data.enterMode) && b.fire("dataFiltered")
        }, null, null, 6);
        b.on("toHtml", function (a) {
        ...
        b.on("toDataFormat", function (a) {
          ...
          a.data.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(c,
            a.data.context, e(a.data.enterMode, b.config.autoParagraph))
        }, null, null, 5);
        b.on("toDataFormat", function (a) {
      ...
      CKEDITOR.htmlDataProcessor.prototype = {
        toHtml: function (a, b, c, d) {
          var f = this.editor,
            g, e, h, m;
          b && "object" == typeof b ? (g = b.context, c = b.fixForBody, d = b.dontFilter, e = b.filter, h = b.enterMode, m = b.protectedWhitespaces) : g = b;
      ...
      var q = /(?:&nbsp;|\xa0)$/,
        ...
        z = CKEDITOR.tools.extend({}, u.$blockLimit, u.$block),
        w = {
          elements: {
            input: g,
            textarea: g
        ...
        CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
          ...
          filter: function (a, b) {
            ...
            for (h in k) {
              ...
              m && (!1 === (g = a.onAttribute(b, e, m, g)) ? delete k[m] : k[m] = g)
            }
          ...
          writeHtml: function (a, b) {
            ...
            var l = this.name,
              ...
              h, m;
            a.openTag(l, g);
            for (h in g) k.push([h, g[h]]);
            a.sortAttributes && k.sort(e);
            h = 0;
            for (m = k.length; h < m; h++) g =
              k[h], a.attribute(g[0], g[1]);
          ...
          split: function (a) {
            for (var b = this.children.splice(a, this.children.length - a), e = this.clone(), k = 0; k < b.length; ++k) b[k].parent = e;
            e.children = b;
          ...
          find: function (a, b) {
            ...
            for (k = 0; k < this.children.length; k++) {
              ...
              "function" == typeof a && a(g) ? e.push(g) : "string" == typeof a && g.name === a && e.push(g);
              b && g.find && (e = e.concat(g.find(a, b)))
            }
            return e
          },
          addClass: function (a) {
          ...
          getFilterContext: function (a) {
            ...
            a.nonEditable || "false" != this.attributes.contenteditable ? a.nonEditable && !a.nestedEditable && "true" == this.attributes.contenteditable && b.push("nestedEditable",
              !0) : b.push("nonEditable", !0);
            if (b.length) {
    ...
    function () {
      ...
      CKEDITOR.inlineAll = function () {
        ...
        for (b in CKEDITOR.dtd.$editable)
          for (var c = CKEDITOR.document.getElementsByTag(b), d = 0, l = c.count(); d <
            l; d++) a = c.getItem(d), "true" == a.getAttribute("contenteditable") && (e = {
            element: a,
            config: {}
    ...
    function () {
      ...
      function b(a) {
        ...
        k == CKEDITOR.ELEMENT_MODE_REPLACE ? (e.hide(), b.insertAfter(e)) :
          e.append(b);
        a.container = b;
      ...
      CKEDITOR.editor.prototype.setMode = function (a, b) {
        ...
        if (a != e.mode && k && k[a]) {
          ...
          if (e.mode) {
            ...
            "source" == e.mode && k == h && (e.fire("lockSnapshot", {
              forceUpdate: !0
            }), m = 1);
      ...
      CKEDITOR.editor.prototype.resize = function (a, b, e, k) {
        ...
        var f = (k.$.offsetHeight || 0) - (h.$.clientHeight ||
            0),
          g = Math.max(b - (e ? 0 : f), 0);
        b = e ? b + f : b;
        h.setStyle("height", g + "px");
        m && (m.style.width = "100%");
        this.fire("resize", {
          outerHeight: b,
          contentsHeight: g,
    ...
    function () {
      function a(a) {
        ...
        if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
          if (g = e(g, f)) g.appendBogus(), m = CKEDITOR.env.ie;
        k(b, f.block, d) && h.collapsed && !h.getCommonAncestor().isReadOnly() && (f = h.clone(), f.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), d = new CKEDITOR.dom.walker(f), d.guard = function (a) {
          return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
        }, !d.checkForward() || f.checkStartOfBlock() && f.checkEndOfBlock()) && (b = h.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller ||
      ...
      function e(a, b) {
        ...
        var f = b.block || b.blockLimit,
          d = f && f.getLast(c);
        if (!(!f || !f.isBlockBoundary() || d && d.type == CKEDITOR.NODE_ELEMENT && d.isBlockBoundary() || f.is("pre") || f.getBogus())) return f
      }
      ...
      function d(a, b) {
        return function (c) {
          var f = c.data.$.toElement || c.data.$.fromElement || c.data.$.relatedTarget;
      ...
      function l(a) {
        function b(a) {
          return function (b, d) {
            d && b.type == CKEDITOR.NODE_ELEMENT && b.is(g) && (f = b);
            if (!(d || !c(b) || a && r(b))) return !1
          }
        }
        var f, d = a.getRanges()[0];
        a = a.root;
        var g = {
          table: 1,
          ul: 1,
        ...
        if (d.startPath().contains(g)) {
          ...
          a.guard = b();
          a.checkBackward();
          if (f) return e = d.clone(), e.collapse(), e.setEndAt(f, CKEDITOR.POSITION_AFTER_END), a = new CKEDITOR.dom.walker(e), a.guard = b(!0), f = !1, a.checkForward(), f
        }
        return null
      }
        ...
        proto: {
          ...
          insertElement: function (a, b) {
            ...
            this.insertElementIntoRange(a, b) && (b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END), g && ((g =
              a.getNext(function (a) {
                return c(a) && !r(a)
              })) && g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.$block) ? g.getDtd()["#"] ? b.moveToElementEditStart(g) : b.moveToElementEditEnd(a) : g || d == CKEDITOR.ENTER_BR || (g = b.fixBlock(!0, d == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(g))));
            f.selectRanges([b]);
            h(this)
          },
          ...
          insertElementIntoRange: function (a, b) {
            ...
            b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({
              ...
              thead: 1,
              tfoot: 1
            }) ? q(b) : b.startContainer.is(CKEDITOR.dtd.$list) && t(b));
            var e, h;
            if (g)
              for (;
                (e = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[e.getName()]) && (!h || !h[d]);) e.getName() in CKEDITOR.dtd.span ? b.splitElement(e) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(e), b.collapse(!0), e.remove()) : b.splitBlock(f == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
            b.insertNode(a);
            return !0
          },
          setData: function (a,
          ...
          fixInitialSelection: function () {
            function a() {
              var b = c.getDocument().$,
                f = b.getSelection(),
                d;
              a: if (f.anchorNode && f.anchorNode == c.$) d = !0;
                else {
                  if (CKEDITOR.env.webkit && (d = c.getDocument().getActive()) && d.equals(c) && !f.anchorNode) {
                    d = !0;
                    break a
                  }
                  d = void 0
          ...
          extractHtmlFromRange: function (a, b) {
            var c = A,
              ...
              d = this.getHtmlFromRange(a);
            if (a.collapsed) return a.optimize(), d;
            ...
            if (b) {
              c = a.startPath();
              if (f = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) {
                a: {
          ...
          setup: function () {
            ...
            if (!this.is("textarea")) {
              ...
              if (h) {
                var e = g.getHead(),
                  k = e.getCustomData("stylesheet");
                k ? h != k.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? k.$.styleSheet.cssText = h : k.setText(h)) : (h = g.appendStyleText(h), h = new CKEDITOR.dom.element(h.ownerNode || h.owningElement), e.setCustomData("stylesheet", h), h.data("cke-temp", 1))
              }
              e = g.getCustomData("stylesheet_ref") || 0;
              ...
              CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                ...
                if (c in n && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                  ...
                  if (f.collapsed) a: {
                    var d = b.block;
                    if (d && f[c ? "checkStartOfBlock" :
                        "checkEndOfBlock"]() && f.moveToClosestEditablePosition(d, !c) && f.collapsed) {
                      if (f.startContainer.type == CKEDITOR.NODE_ELEMENT) {
                        var g = f.startContainer.getChild(f.startOffset - (c ? 1 : 0));
                      ...
                      f = f.startPath().block;
                      if (!f || f && f.contains(d)) b = void 0;
                      else {
                        a.fire("saveSnapshot");
                        var e;
                        (e = (c ? f : d).getBogus()) && e.remove();
                        e = a.getSelection();
                        g = e.createBookmarks();
                        (c ? d : f).moveChildren(c ? f : d, !1);
                  ...
                  else c = f, e = b.block, f = c.endPath().block, e && f && !e.equals(f) ? (a.fire("saveSnapshot"), (d = e.getBogus()) && d.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), f.getParent() && (f.moveChildren(e, !1), b.lastElement.mergeSiblings(), m(e, f, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                  if (!b) return;
      ...
      CKEDITOR.on("instanceCreated", function (a) {
        ...
        b.on("mode", function () {
          ...
          if (a && a.isInline()) {
            ...
            if (f && (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" : "contents"))) {
              var d = CKEDITOR.tools.getNextId(),
                f = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + d + '" class\x3d"cke_voice_label"\x3e' + f + "\x3c/span\x3e");
              c.append(f);
      ...
      x = function () {
        ...
        function b(c, f) {
          ...
          d = f.range.startPath();
          for (var k = l[k.getName()], n = 0, p = c.getChildren(), q = p.count(), t = -1, u = -1, E = 0, v = d.contains(l.$list); n < q; ++n) d = p.getItem(n), a(d) ? (e = d.getName(), v && e in CKEDITOR.dtd.$list ? m = m.concat(b(d, f)) : (h = !!k[e],
            "br" != e || !d.data("cke-eol") || n && n != q - 1 || (E = (g = n ? m[n - 1].node : p.getItem(n + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && l.$block[g.getName()]), -1 != t || h || (t = n), h || (u = n), m.push({
              isElement: 1,
              isLineBreak: E,
            ...
            node: d,
            allowed: 1
          }); - 1 < t && (m[t].firstNotAllowed = 1); - 1 < u && (m[u].lastNotAllowed = 1);
          return m
        }
        ...
        function f(b, c) {
          ...
          for (n && d.push(" "); m < e; m++) h =
            g.getItem(m), a(h) && !h.is(k) ? d = d.concat(f(h, c)) : d.push(h);
          n && d.push(" ");
          return d
        }
        ...
        function h(b, c, f, d) {
          ...
          (e = (new CKEDITOR.dom.walker(g)).next()) && a(e) && n[e.getName()] && (m = e.getPrevious()) && a(m) && !m.getParent().equals(b.startContainer) && f.contains(m) && d.contains(e) && e.isIdentical(m) &&
            (e.moveChildren(m), e.remove(), h(b, c, f, d))
        }
        ...
        var l = CKEDITOR.dtd,
          ...
          q = CKEDITOR.tools.extend({},
            l.$inline);
        delete q.br;
        return function (n, D, t, u) {
          var v = n.editor,
            x = !1;
          "unfiltered_html" == D && (D = "html", x = !0);
          if (!u.checkReadOnly()) {
            var r = (new CKEDITOR.dom.elementPath(u.startContainer, u.root)).blockLimit || u.root;
            n = {
              type: D,
              dontFilter: x,
              editable: n,
            ...
            u = n.mergeCandidates;
            var I, A;
            "text" == n.type && D.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (I = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", D.document), D.insertNode(I),
              D.setStartAfter(I));
            x = new CKEDITOR.dom.elementPath(D.startContainer);
            n.endPath = r = new CKEDITOR.dom.elementPath(D.endContainer);
            if (!D.collapsed) {
              var v = r.block || r.blockLimit,
                da = D.getCommonAncestor();
              v && !v.equals(da) && !v.contains(da) && D.checkEndOfBlock() && n.zombies.push(v);
              D.deleteContents()
            }
            for (;
              (A = d(D)) && a(A) && A.isBlockBoundary() && x.contains(A);) D.moveToPosition(A, CKEDITOR.POSITION_BEFORE_END);
            h(D, n.blockLimit, x, r);
            I && (D.setEndBefore(I), D.collapse(), I.remove());
            I = D.startPath();
            if (v = I.contains(e, !1,
                1)) D.splitElement(v), n.inlineStylesRoot = v, n.inlineStylesPeak = I.lastElement;
            I = D.createBookmark();
            (v = I.startNode.getPrevious(c)) && a(v) && e(v) && u.push(v);
            (v = I.startNode.getNext(c)) && a(v) && e(v) && u.push(v);
            for (v = I.startNode;
              (v = v.getParent()) && e(v);) u.push(v);
            D.moveToBookmark(I);
            if (I = t) {
              I = n.range;
              if ("text" == n.type && n.inlineStylesRoot) {
                A = n.inlineStylesPeak;
                D = A.getDocument().createText("{cke-peak}");
                for (u = n.inlineStylesRoot.getParent(); !A.equals(u);) D = D.appendTo(A.clone()), A = A.getParent();
                t = D.getOuterHtml().split("{cke-peak}").join(t)
              }
              A =
                n.blockLimit.getName();
              if (/^\s+|\s+$/.test(t) && "span" in CKEDITOR.dtd[A]) {
                var P = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                t = P + t + P
              }
              t = n.editor.dataProcessor.toHtml(t, {
                context: null,
                fixForBody: !1,
              ...
              A = I.document.createElement("body");
              A.setHtml(t);
              P && (A.getFirst().remove(), A.getLast().remove());
              if ((P = I.startPath().block) && (1 != P.getChildCount() || !P.getBogus())) a: {
                var Q;
                if (1 ==
                  A.getChildCount() && a(Q = A.getFirst()) && Q.is(p) && !Q.hasAttribute("contenteditable")) {
                  P = Q.getElementsByTag("*");
                  I = 0;
                  for (u = P.count(); I < u; I++)
                    if (D = P.getItem(I), !D.is(q)) break a;
            ...
            if (I) {
              ...
              var x = n.endPath.elements[0],
                ba, r = x.getPosition(D),
                da = !!x.getCommonAncestor(D) && r != CKEDITOR.POSITION_IDENTICAL && !(r & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
              D = b(n.dataWrapper, n);
              for (m(D, Q); u < D.length; u++) {
                r = D[u];
                if (M = r.isLineBreak) {
                  M = Q;
                  W = A;
                  var Y = void 0,
                    ca = void 0;
                  r.hasBlockSibling ? M = 1 : (Y = M.startContainer.getAscendant(l.$block, 1)) && Y.is({
                    div: 1,
                    p: 1
                ...
                if (M) t = 0 < u;
                  ...
                  M = Q.startPath();
                  !r.isBlock && k(n.editor, M.block, M.blockLimit) && (O = g(n.editor)) && (O = I.createElement(O), O.appendBogus(), Q.insertNode(O),
                    CKEDITOR.env.needsBrFiller && (U = O.getBogus()) && U.remove(), Q.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END));
                  if ((M = Q.startPath().block) && !M.equals(T)) {
                    if (U = M.getBogus()) U.remove(), P.push(M);
                    T = M
                  }
                  r.firstNotAllowed && (v = 1);
                  if (v && r.isElement) {
                    M = Q.startContainer;
                    for (W = null; M && !l[M.getName()][r.name];) {
                      if (M.equals(A)) {
                        M = null;
                        break
                      }
                    ...
                    if (M) W && (aa = Q.splitElement(W), n.zombies.push(aa), n.zombies.push(W));
                    else {
                      W = A.getName();
                      ba = !u;
                      M = u == D.length - 1;
                  ...
                  if (ba) {
                    ...
                    ba = 0
                  } else Q.insertNode(r.node);
                  r.lastNotAllowed && u < D.length - 1 && ((aa = da ? x : aa) && Q.setEndAt(aa, CKEDITOR.POSITION_AFTER_START), v = 0);
                  Q.collapse()
                }
              }
              1 != D.length ? U = !1 : (U = D[0], U = U.isElement && "false" == U.node.getAttribute("contenteditable"));
              U && (t = !0, M = D[0].node, Q.setStartAt(M, CKEDITOR.POSITION_BEFORE_START), Q.setEndAt(M,
            ...
            for (ba = U.createBookmark(); T = n.zombies.pop();) T.getParent() && (O = U.clone(), O.moveToElementEditStart(T), O.removeEmptyBlocksAtEnd());
            if (aa)
              for (; T = aa.pop();) CKEDITOR.env.needsBrFiller ? T.appendBogus() : T.append(U.document.createText(" "));
            for (; T = n.mergeCandidates.pop();) T.mergeSiblings();
            U.moveToBookmark(ba);
            if (!n.dontMoveCaret) {
              for (T = d(U); T && a(T) && !T.is(l.$empty);) {
                if (T.isBlockBoundary()) U.moveToPosition(T,
                  CKEDITOR.POSITION_BEFORE_END);
                else {
                  if (e(T) && T.getHtml().match(/(\s|&nbsp;)$/g)) {
                    ga = null;
                    break
                  }
                  ga = U.clone();
      ...
      q = function () {
        ...
        function c(a) {
          var b = a.count(),
            f;
          for (b; 0 < b--;) f = a.getItem(b), CKEDITOR.tools.trim(f.getHtml()) || (f.appendBogus(), CKEDITOR.env.ie && 9 > CKEDITOR.env.version && f.getChildCount() && f.getFirst().remove())
        }
        return function (f) {
          var d = f.startContainer,
            g = d.getAscendant("table", 1),
            e = !1;
          ...
          g.setStart(d, 0);
          g = a(g).lastBackward();
          g || (g = f.clone(), g.setEndAt(d, CKEDITOR.POSITION_BEFORE_END), g = a(g).lastForward(), e = !0);
          g || (g = d);
          g.is("table") ? (f.setStartAt(g,
            CKEDITOR.POSITION_BEFORE_START), f.collapse(!0), g.remove()) : (g.is({
            tbody: 1,
            thead: 1,
            tfoot: 1
          }) && (g = b(g, "tr", e)), g.is("tr") && (g = b(g, g.getParent().is("thead") ? "th" : "td", e)), (d = g.getBogus()) && d.remove(), f.moveToPosition(g, e ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END))
        }
      }();
      t = function () {
        function a(b) {
        ...
        return function (b) {
          ...
          d.setStart(c, 0);
          d = a(d).lastBackward();
          d || (d = b.clone(), d.setEndAt(c, CKEDITOR.POSITION_BEFORE_END), d = a(d).lastForward(), f = !0);
          d || (d = c);
          d.is(CKEDITOR.dtd.$list) ? (b.setStartAt(d, CKEDITOR.POSITION_BEFORE_START), b.collapse(!0), d.remove()) : ((c = d.getBogus()) && c.remove(), b.moveToPosition(d, f ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END), b.select())
        }
      }();
      u = {
        eol: {
          detect: function (a,
            ...
            e.block && d.checkBoundaryOfElement(e.block, CKEDITOR.START) && (c.setEndBefore(e.block), a.appendEolBr = 1)
          },
          fix: function (a, b) {
            var c = b.getDocument(),
              f;
        ...
        tree: {
          rebuild: function (a, b) {
            var c = a.range,
              ...
              d = new CKEDITOR.dom.elementPath(f, b),
              g = new CKEDITOR.dom.elementPath(c.startContainer, b),
            ...
            if (d.blockLimit.is({
              ...
              var h = d.contains("table").getParent();
              e = function (a) {
                return !a.equals(h)
              }
            } else if (d.block && d.block.is(CKEDITOR.dtd.$listItem) && (g = g.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !g.equals(c))) {
              var m = d.contains(CKEDITOR.dtd.$list).getParent();
              e = function (a) {
                return !a.equals(m)
              }
            }
            e || (e = function (a) {
              return !a.equals(d.block) && !a.equals(d.blockLimit)
            });
            this.rebuildFragment(a, b, f, e)
          },
          rebuildFragment: function (a, b, c, f) {
            for (var d; c && !c.equals(b) &&
              f(c);) d = c.clone(0, 1), a.fragment.appendTo(d), a.fragment = d, c = c.getParent()
          }
        },
        cell: {
          shrink: function (a) {
            ...
            var b = a.startContainer,
              ...
              f = a.startOffset,
              d = a.endOffset;
            b.type == CKEDITOR.NODE_ELEMENT && b.equals(c) && b.is("tr") && ++f == d && a.shrink(CKEDITOR.SHRINK_TEXT)
          }
        }
      };
      A = function () {
        function a(b, c) {
          var f = b.getParent();
          if (f.is(CKEDITOR.dtd.$inline)) b[c ? "insertBefore" : "insertAfter"](f)
        }

        function b(c, f, d) {
          a(f);
          a(d, 1);
          for (var g; g = d.getNext();) g.insertAfter(f), f = g;
          p(c) && c.remove()
        }
        ...
        return {
          list: {
            detectMerge: function (a, b) {
              var f = c(b, a.bookmark),
                d = f.startPath(),
                g = f.endPath(),
                e = d.contains(CKEDITOR.dtd.$list),
                h = g.contains(CKEDITOR.dtd.$list);
              a.mergeList = e && h && e.getParent().equals(h.getParent()) && !e.equals(h);
              a.mergeListItems = d.block && g.block && d.block.is(CKEDITOR.dtd.$listItem) && g.block.is(CKEDITOR.dtd.$listItem);
            ...
            merge: function (a, c) {
              if (a.mergeListBookmark) {
                var f = a.mergeListBookmark.startNode,
                  d = a.mergeListBookmark.endNode,
                  g = new CKEDITOR.dom.elementPath(f, c),
                  e = new CKEDITOR.dom.elementPath(d, c);
                if (a.mergeList) {
                  var h = g.contains(CKEDITOR.dtd.$list),
                    m = e.contains(CKEDITOR.dtd.$list);
                  h.equals(m) || (m.moveChildren(h), m.remove())
                }
                a.mergeListItems && (g = g.contains(CKEDITOR.dtd.$listItem), e = e.contains(CKEDITOR.dtd.$listItem), g.equals(e) || b(e, f, d));
                f.remove();
                d.remove()
              }
            }
            ...
            merge: function (a, c) {
              if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
                var f = a.mergeBlockBookmark.startNode,
                  d = a.mergeBlockBookmark.endNode,
                  g = new CKEDITOR.dom.elementPath(f, c),
                  e = new CKEDITOR.dom.elementPath(d, c),
                  g = g.block,
                  e = e.block;
          ...
          table: function () {
            function a(c) {
              var d = [],
                g, e = new CKEDITOR.dom.walker(c),
                h = c.startPath().contains(f),
                m = c.endPath().contains(f),
                k = {};
              e.guard = function (a, e) {
                if (a.type == CKEDITOR.NODE_ELEMENT) {
                  var n = "visited_" + (e ? "out" : "in");
                  if (a.getCustomData(n)) return;
                  CKEDITOR.dom.element.setMarker(k, a, n, 1)
                }
                if (e && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), d.push(g);
                else if (!e && m && a.equals(m)) g = c.clone(), g.setStartAt(m, CKEDITOR.POSITION_AFTER_START), d.push(g);
                else {
                  if (n = !e) n = a.type == CKEDITOR.NODE_ELEMENT && a.is(f) && (!h || b(a, h)) && (!m || b(a, m));
                  if (!n && (n = e))
                    if (a.is(f)) var n = h && h.getAscendant("table", !0),
                      l = m && m.getAscendant("table", !0),
                      p = a.getAscendant("table", !0),
                      n = n && n.contains(p) || l && l.contains(p);
                    else n = void 0;
                  n && (g = c.clone(), g.selectNodeContents(a), d.push(g))
                }
              };
              e.lastForward();
            ...
            function b(a, c) {
              var f = CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED,
                d = a.getPosition(c);
              return d === CKEDITOR.POSITION_IDENTICAL ?
                !1 : 0 === (d & f)
            }
            var f = {
              td: 1,
            ...
            return {
              detectPurge: function (a) {
                ...
                c.evaluator = function (a) {
                  a.type == CKEDITOR.NODE_ELEMENT && a.is(f) && ++d
                };
                c.checkForward();
                if (1 < d) {
              ...
              detectRanges: function (d, g) {
                var e = c(g, d.bookmark),
                  h = e.clone(),
                  m, k, n = e.getCommonAncestor();
                n.is(CKEDITOR.dtd.$tableContent) && !n.is(f) && (n = n.getAscendant("table", !0));
                k = n;
                n = new CKEDITOR.dom.elementPath(e.startContainer, k);
                k = new CKEDITOR.dom.elementPath(e.endContainer, k);
                n = n.contains("table");
                k = k.contains("table");
                if (n || k) n && k && b(n, k) ? (d.tableSurroundingRange = h, h.setStartAt(n, CKEDITOR.POSITION_AFTER_END), h.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), h = e.clone(), h.setEndAt(n, CKEDITOR.POSITION_AFTER_END),
          ...
          autoParagraph: function (a, b) {
            var c = b.startPath(),
              f;
            k(a, c.block, c.blockLimit) && (f = g(a)) && (f = b.document.createElement(f), f.appendBogus(), b.insertNode(f), b.moveToPosition(f, CKEDITOR.POSITION_AFTER_START))
          }
        }
      }()
    }(),
    function () {
      ...
      function e(b, c) {
        ...
        if ((f = !c && 1 === b.length) && !(f = b[0].collapsed)) {
          ...
          var e = g.endContainer.getAscendant({
            td: 1,
            th: 1
          }, !0);
          d = CKEDITOR.tools.trim;
          f && f.equals(e) && !f.findOne("td, th, tr, tbody, table") ? (g = g.cloneContents(), f = g.getFirst() ? d(g.getFirst().getText()) !== d(f.getText()) : !0) : f = !1
        }
        if (f) return !1;
        for (d = 0; d < b.length; d++)
          if (f = b[d]._getTableElement(), !f) return !1;
        return !0
      }
      ...
      function b(a) {
        ...
        var c = [],
          f, d;
        for (d = 0; d < a.length; d++) f = a[d]._getTableElement(), f.is && f.is({
          td: 1,
          th: 1
      ...
      function c(a) {
        ...
        var c = "",
          f = [],
          d, g;
        for (g = 0; g < a.length; g++) d && !d.equals(a[g].getAscendant("tr")) ? (c += f.join("\t") + "\n", d = a[g].getAscendant("tr"), f = []) : 0 === g && (d = a[g].getAscendant("tr")), f.push(a[g].getText());
        return c += f.join("\t")
      }
      ...
      function d(a) {
        ...
        this.reset();
        z = !0;
        f.root.once("selectionchange", function (a) {
          a.cancel()
        }, null, null, 0);
        f.selectRanges([a[0]]);
        f = this._.cache;
      ...
      function l() {
        ...
        if (b) {
          ...
          if (!(f = !c) && (f = !c.isHidden())) {
            ...
            var d = c.getRanges(),
              g = f.getRanges(),
              h = d.length && d[0]._getTableElement() && d[0]._getTableElement().getAscendant("table", !0),
              m = g.length && g[0]._getTableElement() && g[0]._getTableElement().getAscendant("table",
                !0),
              k = 1 === d.length && d[0]._getTableElement() && d[0]._getTableElement().is("table"),
              n = 1 === g.length && g[0]._getTableElement() && g[0]._getTableElement().is("table");
            if (a(f.getSelectedElement())) f = !1;
            else {
              var l = 1 === d.length && d[0].collapsed,
                g = e(d, !!CKEDITOR.env.webkit) && e(g);
              h = h && m ? h.equals(m) || m.contains(h) : !1;
              h && (l || g) ? (k && !n && f.selectRanges(d), f = !0) : f = !1
            }
            f = !f
          }
          f && (b.reset(), b = 0)
        ...
        c = this.elementPath();
        c.compare(this._.selectionPreviousPath) || (f = this._.selectionPreviousPath && this._.selectionPreviousPath.blockLimit.equals(c.blockLimit), CKEDITOR.env.webkit && !f && (this._.previousActive = this.document.getActive()), this._.selectionPreviousPath = c, this.fire("selectionChange", {
          selection: b,
          path: c
        }))
      }
      ...
      function k() {
        C = !0;
        w || (g.call(this), w = CKEDITOR.tools.setTimeout(g, 200, this))
      }
      ...
      function h(a) {
        return y(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ?
          !0 : !1
      }

      function m(a) {
        function b(c, f) {
          return c && c.type != CKEDITOR.NODE_TEXT ? a.clone()["moveToElementEdit" + (f ? "End" : "Start")](c) : !1
        }
        if (!(a.root instanceof CKEDITOR.editable)) return !1;
        var c = a.startContainer,
          f = a.getPreviousNode(h, null, c),
          d = a.getNextNode(h, null, c);
        return b(f) || b(d, 1) || !(f || d || c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary() && c.getBogus()) ? !0 : !1
      }
        ...
        if (c) {
          if (!1 !== b) {
            var f = a.getDocument().getSelection().getNative(),
              d = f && "None" != f.type && f.getRangeAt(0),
              g = u.length;
            if (c.getLength() > g && d && d.intersectsNode(c.$)) {
              ...
              f.anchorNode == c.$ && f.anchorOffset > g && (e[0].offset -= g);
              f.focusNode == c.$ && f.focusOffset > g && (e[1].offset -= g)
            }
          }
          c.setText(p(c.getText(), 1));
          e && (c = a.getDocument().$, f = c.getSelection(), c = c.createRange(), c.setStart(e[0].node, e[0].offset), c.collapse(!0), f.removeAllRanges(),
            f.addRange(c), f.extend(e[1].node, e[1].offset))
        }
      }
      ...
      function r(a, b) {
        ...
        var f = a.getSelection(1),
          d = a.createRange(),
          g = f.root.on("selectionchange", function (a) {
            a.cancel()
          }, null, null, 0);
        d.setStartAt(c, CKEDITOR.POSITION_AFTER_START);
        ...
        return function (c) {
          ...
          if (b[f]) {
            var d = a.getSelection().getRanges(),
              g = d[0];
            1 == d.length && g.collapsed && (f = g[38 > f ? "getPreviousEditableNode" : "getNextEditableNode"]()) && f.type ==
        ...
        for (var b = 0; b < a.length; b++) {
          ...
          if (!c.collapsed) {
            if (c.startContainer.isReadOnly())
              for (var f = c.startContainer, d; f && !((d = f.type == CKEDITOR.NODE_ELEMENT) && f.is("body") || !f.isReadOnly());) d && "false" == f.getAttribute("contentEditable") && c.setStartAfter(f), f = f.getParent();
            f = c.startContainer;
            d = c.endContainer;
            var g = c.startOffset,
              e = c.endOffset,
            ...
            d && d.type == CKEDITOR.NODE_TEXT && (e ? h.setEndAfter(d) : h.setEndBefore(d));
            ...
            f.evaluator = function (f) {
              if (f.type == CKEDITOR.NODE_ELEMENT && f.isReadOnly()) {
                ...
                f.getPosition(h.endContainer) & CKEDITOR.POSITION_CONTAINS || (d.setStartAfter(f), d.collapsed || a.splice(b + 1, 0, d));
                return !0
              }
              return !1
            };
      ...
      var q = "function" != typeof window.getSelection,
        ...
        A = new RegExp(u + "( )?", "g"),
        z, w, C, y = CKEDITOR.dom.walker.invisible(1),
        B = function () {
          function a(b) {
            return function (a) {
          ...
          function b(a) {
            return function (b) {
              var c = b.editor,
                f = c.createRange(),
                d;
              if (!c.readOnly) return (d = f.moveToClosestEditablePosition(b.selected, a)) || (d = f.moveToClosestEditablePosition(b.selected,
                !a)), d && c.getSelection().selectRanges([f]), c.fire("saveSnapshot"), b.selected.remove(), d || (f.moveToElementEditablePosition(c.editable()), c.getSelection().selectRanges([f])), c.fire("saveSnapshot"), !1
            }
          }
          var c = a(),
            f = a(1);
        ...
        c.on("contentDom", function () {
          ...
          function b() {
            ...
            var a = CKEDITOR.document.$.selection,
              c = a.createRange();
            "None" != a.type && c.parentElement() && c.parentElement().ownerDocument == d.$ && c.select()
          }
          ...
          CKEDITOR.env.gecko && e.attachListener(e, "focus", function (a) {
            a.removeListener();
            0 !== u && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == e.$ && (a = c.createRange(), a.moveToElementEditStart(e), a.select())
          }, null, null, -2);
          e.attachListener(e, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
            u && CKEDITOR.env.webkit && (u = c._.previousActive && c._.previousActive.equals(d.getActive())) && null != c._.previousScrollTop && c._.previousScrollTop !=
              e.$.scrollTop && (e.$.scrollTop = c._.previousScrollTop);
            c.unlockSelection(u);
            u = 0
          }, null, null, -1);
          ...
          if (CKEDITOR.env.ie || p) q ? e.attachListener(e, "beforedeactivate", a, null, null, -1) : e.attachListener(c, "selectionCheck", a, null, null, -1), e.attachListener(e, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
            c.lockSelection(t);
            u = 1
          }, null, null, -1), e.attachListener(e, "mousedown", function () {
            u = 0
          });
          if (CKEDITOR.env.ie && !p) {
            ...
            e.attachListener(e, "mousedown", function (a) {
              2 ==
                a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (w = c.window.getScrollPosition()))
            });
                ...
                m.on("mousedown", function (a) {
                  function b(a) {
                    ...
                    if (r) {
                      ...
                      r.setEndPoint(0 >
                        x.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                      r.select()
                    }
                  }
          ...
          e.attachListener(e, "selectionchange", l, c);
          e.attachListener(e, "keyup", k, c);
          e.attachListener(e, "keydown", function (a) {
            var b = this.getSelection(1);
            f(b) && (b.selectElement(f(b)), a.data.preventDefault())
          }, c);
          e.attachListener(e, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
          ...
          if (p && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
            ...
            e.attachListener(d.getDocumentElement(),
              "mouseup",
              function () {
                A && k.call(c);
                A = 0
              })
          } else e.attachListener(CKEDITOR.env.ie ? e : d.getDocumentElement(), "mouseup", k, c);
          CKEDITOR.env.webkit && e.attachListener(d, "keydown", function (a) {
          ...
          e.attachListener(e, "keydown", v(c), null, null, -1)
        });
      ...
      CKEDITOR.dom.selection = function (a) {
        ...
        var f, d;
        if (a)
          if (a.getRangeAt) f = (d = a.rangeCount && a.getRangeAt(0)) && new CKEDITOR.dom.node(d.commonAncestorContainer);
          else {
            try {
              d = a.createRange()
            } catch (g) {}
            f = d && CKEDITOR.dom.element.get(d.item && d.item(0) || d.parentElement())
      ...
      CKEDITOR.dom.selection.prototype = {
        ...
        getRanges: function () {
          var a = q ? function () {
            ...
            var b = function (b, c) {
              ...
              for (var d = f.children, g, e, h = b.duplicate(), m = 0,
                  k = d.length - 1, n = -1, l, p; m <= k;)
                if (n = Math.floor((m + k) / 2), g = d[n], h.moveToElementText(g), l = h.compareEndPoints("StartToStart", b), 0 < l) k = n - 1;
                else if (0 > l) m = n + 1;
              else return {
                container: f,
                offset: a(g)
              };
              if (-1 == n || n == d.length - 1 && 0 > l) {
                h.moveToElementText(f);
                h.setEndPoint("StartToStart", b);
                h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                d = f.childNodes;
                if (!h) return g = d[d.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? {
                  container: f,
                  offset: d.length
                } : {
                  container: g,
                ...
                for (f = d.length; 0 < h && 0 < f;) e = d[--f], e.nodeType ==
                  CKEDITOR.NODE_TEXT && (p = e, h -= e.nodeValue.length);
                return {
                  container: p,
                  offset: -h
                }
              ...
              for (; 0 < h;) try {
                e = g[0 < l ? "previousSibling" : "nextSibling"], e.nodeType == CKEDITOR.NODE_TEXT && (h -= e.nodeValue.length, p = e), g = e
              } catch (q) {
                return {
                  container: f,
                  offset: a(g)
              ...
              return {
                container: p,
                offset: 0 < l ? -h : p.nodeValue.length + h
              }
            };
            return function () {
              ...
              if (f == CKEDITOR.SELECTION_ELEMENT) {
                for (var f = [], d = 0; d < c.length; d++) {
                  for (var g = c.item(d), e = g.parentNode, h = 0, a = new CKEDITOR.dom.range(this.root); h <
                    e.childNodes.length && e.childNodes[h] != g; h++);
            ...
            for (var f = 0; f < c.rangeCount; f++) {
              var d = c.getRangeAt(f);
              b = new CKEDITOR.dom.range(this.root);
              b.setStart(new CKEDITOR.dom.node(d.startContainer), d.startOffset);
          ...
          return function (b) {
            ...
            return b ? x(new CKEDITOR.dom.rangeList(f.slice())) : f
          }
        }(),
        ...
        getSelectedElement: function () {
          ...
          var b = this,
            c = CKEDITOR.tools.tryThese(function () {
              ...
              function () {
                for (var a = b.getRanges()[0].clone(), c, f, d = 2; d && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && G[c.getName()] && (f = c)); d--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                return f && f.$
              });
        ...
        getSelectedText: function () {
          ...
          var b = this.getNative(),
            b = q ? "Control" == b.type ? "" : b.createRange().text : b.toString();
        ...
        unlock: function (a) {
          if (this.isLocked) {
            ...
            this.isLocked = 0;
            this.reset();
            a && (a = b || c[0] && c[0].getCommonAncestor()) && a.getAscendant("body", 1) && (e(c) ? d.call(this, c) : f ? this.fake(b) : b ? this.selectElement(b) : this.selectRanges(c))
          }
        },
        reset: function () {
          this._.cache = {};
        ...
        selectRanges: function (a) {
          ...
          if (a.length)
            if (this.isLocked) {
              ...
              a: {
                var p, u;
                if (1 == a.length && !(u = a[0]).collapsed && (l = u.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (u = u.clone(), u.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (p = u.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT && (l = p), "false" == l.getAttribute("contenteditable"))) break a;
                l = void 0
              }
              if (l) this.fake(l);
              else if (b && b.plugins.tableselection && CKEDITOR.plugins.tableselection.isSupportedEnvironment && e(a) && !z) d.call(this, a);
              else {
                if (q) {
                  ...
                  if (b.startContainer.type ==
                    CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in u || b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in u) b.shrink(CKEDITOR.NODE_ELEMENT, !0), a = b.collapsed;
                  w = b.createBookmark();
                  u = w.startNode;
                  a || (k = w.endNode);
                  w = b.document.$.body.createTextRange();
                  w.moveToElementText(u.$);
                  w.moveStart("character", 1);
                  k ? (l = b.document.$.body.createTextRange(), l.moveToElementText(k.$), w.setEndPoint("EndToEnd", l), w.moveEnd("character", -1)) : (t = u.getNext(p), v = u.hasAscendant("pre"), t = !(t && t.getText && t.getText().match(l)) &&
                    (v || !u.hasPrevious() || u.getPrevious().is && u.getPrevious().is("br")), v = b.document.createElement("span"), v.setHtml("\x26#65279;"), v.insertBefore(u), t && b.document.createText("﻿").insertBefore(u));
                  b.setStartBefore(u);
                  u.remove();
                  a ? (t ? (w.moveStart("character", -1), w.select(), b.document.$.selection.clear()) : w.select(), b.moveToPosition(v, CKEDITOR.POSITION_BEFORE_START), v.remove()) : (b.setEndBefore(k), k.remove(), w.select())
                } else {
                  k = this.getNative();
                  if (!k) return;
                  ...
                  for (w = 0; w < a.length; w++) {
                    if (w <
                      a.length - 1 && (t = a[w], v = a[w + 1], l = t.clone(), l.setStart(t.endContainer, t.endOffset), l.setEnd(v.startContainer, v.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), b = l.getCommonAncestor(), l = l.getEnclosedNode(), b.isReadOnly() || l && l.isReadOnly()))) {
                      v.setStart(t.startContainer, t.startOffset);
                      a.splice(w--, 1);
                      continue
                    }
                    b = a[w];
                    v = this.document.$.createRange();
                    b.collapsed && CKEDITOR.env.webkit && m(b) && (l = f(this.root), b.insertNode(l), (t = l.getNext()) && !l.getPrevious() && t.type == CKEDITOR.NODE_ELEMENT && "br" ==
                      t.getName() ? (n(this.root), b.moveToPosition(t, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
                    v.setStart(b.startContainer.$, b.startOffset);
                    try {
                      v.setEnd(b.endContainer.$, b.endOffset)
                    } catch (x) {
                      if (0 <= x.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), v.setEnd(b.endContainer.$, b.endOffset);
                      else throw x;
                    }
                    k.addRange(v)
                  }
        ...
        fake: function (a, b) {
          ...
          d.setStartBefore(a);
          d.setEndAfter(a);
          f.ranges = new CKEDITOR.dom.rangeList(d);
        ...
        selectBookmarks: function (a) {
          for (var b = [], c, f = 0; f < a.length; f++) {
            ...
            d.moveToBookmark(a[f]);
            b.push(d)
          }
          a.isFake && (c = e(b) ? b[0]._getTableElement() : b[0].getEnclosedNode(), c && c.type ==
    ...
    function () {
      ...
      function b(c) {
        var f = c.document;
        if (c.collapsed) f = t(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
        else {
          var g =
            this.element,
            h = this._.definition,
          ...
          for (w.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (w = 0); w;) {
            k = !1;
            if (w.equals(u)) w = null, k = !0;
            else {
              var A = w.type == CKEDITOR.NODE_ELEMENT ?
                w.getName() : null,
                x = A && "false" == w.getAttribute("contentEditable"),
                z = A && w.getAttribute("data-nostyle");
              if (A && w.data("cke-bookmark")) {
                w = w.getNextSourceNode(!0);
                continue
              }
              if (x && n && CKEDITOR.dtd.$block[A])
                for (var y = w, B = d(y), C = void 0, G = B.length, ea = 0, y = G && new CKEDITOR.dom.range(y.getDocument()); ea < G; ++ea) {
                  var C = B[ea],
                    E = CKEDITOR.filter.instances[C.data("cke-filter")];
                  if (E ? E.check(this) : 1) y.selectNodeContents(C), b.call(this, y)
                }
              B = A ? !l[A] || z ? 0 : x && !n ? 0 : e(w, u, h, K) : 1;
              if (B)
                if (C = w.getParent(), B = h, G = g, ea = m, !C || !(C.getDtd() ||
                    CKEDITOR.dtd.span)[G] && !ea || B.parentRule && !B.parentRule(C)) k = !0;
                else {
                  if (r || A && CKEDITOR.dtd.$removeEmpty[A] && (w.getPosition(u) | K) != K || (r = c.clone(), r.setStartBefore(w)), A = w.type, A == CKEDITOR.NODE_TEXT || x || A == CKEDITOR.NODE_ELEMENT && !w.getChildCount()) {
                    for (var A = w, F;
                      (k = !A.getNext(I)) && (F = A.getParent(), l[F.getName()]) && e(F, q, h, J);) A = F;
                    r.setEndAfter(A)
                  }
                }
              else k = !0;
              w = w.getNextSourceNode(z || x)
            }
            if (k && r && !r.collapsed) {
              for (var k = t(this, f), x = k.hasAttributes(), z = r.getCommonAncestor(), A = {}, B = {}, C = {}, G = {}, fa, H, ha; k &&
                z;) {
                if (z.getName() == g) {
                  for (fa in h.attributes) !G[fa] && (ha = z.getAttribute(H)) && (k.getAttribute(fa) == ha ? B[fa] = 1 : G[fa] = 1);
                  for (H in h.styles) !C[H] && (ha = z.getStyle(H)) && (k.getStyle(H) == ha ? A[H] = 1 : C[H] = 1)
                }
                z = z.getParent()
              }
              for (fa in B) k.removeAttribute(fa);
              for (H in A) k.removeStyle(H);
              x && !k.hasAttributes() && (k = null);
              k ? (r.extractContents().appendTo(k), r.insertNode(k), v.call(this, k), k.mergeSiblings(), CKEDITOR.env.ie || k.$.normalize()) : (k = new CKEDITOR.dom.element("span"), r.extractContents().appendTo(k), r.insertNode(k),
                v.call(this, k), k.remove(!0));
              r = null
            }
          }
          c.moveToBookmark(p);
      ...
      function c(a) {
        function b() {
          for (var a = new CKEDITOR.dom.elementPath(f.getParent()), c = new CKEDITOR.dom.elementPath(n.getParent()), d = null, g = null, e = 0; e < a.elements.length; e++) {
            var h = a.elements[e];
            if (h == a.block || h == a.blockLimit) break;
            l.checkElementRemovable(h, !0) && (d = h)
          }
          for (e = 0; e < c.elements.length; e++) {
            h = c.elements[e];
            if (h == c.block || h == c.blockLimit) break;
            l.checkElementRemovable(h, !0) &&
              (g = h)
          }
          g && n.breakParent(g);
          d && f.breakParent(d)
        ...
        var c = a.createBookmark(),
          f = c.startNode,
          d = this._.definition.alwaysRemoveElement;
        if (a.collapsed) {
          for (var g = new CKEDITOR.dom.elementPath(f.getParent(), a.root), e, h = 0, m; h < g.elements.length && (m = g.elements[h]) && m != g.block && m != g.blockLimit; h++)
            if (this.checkElementRemovable(m)) {
              var k;
              !d && a.collapsed && (a.checkBoundaryOfElement(m, CKEDITOR.END) || (k = a.checkBoundaryOfElement(m, CKEDITOR.START))) ? (e = m, e.match = k ? "start" : "end") : (m.mergeSiblings(),
                m.is(this.element) ? r.call(this, m) : x(m, z(this)[m.getName()]))
            } if (e) {
            d = f;
            for (h = 0;; h++) {
              m = g.elements[h];
            ...
            d["start" == e.match ? "insertBefore" : "insertAfter"](e)
          }
        } else {
          var n = c.endNode,
            l = this;
          b();
          for (g = f; !g.equals(n);) e = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? r.call(this, g) : x(g, z(this)[g.getName()]), e.type == CKEDITOR.NODE_ELEMENT && e.contains(f) && (b(), e = f.getNext())),
            g = e
        }
        a.moveToBookmark(c);
      ...
      function k(a) {
        ...
        if (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) {
          ...
          if (b.styles)
            for (var d in b.styles) b.styles.hasOwnProperty(d) && a.removeStyle(d)
        }
      }
      ...
      function g(a) {
        ...
        for (var f, d = a.document, g; f = c.getNextParagraph();) !f.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = t(this, d, f), m(f, g));
        a.moveToBookmark(b)
      }
      ...
      function h(a) {
        ...
        for (var f, d; f = c.getNextParagraph();) this.checkElementRemovable(f) && (f.is("pre") ? ((d = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && f.copyAttributes(d), m(f, d)) : r.call(this, f));
        a.moveToBookmark(b)
      }
      ...
      function m(a, b) {
        ...
        if (d && !g) {
          ...
          if (CKEDITOR.env.ie) {
            ...
            h.append(g);
            g.$.outerHTML = "\x3cpre\x3e" + e + "\x3c/pre\x3e";
            g.copyAttributes(h.getFirst());
            g = h.getFirst().remove()
          } else g.setHtml(e);
          b = g
        } else e ? b = p(c ? [a.getHtml()] : f(a), b) : a.moveChildren(b);
        b.replace(a);
        if (d) {
          var c = b,
            m;
      ...
      function r(a, b) {
        var c = this._.definition,
          ...
          e;
        for (e in f)
          if ("class" != e && !this._.definition.fullMatch || a.getAttribute(e) == w(e, f[e])) b && "data-" == e.slice(0, 5) || (g = a.hasAttribute(e), a.removeAttribute(e));
      ...
      function v(a) {
        for (var b = z(this), c = a.getElementsByTag(this.element), f, d = c.count(); 0 <= --d;) f = c.getItem(d), f.isReadOnly() || r.call(this, f, !0);
        for (var g in b)
          if (g != this.element)
            for (c = a.getElementsByTag(g), d = c.count() - 1; 0 <= d; d--) f = c.getItem(d), f.isReadOnly() || x(f, b[g])
      }
        ...
        if (b = b && b.attributes)
          for (var f = 0; f < b.length; f++) {
            ...
            if (g = a.getAttribute(d)) {
              var e = b[f][1];
              (null === e || e.test && e.test(g) || "string" == typeof e && g == e) && a.removeAttribute(d)
            }
          }
        c || q(a)
      }
      ...
      function t(a, b, c) {
        ...
        f = u(f, a);
        b.getCustomData("doc_processing_style") && f.hasAttribute("id") ? f.removeAttribute("id") : b.setCustomData("doc_processing_style", 1);
        return f
      }
      ...
      function u(a, b) {
        ...
        if (f)
          for (var d in f) a.setAttribute(d,
            f[d]);
      ...
      function z(a) {
        ...
        if (c) {
          ...
          for (var f = 0; f < c.length; f++) {
            var d = c[f],
              g, e;
            "string" == typeof d ? g = d.toLowerCase() : (g = d.element ? d.element.toLowerCase() : a.element, e = d.attributes);
            d = b[g] || (b[g] = {});
            if (e) {
              var d = d.attributes = d.attributes || [],
                h;
              for (h in e) d.push([h.toLowerCase(),
                e[h]
              ])
            }
          }
      ...
      function C(a, b) {
        ...
        for (var f in a)
          if (!(f in b) || c(b[f], f) != c(a[f], f) && "inherit" != a[f] && "inherit" != b[f]) return !1;
        return !0
      }
      ...
      function y(a, b, c) {
        ...
        if (a.isFake && a.isInTable())
          for (g = [], e = 0; e < d.length; e++) g.push(d[e].clone());
        for (var h = d.createIterator(); e = h.getNextRange();) b.call(this, e, c);
        a.selectRanges(g || d);
      ...
      CKEDITOR.style = function (a, b) {
        ...
        b && (a = CKEDITOR.tools.clone(a), A(a.attributes, b), A(a.styles,
          b));
        c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() : a.element : "*";
        this.type = a.type || (B[c] ? CKEDITOR.STYLE_BLOCK : G[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
      ...
      CKEDITOR.style.prototype = {
        ...
        applyToRange: function (a) {
          this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? g : this.type == CKEDITOR.STYLE_OBJECT ? l : null;
        ...
        checkActive: function (a, b) {
          switch (this.type) {
            ...
            case CKEDITOR.STYLE_INLINE:
              for (var c = a.elements, f = 0, d; f < c.length; f++)
                if (d = c[f], this.type != CKEDITOR.STYLE_INLINE || d != a.block && d != a.blockLimit) {
        ...
        checkElementMatch: function (a, b) {
          ...
          var f = a.getName();
          if ("string" == typeof this.element ? f == this.element : f in this.element) {
            ...
            if (f = c._AC) c = f;
              ...
              var f = {},
                ...
                g = c.attributes;
              if (g)
                for (var e in g) d++, f[e] = g[e];
              if (e = CKEDITOR.style.getStyleText(c)) f.style || d++, f.style = e;
              f._length = d;
              c = c._AC = f
            }
            if (c._length) {
              for (var h in c)
                if ("_length" != h)
                  if (f = a.getAttribute(h) || "", "style" == h ? C(c[h], f) : c[h] == f) {
                    if (!b) return !0
                  } else if (b) return !1;
              if (b) return !0
            } else return !0
        ...
        buildPreview: function (a) {
          ...
          var c = ["\x3c", f],
            d = b.attributes;
          if (d)
            for (var g in d) c.push(" ", g, '\x3d"', d[g], '"');
          (d = CKEDITOR.style.getStyleText(b)) && c.push(' style\x3d"', d, '"');
          c.push("\x3e", a || b.name,
            "\x3c/", f, "\x3e");
          return c.join("")
        },
      ...
      CKEDITOR.dom.elementPath = function (b, d) {
        ...
        do
          if (h.type == CKEDITOR.NODE_ELEMENT) {
            ...
            if (h.equals(d)) break;
            if (!k && (m = h.getName(), "true" == h.getAttribute("contenteditable") ? k = h : !l && e[m] && (l = h), a[m])) {
              if (m = !l && "div" == m) {
                a: {
                  m = h.getChildren();
    ...
    new CKEDITOR.dom.node, CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
      ...
      split: function (a) {
        var e = this.$.parentNode,
          ...
          c = this.getLength(),
          d = this.getDocument(),
          l = new CKEDITOR.dom.text(this.$.splitText(a), d);
      ...
      var e = {
        createIterator: function () {
          ...
          return {
            getNextRange: function (k) {
              ...
              if (g && 1 < a.length) {
                if (!e)
                  for (var h = a.length - 1; 0 <= h; h--) d.unshift(a[h].createBookmark(!0));
                if (k)
                  for (var m = 0; a[e + m + 1];) {
                    var f = g.document;
                    k = 0;
                    h = f.getById(d[m].endNode);
                    for (f = f.getById(d[m + 1].startNode);;) {
                ...
                for (g.moveToBookmark(d.shift()); m--;) h = a[++e], h.moveToBookmark(d.shift()), g.setEnd(h.endContainer, h.endOffset)
              }
              return g
            }
          }
        ...
        createBookmarks: function (b) {
          for (var c = [], d, e = 0; e < this.length; e++) {
            ...
            for (var k = e + 1; k < this.length; k++) this[k] =
    ...
    function () {
      ...
      function e(b) {
        ...
        if (c)
          for (var c = c.split(",").sort(function (a, b) {
              ...
              e; g < c.length; g++)
            if (e = c[g], d.ie && (e.replace(/^ie/, "") == d.version || d.quirks && "iequirks" == e) && (e = "ie"), d[e]) {
              b += "_" + c[g];
              break
      ...
      CKEDITOR.skin = {
        ...
        getIconStyle: function (a, b, c, d, g) {
          var e;
          ...
          g = g || e && e.bgsize || "16px";
          a && (a = a.replace(/'/g, "\\'"));
          return a && "background-image:url('" + CKEDITOR.getUrl(a) + "');background-position:0 " + d + "px;background-size:" + g + ";"
        }
      };
      CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
        getUiColor: function () {
    ...
    "moono-lisa", CKEDITOR.skin.ua_editor = "ie,iequirks,ie8,gecko", CKEDITOR.skin.ua_dialog = "ie,iequirks,ie8", CKEDITOR.skin.chameleon = function () {
      var a = function () {
          return function (a, c) {
            for (var d = a.match(/[^#]./g), e = 0; 3 > e; e++) {
              var k = e,
                g;
              g = parseInt(d[e], 16);
              g = ("0" + (0 > c ? 0 | g * (1 + c) : 0 | g + (255 - g) * c).toString(16)).slice(-2);
              d[k] = g
            }
            return "#" + d.join("")
          }
      ...
      return function (b, c) {
        ...
        return e[c].output(d).replace(/\[/g, "{").replace(/\]/g, "}")
      }
    }(),
      ...
      onLoad: function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
          labeledElement: function (b, c, f, d) {
            if (!(4 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.uiElement.call(this, b, c, f, "div", null, e, function () {
                var a = [],
                ...
                "horizontal" != c.labelLayout ? a.push('\x3clabel class\x3d"cke_dialog_ui_labeled_label' + f + '" ', ' id\x3d"' + g.labelId + '"', g.inputId ? ' for\x3d"' + g.inputId + '"' : "", (c.labelStyle ? ' style\x3d"' + c.labelStyle + '"' : "") + "\x3e", c.label, "\x3c/label\x3e", '\x3cdiv class\x3d"cke_dialog_ui_labeled_content"',
                  ...
                  children: [{
                    type: "html",
                    html: '\x3clabel class\x3d"cke_dialog_ui_labeled_label' + f + '" id\x3d"' + g.labelId + '" for\x3d"' + g.inputId + '"' + (c.labelStyle ? ' style\x3d"' + c.labelStyle + '"' : "") + "\x3e" + CKEDITOR.tools.htmlEncode(c.label) + "\x3c/label\x3e"
                  }, {
                    type: "html",
          ...
          textarea: function (b, c, f) {
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this, b, c, f, function () {
                ...
                a.push("\x3e", CKEDITOR.tools.htmlEncode(d._["default"]), "\x3c/textarea\x3e\x3c/div\x3e");
                return a.join("")
              })
            }
          },
          checkbox: function (b,
            ...
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.uiElement.call(this, b, c, f, "span", null, null, function () {
                ...
                d.checkbox = new CKEDITOR.ui.dialog.uiElement(b, a, f, "input", null, e);
                f.push(' \x3clabel id\x3d"', g, '" for\x3d"', e.id, '"' + (c.labelStyle ? ' style\x3d"' + c.labelStyle + '"' : "") + "\x3e", CKEDITOR.tools.htmlEncode(c.label), "\x3c/label\x3e");
                return f.join("")
              })
            }
          },
                ...
                function () {
                  for (var a = [], f = [], e = (c.id ? c.id : CKEDITOR.tools.getNextId()) + "_radio", l = 0; l < c.items.length; l++) {
                    var t = c.items[l],
                      ...
                      y = [];
                    g._["default"] == A && (C.checked = "checked");
                    k(z);
                    k(u);
                    "undefined" != typeof z.inputStyle &&
                      (z.style = z.inputStyle);
                    z.keyboardFocusable = !0;
                    d.push(new CKEDITOR.ui.dialog.uiElement(b, z, y, "input", null, C));
                    y.push(" ");
                    new CKEDITOR.ui.dialog.uiElement(b, u, y, "label", null, {
                      id: w,
                      "for": C.id
                    }, t[0]);
                    a.push(y.join(""))
                  }
                  new CKEDITOR.ui.dialog.hbox(b, d, a, f);
                  return f.join("")
                });
              this._.children = d
            }
          ...
          button: function (b, c, f) {
            if (arguments.length) {
              ...
              CKEDITOR.ui.dialog.uiElement.call(this, b, g, f, "a", null, {
                  style: c.style,
          ...
          select: function (b, c, f) {
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this, b, c, f, function () {
                ...
                k(a);
                for (var l = 0, t; l < c.items.length && (t = c.items[l]); l++) g.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== t[1] ? t[1] : t[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(t[0]));
                "undefined" != typeof a.inputStyle && (a.style = a.inputStyle);
                d.select = new CKEDITOR.ui.dialog.uiElement(b, a, f, "select", null,
                  e, g.join(""));
                f.push("\x3c/div\x3e");
                return f.join("")
              })
            ...
            return function (d, g, e) {
              if (!(3 > arguments.length)) {
                ...
                if (q) {
                  var t = this.focus;
                  this.focus = function () {
                    ("function" == typeof q ? q : t).call(this);
                    this.fire("focus")
                  };
                  g.isFocusable && (this.isFocusable = this.isFocusable);
                  this.keyboardFocusable = !0
                }
                CKEDITOR.ui.dialog.uiElement.call(this, d, g, k, "span", null, null, "");
                k = k.join("").match(a);
                l = l.match(b) || ["", "", ""];
        ...
        CKEDITOR.ui.dialog.select.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, {
          ...
          add: function (a, b, c) {
            ...
            void 0 === c || null === c ? CKEDITOR.env.ie ? g.add(d.$) : g.add(d.$, null) : g.add(d.$, c);
            return this
          },
          remove: function (a) {
        ...
        CKEDITOR.dialog.addUIElement("fieldset", {
          build: function (a, b, c) {
            for (var d = b.children, g, e = [], k = [], l = 0; l < d.length && (g = d[l]); l++) {
              var q = [];
              e.push(q);
              k.push(CKEDITOR.dialog._.uiElementBuilders[g.type].build(a, g, q))
            }
    ...
    function () {
      ...
      function l(a) {
        var b = CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog", x).output({
      ...
      function m(a) {
        function b(c) {
          ...
          d.x += q;
          d.y += u;
          a.move(d.x + h[3] < e ? -h[3] : d.x - h[1] > l.width - k.width - e ? l.width - k.width + ("rtl" == g.lang.dir ? 0 : h[1]) : d.x, d.y + h[0] < e ? -h[0] : d.y - h[2] > l.height - k.height - e ? l.height - k.height + h[2] : d.y, 1);
        ...
        function c() {
          ...
          if (CKEDITOR.env.ie6Compat) {
            var a = y.getChild(0).getFrameDocument();
      ...
      function f(a) {
        function b(c) {
          var n = "rtl" == g.lang.dir,
            q = m.width,
            u = m.height,
            t = q + (c.data.$.screenX - l.x) * (n ? -1 : 1) * (a._.moved ? 1 : 2),
            p = u + (c.data.$.screenY - l.y) * (a._.moved ? 1 : 2),
            w = a._.element.getFirst(),
            w = n && w.getComputedStyle("right"),
            v = a.getPosition();
          v.y + p > k.height && (p = k.height - v.y);
          (n ? w : v.x) + t > k.width && (t = k.width - (n ? w : v.x));
          if (d == CKEDITOR.DIALOG_RESIZE_WIDTH || d == CKEDITOR.DIALOG_RESIZE_BOTH) q = Math.max(f.minWidth ||
            0, t - e);
          if (d == CKEDITOR.DIALOG_RESIZE_HEIGHT || d == CKEDITOR.DIALOG_RESIZE_BOTH) u = Math.max(f.minHeight || 0, p - h);
          a.resize(q, u);
          a._.moved || a.layout();
          c.data.preventDefault()
        }
        ...
        if (d != CKEDITOR.DIALOG_RESIZE_NONE) {
          var g = a.getParentEditor(),
            e, h, k, l, m, n, q = CKEDITOR.tools.addFunction(function (f) {
              m = a.getSize();
              var d = a.parts.contents;
              d.$.getElementsByTagName("iframe").length && (n = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_dialog_resize_cover" style\x3d"height: 100%; position: absolute; width: 100%;"\x3e\x3c/div\x3e'), d.append(n));
              h = m.height - a.parts.contents.getSize("height", !(CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.quirks));
              e = m.width - a.parts.contents.getSize("width", 1);
              l = {
                x: f.screenX,
                y: f.screenY
              };
              ...
              CKEDITOR.document.on("mousemove", b);
              CKEDITOR.document.on("mouseup", c);
              CKEDITOR.env.ie6Compat && (d = y.getChild(0).getFrameDocument(), d.on("mousemove", b), d.on("mouseup", c));
      ...
      function p(a) {
        var b = CKEDITOR.document.getWindow(),
          ...
          d = c.dialog_backgroundCoverColor || ("moono-lisa" == f ? "black" : "white"),
          f = c.dialog_backgroundCoverOpacity,
          g = c.baseFloatZIndex,
          c = CKEDITOR.tools.genKey(d, f, g),
          e = C[c];
        e ? e.show() :
      ...
      function r(a) {
        y && (a.focusManager.remove(y), a = CKEDITOR.document.getWindow(), y.hide(), a.removeListener("resize", w), CKEDITOR.env.ie6Compat && a.$.setTimeout(function () {
          window.onscroll = window.onscroll && window.onscroll.prevScrollHandler || null
        }, 0), w = null)
      }
      var v = CKEDITOR.tools.cssLength,
        x = '\x3cdiv class\x3d"cke_reset_all {editorId} {editorDialogClass} {hidpi}" dir\x3d"{langDir}" lang\x3d"{langCode}" role\x3d"dialog" aria-labelledby\x3d"cke_dialog_title_{id}"\x3e\x3ctable class\x3d"cke_dialog ' +
      ...
      CKEDITOR.dialog = function (b, g) {
        ...
        function k(a) {
          ...
          if (!(1 > b.length)) {
            ...
            do {
              d += a;
              if (g && !B._.tabBarMode && (d == b.length || -1 == d)) {
                B._.tabBarMode = !0;
        ...
        function n(c) {
          if (B == CKEDITOR.dialog._.currentTop) {
            var f = c.data.getKeystroke(),
              ...
              g = [37, 38, 39, 40];
            y = r = 0;
            if (9 == f || f == CKEDITOR.SHIFT + 9) k(f == CKEDITOR.SHIFT + 9 ? -1 : 1), y = 1;
            else if (f == CKEDITOR.ALT + 121 && !B._.tabBarMode && 1 < B.getPageCount()) B._.tabBarMode = !0, B._.tabs[B._.currentTabId][0].focus(), B._.currentFocusIndex = -1, y = 1;
            else if (-1 != CKEDITOR.tools.indexOf(g,
                f) && B._.tabBarMode) f = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], f) ? a.call(B) : e.call(B), B.selectPage(f), B._.tabs[f][0].focus(), y = 1;
            else if (13 != f && 32 != f || !B._.tabBarMode)
              if (13 == f) f = c.data.getTarget(), f.is("a", "button", "select", "textarea") || f.is("input") && "button" == f.$.type || ((f = this.getButton("ok")) && CKEDITOR.tools.setTimeout(f.click, 0, f), y = 1), r = 1;
              else if (27 == f)(f = this.getButton("cancel")) ? CKEDITOR.tools.setTimeout(f.click, 0, f) : !1 !== this.fire("cancel", {
              hide: !0
            }).hide && this.hide(), r = 1;
            else return;
            else this.selectPage(this._.currentTabId),
              this._.tabBarMode = !1, this._.currentFocusIndex = -1, k(1), y = 1;
            u(c)
          }
        }

        function u(a) {
          y ? a.data.preventDefault(1) : r && a.data.stopPropagation()
        }
        var t = CKEDITOR.dialog._.dialogDefinitions[g],
          p = CKEDITOR.tools.clone(q),
          w = b.config.dialog_buttonsOrder || "OS",
          v = b.lang.dir,
          A = {},
          y, r;
        ("OS" == w && CKEDITOR.env.mac || "rtl" == w && "ltr" == v || "ltr" == w && "rtl" == v) && p.buttons.reverse();
        t = CKEDITOR.tools.extend(t(b), p);
        ...
        p["rtl" == v ? "right" : "left"] = 0;
        this.parts.dialog.setStyles(p);
        CKEDITOR.event.call(this);
        this.definition = t = CKEDITOR.fire("dialogDefinition", {
          name: g,
          definition: t
        }, b).definition;
        if (!("removeDialogTabs" in b._) && b.config.removeDialogTabs) {
          ...
          for (v = 0; v < p.length; v++)
            if (w = p[v].split(":"), 2 == w.length) {
              var x = w[0];
              A[x] || (A[x] = []);
              A[x].push(w[1])
            } b._.removeDialogTabs = A
        }
        if (b._.removeDialogTabs && (A = b._.removeDialogTabs[g]))
          for (v = 0; v < A.length; v++) t.removeContents(A[v]);
        if (t.onLoad) this.on("load", t.onLoad);
        if (t.onShow) this.on("show", t.onShow);
        if (t.onHide) this.on("hide", t.onHide);
        if (t.onOk) this.on("ok", function (a) {
          b.fire("saveSnapshot");
          setTimeout(function () {
            b.fire("saveSnapshot")
          }, 0);
          !1 === t.onOk.call(this, a) && (a.data.hide = !1)
        });
        this.state = CKEDITOR.DIALOG_STATE_IDLE;
        if (t.onCancel) this.on("cancel", function (a) {
          !1 === t.onCancel.call(this, a) && (a.data.hide = !1)
        });
        var B = this,
          O = function (a) {
            var b = B._.contents,
          ...
          O(function (b) {
            if (b.validate) {
              var f = b.validate(this),
                d = "string" == typeof f || !1 === f;
              d && (a.data.hide = !1, a.stop());
              c.call(b, !d, "string" == typeof f ?
                f : void 0);
              return d
            }
          })
        ...
        this.on("show", function () {
          C.on("keydown", n, this);
          if (CKEDITOR.env.gecko) C.on("keypress", u, this)
        });
        this.on("hide",
          function () {
            C.removeListener("keydown", n);
            CKEDITOR.env.gecko && C.removeListener("keypress", u);
            O(function (a) {
              d.apply(a)
            })
          });
        ...
        this.on("show", function () {
          ...
          b.config.dialog_startupFocusTab && a ? (B._.tabBarMode = !0, B._.tabs[B._.currentTabId][0].focus(), B._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = a ? -1 : this._.focusList.length - 1, t.onFocus ?
        ...
        for (v = 0; v < t.contents.length; v++)(A = t.contents[v]) && this.addPage(A);
        ...
        v = [];
        A = CKEDITOR.dialog._.uiElementBuilders.hbox.build(this, {
          type: "hbox",
        ...
        for (v = 0; v < A.length; v++) this._.buttons[A[v].id] = A[v]
      };
      CKEDITOR.dialog.prototype = {
            ...
            if (b.contents[c]) {
              ...
              if (f) {
                for (var h in this._.contents[a.id]) {
                  ...
                  "hbox" != k.type && "vbox" != k.type && k.getInputElement() && (k.requiredContent && !this._.editor.activeFilter.check(k.requiredContent) ? k.disable() : (k.enable(), e++))
                }!e || d && !this._.editor.activeFilter.check(d) ? f[0].addClass("cke_dialog_tab_disabled") :
        ...
        layout: function () {
          ...
          CKEDITOR.env.ie6Compat || (b.height + (0 < d ? d : 0) > c.height || b.width + (0 < f ? f : 0) > c.width ? a.setStyle("position", "absolute") : a.setStyle("position", "fixed"));
          this.move(this._.moved ? this._.position.x : f, this._.moved ? this._.position.y : d)
        },
        foreach: function (a) {
        ...
        addPage: function (a) {
          if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
            for (var b = [], c = a.label ? ' title\x3d"' + CKEDITOR.tools.htmlEncode(a.label) + '"' : "", f = CKEDITOR.dialog._.uiElementBuilders.vbox.build(this, {
              ...
              }, b), d = this._.contents[a.id] = {}, g = f.getChild(), e = 0; f = g.shift();) f.notAllowed || "hbox" == f.type || "vbox" == f.type || e++, d[f.id] = f, "function" == typeof f.getChild && g.push.apply(g, f.getChild());
            e || (a.hidden = !0);
            ...
            c = CKEDITOR.dom.element.createFromHtml(['\x3ca class\x3d"cke_dialog_tab"',
              0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ? ' style\x3d"display:none"' : "", ' id\x3d"', d, '"', f.gecko && !f.hc ? "" : ' href\x3d"javascript:void(0)"', ' tabIndex\x3d"-1" hidefocus\x3d"true" role\x3d"tab"\x3e', a.label, "\x3c/a\x3e"
            ].join(""));
          ...
          if (this._.currentTabId != a && !this._.tabs[a][0].hasClass("cke_dialog_tab_disabled") && !1 !== this.fire("selectPage", {
            ...
            for (var c in this._.tabs) {
              var f = this._.tabs[c][0],
                d = this._.tabs[c][1];
              c != a && (f.removeClass("cke_dialog_tab_selected"), d.hide());
              d.setAttribute("aria-hidden", c != a)
            }
            var g = this._.tabs[a];
            g[0].addClass("cke_dialog_tab_selected");
            CKEDITOR.env.ie6Compat ||
              CKEDITOR.env.ie7Compat ? (b(g[1]), g[1].show(), setTimeout(function () {
                b(g[1], 1)
              }, 0)) : g[1].show();
      ...
      var q = {
        ...
        t = function (a, b, c) {
          for (var f = 0, d; d = a[f]; f++)
            if (d.id == b || c && d[c] && (d = t(d[c], b, c))) return d;
          return null
        },
        u = function (a, b, c, f, d) {
          if (c) {
            for (var g = 0, e; e = a[g]; g++) {
              if (e.id == c) return a.splice(g, 0, b), b;
              if (f && e[f] && (e = u(e[f], b, c, f, !0))) return e
            }
            if (d) return null
          }
          a.push(b);
        ...
        z = function (a, b) {
          this.dialog = a;
          for (var c = b.contents, f = 0, d; d = c[f]; f++) c[f] = d && new h(a, d);
          CKEDITOR.tools.extend(this, b)
        };
      z.prototype = {
      ...
      var w, C = {},
        ...
        G = function (a) {
          ...
          (b = B[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (f ? "SHIFT+" : "") + d]) && b.length && (b = b[b.length - 1], b.keydown && b.keydown.call(b.uiElement, b.dialog, b.key), a.data.preventDefault())
        },
        E = function (a) {
          var b = a.data.$.ctrlKey || a.data.$.metaKey,
            c = a.data.$.altKey,
            f = a.data.$.shiftKey,
            d = String.fromCharCode(a.data.$.keyCode);
          (b = B[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (f ? "SHIFT+" : "") + d]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key), a.data.preventDefault()))
        },
        F = function (a, b, c, f, d) {
          (B[c] || (B[c] = [])).push({
            uiElement: a,
            dialog: b,
            key: c,
        ...
        I = function (a) {
          for (var b in B) {
            for (var c = B[b], f = c.length - 1; 0 <= f; f--) c[f].dialog != a && c[f].uiElement != a || c.splice(f, 1);
        ...
        CKEDITOR.ui.dialog = {
          uiElement: function (a, b, c, f, d, g, e) {
            if (!(4 > arguments.length)) {
              ...
              m.id = q;
              var u = {};
              b.type && (u["cke_dialog_ui_" +
                b.type] = 1);
              b.className && (u[b.className] = 1);
              b.disabled && (u.cke_disabled = 1);
              for (var t = m["class"] && m["class"].split ? m["class"].split(" ") : [], q = 0; q < t.length; q++) t[q] && (u[t[q]] = 1);
              t = [];
              for (q in u) t.push(q);
              m["class"] = t.join(" ");
              ...
              for (q in l) u.push(q + ":" + l[q]);
              b.hidden && u.push("display:none");
              for (q = u.length - 1; 0 <= q; q--) "" === u[q] && u.splice(q, 1);
              0 < u.length && (m.style =
                (m.style ? m.style + "; " : "") + u.join("; "));
              ...
              CKEDITOR.ui.dialog.uiElement.call(this,
                ...
                function () {
                  ...
                  for (k = 0; k < c.length; k++) {
                    ...
                    e ? e[k] && f.push("width:" + v(e[k])) : f.push("width:" + Math.floor(100 / c.length) + "%");
                    h && f.push("height:" + v(h));
                    d && void 0 !== d.padding && f.push("padding:" + v(d.padding));
                    CKEDITOR.env.ie && CKEDITOR.env.quirks &&
            ...
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.uiElement.call(this, a, d || {
                ...
                for (var f = 0; f < c.length; f++) {
                  ...
                  h ? k.push("height:" + v(h[f])) : d && d.expand && k.push("height:" + Math.floor(100 / c.length) + "%");
      ...
      (function () {
        var a = {
          build: function (a, b, c) {
            for (var f = b.children, d, g = [], e = [], h = 0; h < f.length && (d = f[h]); h++) {
              var k = [];
              g.push(k);
              e.push(CKEDITOR.dialog._.uiElementBuilders[d.type].build(a, d, k))
            }
          ...
          functions: function () {
            ...
            return function () {
              ...
              for (g = 0; g < a.length; g++)
                if ("function" == typeof a[g]) d.push(a[g]);
                else break;
              g < a.length && "string" == typeof a[g] && (c = a[g], g++);
              g < a.length && "number" == typeof a[g] && (f = a[g]);
              var e = f == CKEDITOR.VALIDATE_AND ? !0 : !1;
              for (g = 0; g < d.length; g++) e = f == CKEDITOR.VALIDATE_AND ? e &&
                d[g](b) : e || d[g](b);
              return e ? !0 : c
            }
          },
      ...
      CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
        openDialog: function (a, b) {
          ...
          if ("function" == typeof f) c = this._.storedDialogs || (this._.storedDialogs = {}), c = c[a] || (c[a] = new CKEDITOR.dialog(this, a)), b && b.call(c, c), c.show();
            ...
            if ("failed" == f) throw r(this), Error('[CKEDITOR.dialog.openDialog] Dialog "' + a + '" failed when loading definition.');
    ...
    function () {
      ...
      init: function (a) {
        var e = 0,
          b = function (b, d, h, l) {
            if (l) {
              ...
              a.addCommand(h, new CKEDITOR.styleCommand(l, {
                contentForms: f
              }));
        ...
        b("Strike",
          l.strike, "strike", d.coreStyles_strike);
      ...
      var a = {
        exec: function (a) {
          ...
          if (d) {
            ...
            var m = d.createIterator();
            m.enlargeBr = a.config.enterMode != CKEDITOR.ENTER_BR;
            if (b == CKEDITOR.TRISTATE_OFF) {
              for (k = []; b = m.getNextParagraph();) k.push(b);
              1 > k.length && (b = a.document.createElement(a.config.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), g = l.shift(), d.insertNode(b), b.append(new CKEDITOR.dom.text("﻿", a.document)), d.moveToBookmark(g), d.selectNodeContents(b), d.collapse(!0), g = d.createBookmark(), k.push(b), l.unshift(g));
              h = k[0].getParent();
              d = [];
              for (g = 0; g < k.length; g++) b = k[g], h = h.getCommonAncestor(b.getParent());
              for (b = {
                  table: 1,
                  tbody: 1,
                  tr: 1,
              ...
              for (; 0 < d.length;)
                if (b = d.shift(), "blockquote" == b.getName()) {
                  for (g = new CKEDITOR.dom.documentFragment(a.document); b.getFirst();) g.append(b.getFirst().remove()), k.push(g.getLast());
                  g.replace(b)
                } else k.push(b);
              ...
              for (h = {}; b = m.getNextParagraph();) {
                ...
                d && k && !k.getCustomData("blockquote_moveout") && (g.push(k), CKEDITOR.dom.element.setMarker(h, k, "blockquote_moveout", !0))
              }
              CKEDITOR.dom.element.clearAllMarkers(h);
              b = [];
              k = [];
              for (h = {}; 0 < g.length;) m = g.shift(), d = m.getParent(), m.getPrevious() ? m.getNext() ? (m.breakParent(m.getParent()),
                k.push(m.getNext())) : m.remove().insertAfter(d) : m.remove().insertBefore(d), d.getCustomData("blockquote_processed") || (k.push(d), CKEDITOR.dom.element.setMarker(h, d, "blockquote_processed", !0)), b.push(m);
              CKEDITOR.dom.element.clearAllMarkers(h);
              for (g = k.length - 1; 0 <= g; g--) {
                d = k[g];
                a: {
                  h = d;
                  for (var m = 0, f = h.getChildCount(), n = void 0; m < f && (n = h.getChild(m)); m++)
              ...
              if (a.config.enterMode == CKEDITOR.ENTER_BR)
                for (d = !0; b.length;)
                  if (m = b.shift(),
                    "div" == m.getName()) {
                    g = new CKEDITOR.dom.documentFragment(a.document);
                    !d || !m.getPrevious() || m.getPrevious().type == CKEDITOR.NODE_ELEMENT && m.getPrevious().isBlockBoundary() || g.append(a.document.createElement("br"));
                    for (d = m.getNext() && !(m.getNext().type == CKEDITOR.NODE_ELEMENT && m.getNext().isBlockBoundary()); m.getFirst();) m.getFirst().remove().appendTo(g);
                    d && g.append(a.document.createElement("br"));
                    g.replace(m);
                    d = !1
                  }
            }
    ...
    function () {
        ...
        init: function (a) {
          ...
          a.on("key", function (d) {
            if (27 ==
              ...
              e.length && (c(a.lang.notification.closed), e[e.length - 1].hide(), d.cancel())
            }
          })
        }
      });
      a.prototype = {
        ...
        update: function (a) {
          ...
          var d = this.element,
            e = d.findOne(".cke_notification_message"),
            k = d.findOne(".cke_notification_progress"),
            g = a.type;
          d.removeAttribute("role");
          a.progress && "progress" != this.type && (g = "progress");
          g && (d.removeClass(this._getClass()), d.removeAttribute("aria-label"), this.type = g, d.addClass(this._getClass()), d.setAttribute("aria-label", this.type), "progress" != this.type || k ? "progress" != this.type && k && k.remove() : (k = this._createProgressElement(), k.insertBefore(e)));
          ...
          c && a.important && (d.setAttribute("role",
            "alert"), this.isVisible() || this.area.add(this));
        ...
        _createElement: function () {
          var a = this,
            c, d, e = this.editor.lang.common.close;
          ...
          c.append(d);
          d = CKEDITOR.dom.element.createFromHtml('\x3ca class\x3d"cke_notification_close" href\x3d"javascript:void(0)" title\x3d"' + e + '" role\x3d"button" tabindex\x3d"-1"\x3e\x3cspan class\x3d"cke_label"\x3eX\x3c/span\x3e\x3c/a\x3e');
          c.append(d);
          d.on("click", function () {
            a.editor.focus();
            a.hide()
        ...
        _hideAfterTimeout: function () {
          ...
          else if ("info" == this.type || "success" ==
            this.type) c = "number" == typeof this.editor.config.notification_duration ? this.editor.config.notification_duration : 5E3;
      ...
      e.prototype = {
        ...
        remove: function (a) {
          ...
          0 > c || (this.notifications.splice(c, 1), a.element.remove(),
        ...
        _createElement: function () {
          ...
          d.setStyle("z-index", c.baseFloatZIndex - 2);
          return d
        },
        ...
        _layout: function () {
          function a() {
            c.setStyle("left", t(u + e.width - n - p))
          }
          var c = this.element,
            d =
            this.editor,
            e = d.ui.contentsElement.getClientRect(),
            k = d.ui.contentsElement.getDocumentPosition(),
            g, h, m = c.getClientRect(),
            f, n = this._notificationWidth,
            p = this._notificationMargin;
          f = CKEDITOR.document.getWindow();
          var r = f.getScrollPosition(),
            v = f.getViewPaneSize(),
            x = CKEDITOR.document.getBody(),
            q = x.getDocumentPosition(),
            t = CKEDITOR.tools.cssLength;
          n && p || (f = this.element.getChild(0), n = this._notificationWidth = f.getClientRect().width, p = this._notificationMargin = parseInt(f.getComputedStyle("margin-left"), 10) + parseInt(f.getComputedStyle("margin-right"),
            10));
          d.toolbar && (g = d.ui.space("top"), h = g.getClientRect());
          g && g.isVisible() && h.bottom > e.top && h.bottom < e.bottom - m.height ? c.setStyles({
            position: "fixed",
            top: t(h.bottom)
          }) : 0 < e.top ? c.setStyles({
            position: "absolute",
            top: t(k.y)
          }) : k.y + e.height - m.height > r.y ? c.setStyles({
            position: "fixed",
            top: 0
          }) : c.setStyles({
            position: "absolute",
            top: t(k.y + e.height - m.height)
          });
          var u = "fixed" == c.getStyle("position") ? e.left : "static" != x.getComputedStyle("position") ? k.x - q.x : k.x;
          e.width < n + p ? k.x + n + p > r.x + v.width ? a() : c.setStyle("left",
            t(u)) : k.x + n + p > r.x + v.width ? c.setStyle("left", t(u)) : k.x + e.width / 2 + n / 2 + p > r.x + v.width ? c.setStyle("left", t(u - k.x + r.x + v.width - n - p)) : 0 > e.left + e.width - n - p ? a() : 0 > e.left + e.width / 2 - n / 2 ? c.setStyle("left", t(u - k.x + r.x)) : c.setStyle("left", t(u + e.width / 2 - n / 2 - p / 2))
        }
      };
    ...
    function () {
      ...
      CKEDITOR.ui.button.prototype = {
        render: function (a, d) {
          function l() {
            var b = a.mode;
            b && (b = this.modes[b] ? void 0 !== k[b] ? k[b] : CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, b = a.readOnly && !this.readOnly ? CKEDITOR.TRISTATE_DISABLED :
          ...
          var v = {
            ...
            x = CKEDITOR.tools.addFunction(function (a) {
              if (v.onkey) return a = new CKEDITOR.dom.event(a), !1 !== v.onkey(v, a.getKeystroke())
            }),
            q = CKEDITOR.tools.addFunction(function (a) {
              var b;
              v.onfocus &&
                (b = !1 !== v.onfocus(v, new CKEDITOR.dom.event(a)));
              return b
            }),
            t = 0;
          v.clickFn = n = CKEDITOR.tools.addFunction(function () {
            t && (a.unlockSelection(1), t = 0);
            v.execute();
            g.iOS && a.focus()
          });
          this.modes ? (k = {}, a.on("beforeModeUnload", function () {
            a.mode && this._.state != CKEDITOR.TRISTATE_DISABLED && (k[a.mode] = this._.state)
          }, this), a.on("activeFilterChange", l, this), a.on("mode", l, this), !this.readOnly && a.on("readOnly", l, this)) : f && (f = a.getCommand(f)) && (f.on("state", function () {
              this.setState(f.state)
            }, this), m += f.state == CKEDITOR.TRISTATE_ON ?
            "on" : f.state == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off");
          var u;
          if (this.directional) a.on("contentDirChanged", function (b) {
            ...
            d.setAttribute("style", CKEDITOR.skin.getIconStyle(u, "rtl" == b, this.icon, this.iconOffset))
          }, this);
          f ? (p = a.getCommandKeystroke(f)) && (r = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard, p)) : m += "off";
          p = this.name || this.command;
          var A =
            null,
            z = this.icon;
          u = p;
          this.icon && !/\./.test(this.icon) ? (u = this.icon, z = null) : (this.icon && (A = this.icon), CKEDITOR.env.hidpi && this.iconHiDpi && (A = this.iconHiDpi));
          A ? (CKEDITOR.skin.addIcon(A, A), z = null) : A = u;
          m = {
            id: h,
            name: p,
            iconName: u,
            ...
            ariaShortcut: r ? a.lang.common.keyboardShortcut + " " + r.aria : "",
            titleJs: g.gecko && !g.hc ? "" : (this.title || "").replace("'", ""),
            hasArrow: this.hasArrow ? "true" : "false",
            keydownFn: x,
            focusFn: q,
            clickFn: n,
            style: CKEDITOR.skin.getIconStyle(A, "rtl" == a.lang.dir, z, this.iconOffset),
        ...
        setState: function (a) {
          ...
          return b ? (b.setState(a, "cke_button"), a == CKEDITOR.TRISTATE_DISABLED ? b.setAttribute("aria-disabled", !0) : b.removeAttribute("aria-disabled"), this.hasArrow ? (a = a == CKEDITOR.TRISTATE_ON ? this._.editor.lang.button.selectedLabel.replace(/%1/g,
    ...
    function () {
      function a(a) {
        function b() {
          for (var f =
              c(), h = CKEDITOR.tools.clone(a.config.toolbarGroups) || e(a), m = 0; m < h.length; m++) {
            var l = h[m];
            if ("/" != l) {
              ...
              var x, q = l.groups;
              if (q)
                for (var t = 0; t < q.length; t++) x = q[t], (x = f[x]) && g(l, x);
              (x = f[l.name]) && g(l, x)
            }
          }
          return h
        ...
        function c() {
          var b = {},
            f, g, e;
          for (f in a.ui.items) g = a.ui.items[f], e = g.toolbar || "others", e = e.split(","), g = e[0], e = parseInt(e[1] || -1, 10), b[g] || (b[g] = []), b[g].push({
            name: f,
            order: e
          });
        ...
        function g(b, c) {
          if (c.length) {
            ...
            for (var f; f = c.shift();) f = "string" == typeof f ? f : f.name, m && -1 != CKEDITOR.tools.indexOf(m, f) || (f = a.ui.create(f)) && a.addFeature(f) && b.items.push(f)
          }
        }
        ...
        function h(a) {
          var b = [],
            c, f, d;
          for (c = 0; c < a.length; ++c) f = a[c], d = {}, "/" == f ? b.push(f) : CKEDITOR.tools.isArray(f) ? (g(d, CKEDITOR.tools.clone(f)), b.push(d)) : f.items && (g(d, CKEDITOR.tools.clone(f.items)), d.name = f.name, b.push(d));
          return b
        }
            ...
            switch (b) {
              ...
              case CKEDITOR.SHIFT + 9:
                for (; !c || !c.items.length;)
                  if (c = 9 == b ? (c ? c.next : a.toolbar.next) || d.toolbox.toolbars[0] : (c ? c.previous : a.toolbar.previous) || d.toolbox.toolbars[d.toolbox.toolbars.length - 1], c.items.length)
              ...
              case p:
                c = a;
                do c = c.next, !c &&
                  n && (c = a.toolbar.items[0]); while (c && !c.focus);
                c ? c.focus() : k(a, 9);
                return !1;
              case 40:
              ...
              case 38:
                ...
                c ? c.focus() : (e = 1, k(a, CKEDITOR.SHIFT + 9), e = 0);
                return !1;
              case 27:
                return d.focus(), !1;
              case 13:
          ...
          d.on("uiSpace", function (c) {
            if (c.data.space == d.config.toolbarLocation) {
              ...
              var e = CKEDITOR.tools.getNextId(),
                l = ['\x3cspan id\x3d"', e, '" class\x3d"cke_voice_label"\x3e', d.lang.toolbar.toolbars, "\x3c/span\x3e", '\x3cspan id\x3d"' + d.ui.spaceId("toolbox") + '" class\x3d"cke_toolbox" role\x3d"group" aria-labelledby\x3d"', e, '" onmousedown\x3d"return false;"\x3e'],
                e = !1 !== d.config.toolbarStartupExpanded,
                f, n;
              d.config.toolbarCanCollapse && d.elementMode != CKEDITOR.ELEMENT_MODE_INLINE && l.push('\x3cspan class\x3d"cke_toolbox_main"' + (e ? "\x3e" : ' style\x3d"display:none"\x3e'));
              for (var p = d.toolbox.toolbars, r = a(d), v = r.length,
                  x = 0; x < v; x++) {
                var q, t = 0,
                  u, A = r[x],
                  z = "/" !== A && ("/" === r[x + 1] || x == v - 1),
                  w;
                if (A)
                  if (f && (l.push("\x3c/span\x3e"), n = f = 0), "/" === A) l.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e');
                  else {
                    w = A.items || A;
                    for (var C = 0; C < w.length; C++) {
                      ...
                      if (y) {
                        var G = function (a) {
                          a = a.render(d, l);
                          E = t.items.push(a) - 1;
                          0 < E && (a.previous = t.items[E - 1], a.previous.next = a);
                          a.toolbar = t;
                          a.onkey = k;
                          a.onfocus = function () {
                        ...
                        if (y.type == CKEDITOR.UI_SEPARATOR) n = f && y;
                        else {
                          B = !1 !== y.canGroup;
                          if (!t) {
                            ...
                            u = A.name && (d.lang.toolbar.toolbarGroups[A.name] || A.name);
                            l.push('\x3cspan id\x3d"', q, '" class\x3d"cke_toolbar' + (z ? ' cke_toolbar_last"' : '"'), u ? ' aria-labelledby\x3d"' + q + '_label"' : "", ' role\x3d"toolbar"\x3e');
                            u && l.push('\x3cspan id\x3d"', q, '_label" class\x3d"cke_voice_label"\x3e', u, "\x3c/span\x3e");
                            l.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e');
                            var E = p.push(t) - 1;
                            0 < E && (t.previous = p[E - 1], t.previous.next = t)
                          }
                          B ? f || (l.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'),
                            f = 1) : f && (l.push("\x3c/span\x3e"), f = 0);
                          n && (G(n), n = 0);
                          G(y)
                        }
                      }
                    }
                    f && (l.push("\x3c/span\x3e"), n = f = 0);
                    t && l.push('\x3cspan class\x3d"cke_toolbar_end"\x3e\x3c/span\x3e\x3c/span\x3e')
                  }
              }
              d.config.toolbarCanCollapse && l.push("\x3c/span\x3e");
              if (d.config.toolbarCanCollapse && d.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                ...
                d.addCommand("toolbarCollapse", {
                  ...
                  exec: function (a) {
                    ...
                    f.setStyle("height", g - (d.$.offsetHeight - e) + "px");
                    a.fire("resize", {
                ...
                l.push('\x3ca title\x3d"' + (e ? d.lang.toolbar.toolbarCollapse : d.lang.toolbar.toolbarExpand) + '" id\x3d"' + d.ui.spaceId("toolbar_collapser") + '" tabIndex\x3d"-1" class\x3d"cke_toolbox_collapser');
                e || l.push(" cke_toolbox_collapser_min");
                l.push('" onclick\x3d"CKEDITOR.tools.callFunction(' + F + ')"\x3e', '\x3cspan class\x3d"cke_arrow"\x3e\x26#9650;\x3c/span\x3e',
                  "\x3c/a\x3e")
              }
              l.push("\x3c/span\x3e");
              c.data.html += l.join("")
          ...
          d.on("destroy", function () {
            if (this.toolbox) {
              ...
              for (a = this.toolbox.toolbars; b < a.length; b++)
                for (f = a[b].items, c = 0; c < f.length; c++) d = f[c], d.clickFn && CKEDITOR.tools.removeFunction(d.clickFn), d.keyDownFn && CKEDITOR.tools.removeFunction(d.keyDownFn)
            }
          });
      ...
      CKEDITOR.ui.prototype.addToolbarGroup = function (a, b, c) {
        ...
        if (c) {
          if (c = CKEDITOR.tools.search(g, function (a) {
              return a.name == c
            })) {
            !c.groups && (c.groups = []);
        ...
        b && (b = CKEDITOR.tools.indexOf(g, function (a) {
          return a.name == b
        }));
        h ? g.splice(0, 0, a) : "number" == typeof b ? g.splice(b + 1, 0, m) : g.push(a)
      }
    ...
    function () {
      ...
      function e(b) {
        function c() {
          ...
          a.on(B.mainPasteEvent, function (a) {
            "beforepaste" == B.mainPasteEvent && G || w(a)
          });
          ...
          return {
            ...
            exec: function (b, c) {
              function f(c, e) {
                ...
                c ? (c.method = "paste", c.dataTransfer || (c.dataTransfer = B.initPasteDataTransfer()), a(b, c, e)) : g && !b._.forcePasteDialog && b.showNotification(k, "info", b.config.clipboard_notificationDuration);
              ...
              var d = this,
                ...
                k = "string" === typeof g ? g : b.lang.clipboard.pasteNotification.replace(/%1/, '\x3ckbd aria-label\x3d"' + h.aria + '"\x3e' + h.display + "\x3c/kbd\x3e"),
                h = "string" === typeof c ? c : c.dataValue;
              e && !0 !== b.config.forcePasteAsPlainText &&
                "allow-word" !== b.config.forcePasteAsPlainText ? b._.nextPasteType = e : delete b._.nextPasteType;
              "string" === typeof h ? f({
                dataValue: h
        ...
        function l() {
          if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
            var a =
              b.getSelection(),
              c, d, g;
            a.getType() == CKEDITOR.SELECTION_ELEMENT && (c = a.getSelectedElement()) && (d = a.getRanges()[0], g = b.document.createText(""), g.insertBefore(c), d.setStartBefore(g), d.setEndAfter(c), a.selectRanges([d]), setTimeout(function () {
        ...
        function m(a, c) {
          ...
          if (!d.getById("cke_pastebin")) {
            ...
            var n = new CKEDITOR.dom.element(!CKEDITOR.env.webkit &&
              !g.is("body") || CKEDITOR.env.ie ? "div" : "body", d);
            n.setAttributes({
              id: "cke_pastebin",
              "data-cke-temp": "1"
            });
            var q = 0,
              d = d.getWindow();
            CKEDITOR.env.webkit ? (g.append(n), n.addClass("cke_editable"), g.is("body") || (q = "static" != g.getComputedStyle("position") ? g : CKEDITOR.dom.element.get(g.$.offsetParent), q = q.getDocumentPosition().y)) : g.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(n);
            n.setStyles({
              position: "absolute",
            ...
            if (CKEDITOR.env.webkit || CKEDITOR.env.gecko) h = g.once("blur", e, null, null, -100);
            q && n.focus();
        ...
        function w(c) {
          ...
          var g = !1 !== b.fire("beforePaste", d);
          g && B.canClipboardApiBeTrusted(d.dataTransfer, b) ? (c.data.preventDefault(), setTimeout(function () {
            a(b, d)
          }, 0)) : m(c, function (c) {
        ...
        function C() {
          if ("wysiwyg" == b.mode) {
            var a = y("paste");
            b.getCommand("cut").setState(y("cut"));
            b.getCommand("copy").setState(y("copy"));
        ...
        b.getClipboardData = function (a, c) {
          ...
          !1 === A() && (b.removeListener("paste", d), b._.forcePasteDialog && e && b.fire("pasteDialog") ? (b.on("pasteDialogCommit", g), b.on("dialogHide", function (a) {
            a.removeListener();
        ...
        return {
          get: function (c) {
            return "plain-text" == c ? b.plainText || (b.plainText = new CKEDITOR.filter("br")) :
              "semantic-content" == c ? ((c = b.semanticContent) || (c = new CKEDITOR.filter, c.allow({
                $1: {
                  elements: a(),
                  attributes: !0,
                  styles: !1,
      ...
      function h(b) {
        ...
        b.on("contentDom", function () {
          function d(c, g, e) {
            ...
            e.sourceEditor.editable().extractHtmlFromRange(c);
            e.sourceEditor.getSelection().selectRanges([c]);
            e.sourceEditor.fire("saveSnapshot")
          }
          ...
          k.attachListener(l, "dragstart", e);
          ...
          k.attachListener(l, "dragend", e);
          k.attachListener(b, "dragend",
          ...
          k.attachListener(b, "drop", function (a) {
            if (a = a.data) {
              ...
              }, 0) : k.getTransferType(b) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? d(h, e, k) : g(e, k)
            }
          }, null, null, 9999)
        })
      }
      ...
      CKEDITOR.plugins.add("clipboard", {
        ...
        init: function (a) {
          var g, k = d();
          a.config.forcePasteAsPlainText ? g = "plain-text" : a.config.pasteFilter ? g = a.config.pasteFilter : !CKEDITOR.env.webkit || "pasteFilter" in a.config || (g = "semantic-content");
          a.pasteFilter = k.get(g);
          e(a);
          h(a);
          ...
          if (CKEDITOR.env.gecko) {
            ...
            a.on("paste", function (b) {
              var c = b.data,
                d = c.dataTransfer;
              if (!c.dataValue && "paste" == c.method && d && 1 == d.getFilesCount() && v != d.id && (d = d.getFile(0), -1 != CKEDITOR.tools.indexOf(m, d.type))) {
                var g = new FileReader;
                g.addEventListener("load", function () {
                  b.data.dataValue = '\x3cimg src\x3d"' + g.result + '" /\x3e';
                  a.fire("paste", b.data)
                }, !1);
          ...
          a.on("paste", function (a) {
            ...
            if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
              ...
              for (g.setHtml(b); 1 == g.getChildCount() && (d = g.getFirst()) && d.type == CKEDITOR.NODE_ELEMENT && (d.hasClass("cke_editable") ||
                  d.hasClass("cke_contents"));) g = f = d;
          ...
          a.on("paste", function (d) {
            d = d.data;
            var g = a._.nextPasteType || d.type,
              e = d.dataValue,
              h, m = a.config.clipboard_defaultContentType || "html",
              n = d.dataTransfer.getTransferType(a);
            h = "html" == g || "html" == d.preSniffing ? "html" : b(e);
            delete a._.nextPasteType;
            "htmlifiedtext" == h && (e = c(a.config, e));
            "text" == g && "html" == h ? e = l(a, e, k.get("plain-text")) : n == CKEDITOR.DATA_TRANSFER_EXTERNAL && a.pasteFilter && !d.dontFilter && (e = l(a, e, a.pasteFilter));
            d.startsWithEOL && (e = '\x3cbr data-cke-eol\x3d"1"\x3e' + e);
            d.endsWithEOL && (e += '\x3cbr data-cke-eol\x3d"1"\x3e');
      ...
      CKEDITOR.plugins.clipboard = {
        ...
        canClipboardApiBeTrusted: function (a, b) {
          return a.getTransferType(b) != CKEDITOR.DATA_TRANSFER_EXTERNAL || CKEDITOR.env.chrome && !a.isEmpty() || CKEDITOR.env.gecko && (a.getData("text/html") || a.getFilesCount()) || CKEDITOR.env.safari &&
            603 <= CKEDITOR.env.version && !CKEDITOR.env.iOS || CKEDITOR.env.edge && 16 <= CKEDITOR.env.version ? !0 : !1
        },
        ...
        fixSplitNodesAfterDrop: function (a, b, c, d) {
          function g(a, c, d) {
            ...
            if (f.equals(c) && d != c.getChildCount()) return a = b.startContainer.getChild(b.startOffset - 1), c = b.startContainer.getChild(b.startOffset), a && a.type == CKEDITOR.NODE_TEXT && c && c.type ==
              CKEDITOR.NODE_TEXT && (d = a.getLength(), a.setText(a.getText() + c.getText()), c.remove(), b.setStart(a, d), b.collapse(!0)), !0
          }
          var e = b.startContainer;
          "number" == typeof d && "number" == typeof c && e.type == CKEDITOR.NODE_ELEMENT && (g(a.startContainer, e, c) || g(a.endContainer, e, d))
        },
        isDropRangeAffectedByDragRange: function (a, b) {
          var c = b.startContainer,
            d = b.endOffset;
          return a.endContainer.equals(c) && a.endOffset <= d || a.startContainer.getParent().equals(c) && a.startContainer.getIndex() < d || a.endContainer.getParent().equals(c) &&
            a.endContainer.getIndex() < d ? !0 : !1
        },
        internalDrop: function (b, c, d, g) {
          ...
          CKEDITOR.env.ie && 10 > CKEDITOR.env.version && this.fixSplitNodesAfterDrop(b, c, e.dragStartContainerChildCount, e.dragEndContainerChildCount);
          (l = this.isDropRangeAffectedByDragRange(b, c)) || (k = b.createBookmark(!1));
          e = c.clone().createBookmark(!1);
          l && (k = b.createBookmark(!1));
          b = k.startNode;
          c = k.endNode;
          l = e.startNode;
          c && b.getPosition(l) &
            CKEDITOR.POSITION_PRECEDING && c.getPosition(l) & CKEDITOR.POSITION_FOLLOWING && l.insertBefore(b);
          b = g.createRange();
          b.moveToBookmark(k);
        ...
        getRangeAtDropPosition: function (a, b) {
          ...
          if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d,
              g)) c = b.document.$.caretRangeFromPoint(d, g), h.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), h.collapse(!0);
          else if (c.rangeParent) h.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), h.collapse(!0);
          else {
            if (CKEDITOR.env.ie && 8 < CKEDITOR.env.version && e && b.editable().hasFocus) return e;
            if (document.body.createTextRange) {
              ...
              try {
                ...
                if (k) {
                  ...
                  var C = b.document.getById(w);
                  h.moveToPosition(C, CKEDITOR.POSITION_BEFORE_START);
                  C.remove()
                } else {
                  var y = b.document.$.elementFromPoint(d, g),
                    B = new CKEDITOR.dom.element(y),
                    G;
                  if (B.equals(b.editable()) || "html" == B.getName()) return e && e.startContainer && !e.startContainer.equals(b.editable()) ? e : null;
                  G = B.getClientRect();
                  d < G.left ? h.setStartAt(B, CKEDITOR.POSITION_AFTER_START) : h.setStartAt(B, CKEDITOR.POSITION_BEFORE_END);
                  h.collapse(!0)
                }
              } catch (E) {
                return null
      ...
      CKEDITOR.plugins.clipboard.dataTransfer = function (a, b) {
        ...
        b && (this.sourceEditor = b, this.setData("text/html", b.getSelectedHtml(1)), "Text" == m || this.getData("text/plain") || this.setData("text/plain",
          b.getSelection().getSelectedText()))
      };
      ...
      CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
        getData: function (a, b) {
          ...
          "Text" ==
          a && CKEDITOR.env.gecko && this.getFilesCount() && "file://" == c.substring(0, 7) && (c = "");
        ...
        setData: function (a, b) {
          ...
          if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || "URL" == a || "Text" == a)
            if ("Text" == m && "Text" == a && (this.id = b), this._.fallbackDataTransfer.isRequired()) this._.fallbackDataTransfer.setData(a,
              b);
            else try {
              this.$.setData(a, b)
            } catch (c) {}
        ...
        getFile: function (a) {
          return this._.files.length ?
            this._.files[a] : this.$ && this.$.files && this.$.files.length ? this.$.files[a] : 0 === a ? this._getImageFromClipboard() : void 0
        },
        isEmpty: function () {
          var a = {},
            b;
        ...
        setData: function (a, b) {
          ...
          try {
            ...
            if (this._isUnsupportedMimeTypeError(e)) {
              ...
              h[a] = d;
              try {
                d = this._applyDataComment(c, h), g.setData(this._customDataFallbackType, d), this._dataTransfer._.nativeHtmlCache = d
              } catch (k) {
                d = ""
              }
            }
        ...
        CKEDITOR.tools.createClass({
          ...
          _: {
            ...
            markFirstDisplayed: function (a) {
              for (var b = function (a) {
                ...
                }, e = this._.getItems(), k, g, h = e.count() - 1; 0 <= h; h--)
                if (k = e.getItem(h), k.getAscendant(b) || (g = k, this._.focusIndex = h), "true" == k.getAttribute("aria-selected")) {
                  g = k;
                  this._.focusIndex = h;
                  break
                } g && (a && a(), CKEDITOR.env.webkit && g.getDocument().getWindow().focus(), g.focus(), this.onMark && this.onMark(g))
            },
            getItems: function () {
          ...
          proto: {
            ...
            onKeyDown: function (a, b) {
              ...
              switch (e) {
                case "next":
                  for (var k = this._.focusIndex, e = this.element.getElementsByTag("a"), g; g = e.getItem(++k);)
                    if (g.getAttribute("_cke_focus") && g.$.offsetWidth) {
                      this._.focusIndex = k;
                      g.focus();
                      break
                    } return g || b ? !1 : (this._.focusIndex = -1, this.onKeyDown(a,
                    1));
                case "prev":
                  k = this._.focusIndex;
                  for (e = this.element.getElementsByTag("a"); 0 < k && (g = e.getItem(--k));) {
                    if (g.getAttribute("_cke_focus") && g.$.offsetWidth) {
                      this._.focusIndex = k;
                      g.focus();
                      break
                  ...
                  return g || b ? !1 : (this._.focusIndex = e.count(), this.onKeyDown(a, 1));
                case "click":
                case "mouseup":
                  return k = this._.focusIndex, (g = 0 <= k && this.element.getElementsByTag("a").getItem(k)) && (g.$[e] ? g.$[e]() : g.$["on" + e]()), !1
              }
              return !0
            }
          }
    ...
    function () {
      function a(a,
        c, d, l, k) {
        k = CKEDITOR.tools.genKey(c.getUniqueId(), d.getUniqueId(), a.lang.dir, a.uiColor || "", l.css || "", k || "");
        var g = e[k];
        g || (g = e[k] = new CKEDITOR.ui.panel(c, l), g.element = d.append(CKEDITOR.dom.element.createFromHtml(g.render(a), c)), g.element.setStyles({
          display: "none",
          position: "absolute"
        }));
        return g
      ...
      CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
        ...
        proto: {
          ...
          showBlock: function (a, c, d, e, k, g) {
            var h = this._.panel,
              m = h.showBlock(a);
            ...
            var n = this.element,
              ...
              q = v.x + (e || 0) - p.x,
              t = v.y + (k || 0) - p.y;
            !x || 1 != d && 4 != d ? x || 2 != d && 3 != d || (q += c.$.offsetWidth - 1) : q += c.$.offsetWidth;
            ...
            }, this), f.on("focus", function () {
              this._.focused = !0;
              this.hideChild();
              this.allowBlur(!0)
            }, this), CKEDITOR.env.iOS && (f.on("touchstart", function () {
              clearTimeout(this._.hideTimeout)
            }, this), f.on("touchend", function () {
              this._.hideTimeout = 0;
              this.focus()
            ...
            CKEDITOR.tools.setTimeout(function () {
              var a = CKEDITOR.tools.bind(function () {
                ...
                var b = h.element.getWindow(),
                  ...
                  f = x ? a.right : b.width - a.left,
                  e = x ? b.width - a.right : a.left;
                x ? f < c && (q = e > c ? q + c : b.width > c ? q - a.left : q - a.right + b.width) : f < c && (q = e > c ? q - c : b.width > c ? q - a.right + b.width : q - a.left);
                c = a.top;
                b.height -
                  a.top < d && (t = c > d ? t - d : b.height > d ? t - a.bottom + b.height : t - a.top);
          ...
          showAsChild: function (a, c, d, e, k, g) {
            if (this._.activeChild != a || a._.panel._.offsetParentId != d.getId()) this.hideChild(), a.onHide = CKEDITOR.tools.bind(function () {
              CKEDITOR.tools.setTimeout(function () {
                this._.focused || this.hide()
              }, 0, this)
            }, this), this._.activeChild = a, this._.focused = !1, a.showBlock(c, d, e, k, g), this.blur(), (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) && setTimeout(function () {
      ...
      requires: "floatpanel",
      beforeInit: function (a) {
        for (var e = a.config.menu_groups.split(","), b = a._.menuGroups = {}, c = a._.menuItems = {}, d = 0; d < e.length; d++) b[e[d]] = d + 1;
        a.addMenuGroup = function (a, c) {
          b[a] = c || 100
        };
        a.addMenuItem = function (a,
          d) {
    ...
    function () {
      ...
      var e = e + (' onmouseover\x3d"CKEDITOR.tools.callFunction({hoverFn},{index});" onmouseout\x3d"CKEDITOR.tools.callFunction({moveOutFn},{index});" ' + (CKEDITOR.env.ie ? 'onclick\x3d"return false;" onmouseup' : "onclick") + '\x3d"CKEDITOR.tools.callFunction({clickFn},{index}); return false;"\x3e'),
        ...
        d = CKEDITOR.addTemplate("menuShortcut", '\x3cspan class\x3d"cke_menubutton_label cke_menubutton_shortcut"\x3e{shortcut}\x3c/span\x3e');
            ...
            for (var e = 0; e < d.length; e++) {
              ...
              if (f)
                for (var n in f) {
                  ...
                  !p || p.command && !this.editor.getCommand(p.command).state || (p.state = f[n], this.add(p))
                }
            }
          },
          onClick: function (a) {
        ...
        proto: {
          ...
          show: function (b, c, d, e) {
            ...
            if (!n) {
              ...
              r["rtl" == f.lang.dir ? 37 : 39] = CKEDITOR.env.ie ? "mouseup" : "click";
              r[32] = CKEDITOR.env.ie ? "mouseup" :
                "click";
            ...
            a(m);
            for (var r = f.elementPath(), r = ['\x3cdiv class\x3d"cke_menu' + (r && r.direction() != f.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], v = m.length, x = v && m[0].group, q = 0; q < v; q++) {
              var t = m[q];
              x != t.group && (r.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'),
                x = t.group);
              t.render(this, q, r)
            }
            r.push("\x3c/div\x3e");
        ...
        proto: {
          render: function (a, e, g) {
            var h = a.id + String(e),
              ...
              f = "",
              n = this.editor,
              p, r, v = m == CKEDITOR.TRISTATE_ON ? "on" : m == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off";
            this.role in {
              menuitemcheckbox: 1,
              menuitemradio: 1
            } && (f = ' aria-checked\x3d"' + (m == CKEDITOR.TRISTATE_ON ? "true" : "false") + '"');
            var x = this.getItems,
            ...
            a = {
              ...
              shortcutHtml: r ? d.output({
                shortcut: r.display
              }) : "",
              arrowHtml: x ? c.output({
                label: q
              }) : "",
        ...
        CKEDITOR.plugins.contextMenu = CKEDITOR.tools.createClass({
          ...
          proto: {
            ...
            open: function (a, e, b, c) {
              !1 !== this.editor.config.enableContextMenu && (this.editor.focus(), a = a || CKEDITOR.document.getDocumentElement(),
                this.editor.selectionChange(1), this.show(a, e, b, c))
            }
          }
        })
      },
    ...
    function () {
      function a(a, b) {
        function k(b) {
          ...
          var c;
          b.equals(a.editable()) ||
            "true" == b.getAttribute("contenteditable") ? (c = a.createRange(), c.selectNodeContents(b), c = c.select()) : (c = a.getSelection(), c.selectElement(b));
        ...
        var h = a.ui.spaceId("path"),
          ...
          n = f.idBase;
        b.html += '\x3cspan id\x3d"' + h + '_label" class\x3d"cke_voice_label"\x3e' + a.lang.elementspath.eleLabel +
          '\x3c/span\x3e\x3cspan id\x3d"' + h + '" class\x3d"cke_path" role\x3d"group" aria-labelledby\x3d"' + h + '_label"\x3e\x3cspan class\x3d"cke_path_empty"\x3e\x26nbsp;\x3c/span\x3e\x3c/span\x3e';
        ...
        var p = CKEDITOR.tools.addFunction(k),
          r = CKEDITOR.tools.addFunction(function (b, c) {
            ...
            switch (c.getKeystroke()) {
              case g ? 39:
                37: case 9: return (g = CKEDITOR.document.getById(e +
                  (b + 1))) || (g = CKEDITOR.document.getById(e + "0")), g.focus(), !1;
              case g ? 37:
                39: case CKEDITOR.SHIFT + 9: return (g = CKEDITOR.document.getById(e + (b - 1))) || (g = CKEDITOR.document.getById(e + (f.list.length - 1))), g.focus(), !1;
              case 27:
                return a.focus(), !1;
              case 13:
              case 32:
        ...
        a.on("selectionChange", function (b) {
          for (var e = [], g = f.list = [], k = [], l = f.filters, A = !0, z = b.data.path.elements, w = z.length; w--;) {
            var C = z[w],
              y = 0;
            b = C.data("cke-display-name") ? C.data("cke-display-name") : C.data("cke-real-element-type") ? C.data("cke-real-element-type") :
              C.getName();
            (A = C.hasAttribute("contenteditable") ? "true" == C.getAttribute("contenteditable") : A) || C.hasAttribute("contenteditable") || (y = 1);
            ...
            y || (g.unshift(C), k.unshift(b))
          }
          g = g.length;
          for (l = 0; l < g; l++) b = k[l], A = a.lang.elementspath.eleTitle.replace(/%1/, b), b = c.output({
            id: n + l,
            label: A,
            text: b,
      ...
      CKEDITOR.plugins.add("indent", {
        init: function (b) {
          ...
          b.on("dirChanged", function (a) {
            ...
            d.setStartBefore(e);
            d.setEndAfter(e);
            for (var h = new CKEDITOR.dom.walker(d), m; m = h.next();)
              if (m.type == CKEDITOR.NODE_ELEMENT)
                if (!m.equals(e) && m.getDirection()) d.setStartAfter(m), h = new CKEDITOR.dom.walker(d);
                else {
                  ...
                  f ? m.setStyle("margin-left", f) : m.removeStyle("margin-left");
    ...
    function () {
      function a(a) {
        function c(e) {
          for (var h = l.startContainer, u = l.endContainer; h && !h.getParent().equals(e);) h = h.getParent();
          for (; u && !u.getParent().equals(e);) u = u.getParent();
          if (!h || !u) return !1;
          for (var A = [], v = !1; !v;) h.equals(u) && (v = !0), A.push(h), h =
            h.getNext();
          if (1 > A.length) return !1;
          h = e.getParents(!0);
          for (u = 0; u < h.length; u++)
            if (h[u].getName && k[h[u].getName()]) {
              e = h[u];
              break
            } for (var h = d.isIndent ? 1 : -1, u = A[0], A = A[A.length - 1], v = CKEDITOR.plugins.list.listToArray(e, f), w = v[A.getCustomData("listarray_index")].indent, u = u.getCustomData("listarray_index"); u <= A.getCustomData("listarray_index"); u++)
            if (v[u].indent += h, 0 < h) {
              for (var x = v[u].parent, y = u - 1; 0 <= y; y--)
                if (v[y].indent === h) {
                  x = v[y].parent;
                  break
                } v[u].parent = new CKEDITOR.dom.element(x.getName(), x.getDocument())
            } for (u =
            A.getCustomData("listarray_index") + 1; u < v.length && v[u].indent > w; u++) v[u].indent += h;
          h = CKEDITOR.plugins.list.arrayToList(v, f, null, a.config.enterMode, e.getDirection());
          if (!d.isIndent) {
            var B;
            if ((B = e.getParent()) && B.is("li"))
              for (var A = h.listNode.getChildren(), r = [], E, u = A.count() - 1; 0 <= u; u--)(E = A.getItem(u)) && E.is && E.is("li") && r.push(E)
          }
          h && h.listNode.replace(e);
          if (r && r.length)
            for (u = 0; u < r.length; u++) {
              for (E = e = r[u];
                (E = E.getNext()) && E.is && E.getName() in k;) CKEDITOR.env.needsNbspFiller && !e.getFirst(b) && e.append(l.document.createText(" ")),
                e.append(E);
              e.insertAfter(B)
            }
        ...
        for (var d = this, f = this.database, k = this.context, l, r = a.getSelection(), r = (r && r.getRanges()).createIterator(); l = r.getNextRange();) {
          for (var v = l.getCommonAncestor(); v && (v.type != CKEDITOR.NODE_ELEMENT || !k[v.getName()]);) {
          ...
          v || (v = l.startPath().contains(k)) && l.setEndAt(v, CKEDITOR.POSITION_BEFORE_END);
          if (!v) {
            var x = l.getEnclosedNode();
            x && x.type == CKEDITOR.NODE_ELEMENT && x.getName() in k && (l.setStartAt(x,
              CKEDITOR.POSITION_AFTER_START), l.setEndAt(x, CKEDITOR.POSITION_BEFORE_END), v = x)
          }
          v && l.startContainer.type == CKEDITOR.NODE_ELEMENT && l.startContainer.getName() in k && (x = new CKEDITOR.dom.walker(l), x.evaluator = e, l.startContainer = x.next());
          v && l.endContainer.type == CKEDITOR.NODE_ELEMENT && l.endContainer.getName() in k && (x = new CKEDITOR.dom.walker(l), x.evaluator = e, l.endContainer = x.previous());
          if (v) return c(v)
        }
        return 0
      }
    ...
    function () {
      function a(a, b, c) {
        ...
        for (var f = CKEDITOR.plugins.list.listToArray(b.root,
            c), e = [], g = 0; g < b.contents.length; g++) {
          var h = b.contents[g];
          (h = h.getAscendant("li", !0)) && !h.getCustomData("list_item_processed") && (e.push(h), CKEDITOR.dom.element.setMarker(c, h, "list_item_processed", !0))
        }
        h = null;
        for (g = 0; g < e.length; g++) h = e[g].getCustomData("listarray_index"), f[h].indent = -1;
        for (g = h + 1; g < f.length; g++)
          if (f[g].indent > f[g - 1].indent + 1) {
            e = f[g - 1].indent + 1 - f[g].indent;
            for (h = f[g].indent; f[g] && f[g].indent >= h;) f[g].indent += e, g++;
            g--
          } var k = CKEDITOR.plugins.list.arrayToList(f, c, null, a.config.enterMode,
            b.root.getAttribute("dir")).listNode,
          l, m;
        d(!0);
        d();
        k.replace(b.root);
      ...
      function b(a, b, c, d) {
        for (var f, e; f = a[d ? "getLast" : "getFirst"](r);)(e = f.getDirection(1)) !== b.getDirection(1) && f.setAttribute("dir", e), f.remove(), c ? f[d ? "insertBefore" : "insertAfter"](c) : b.append(f, d)
      }

      function c(a) {
        function c(d) {
          var e = a[d ? "getPrevious" : "getNext"](f);
          e && e.type == CKEDITOR.NODE_ELEMENT && e.is(a.getName()) &&
            (b(a, e, null, !d), a.remove(), a = e)
        }
        c();
        c(1)
      }
      ...
      function l(a, d, e) {
        ...
        var h = d.createBookmark(),
          ...
          p =
          w.contains(CKEDITOR.dtd.$listItem),
          w = w.contains(CKEDITOR.dtd.$list);
        m ? (m = m.getBogus()) && m.remove() : w && (m = w.getPrevious(f)) && n(m) && m.remove();
        (m = g.getLast()) && m.type == CKEDITOR.NODE_ELEMENT && m.is("br") && m.remove();
        (m = d.startContainer.getChild(d.startOffset)) ? g.insertBefore(m): d.startContainer.append(g);
        p && (g = k(p)) && (l.contains(p) ? (b(g, p.getParent(), p), g.remove()) : l.append(g));
        for (; e.checkStartOfBlock() && e.checkEndOfBlock();) {
          w = e.startPath();
          g = w.block;
          if (!g) break;
          g.is("li") && (l = g.getParent(), g.equals(l.getLast(f)) &&
            g.equals(l.getFirst(f)) && (g = l));
      ...
      function k(a) {
        return (a = a.getLast(f)) && a.type == CKEDITOR.NODE_ELEMENT && a.getName() in g ? a : null
      }
      var g = {
          ol: 1,
          ul: 1
      ...
      CKEDITOR.plugins.list = {
        listToArray: function (a, b, c, d, f) {
          ...
          for (var e = 0, h = a.getChildCount(); e < h; e++) {
            ...
            if ("li" == k.$.nodeName.toLowerCase()) {
              ...
              c.push(l);
              for (var m = 0, n = k.getChildCount(), p; m < n; m++) p = k.getChild(m), p.type == CKEDITOR.NODE_ELEMENT && g[p.getName()] ? CKEDITOR.plugins.list.listToArray(p, b, c, d + 1, l.grandparent) : l.contents.push(p)
            }
          }
          return c
        },
        arrayToList: function (a, b, c, d, e) {
          ...
          for (var h, k = a[c].parent.getDocument(), l = new CKEDITOR.dom.documentFragment(k),
              n = null, y = c, p = Math.max(a[c].indent, 0), r = null, E, F, I = d == CKEDITOR.ENTER_P ? "p" : "div";;) {
            var H = a[y];
            h = H.grandparent;
            E = H.element.getDirection(1);
            if (H.indent == p) {
              n && a[y].parent.getName() == n.getName() || (n = a[y].parent.clone(!1, 1), e && n.setAttribute("dir", e), l.append(n));
              r = n.append(H.element.clone(0, 1));
              E != n.getDirection(1) && r.setAttribute("dir", E);
              for (h = 0; h < H.contents.length; h++) r.append(H.contents[h].clone(1, 1));
              y++
            } else if (H.indent == Math.max(p, 0) + 1) H = a[y - 1].element.getDirection(1), y = CKEDITOR.plugins.list.arrayToList(a,
              null, y, d, H != E ? E : null), !r.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= k.$.documentMode && r.append(k.createText(" ")), r.append(y.listNode), y = y.nextIndex;
            else if (-1 == H.indent && !c && h) {
              g[h.getName()] ? (r = H.element.clone(!1, !0), E != h.getDirection(1) && r.setAttribute("dir", E)) : r = new CKEDITOR.dom.documentFragment(k);
              var n = h.getDirection(1) != E,
                K = H.element,
                J = K.getAttribute("class"),
                D = K.getAttribute("style"),
                R = r.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (d != CKEDITOR.ENTER_BR || n || D || J),
                N, S = H.contents.length,
                L;
              for (h = 0; h < S; h++)
                if (N = H.contents[h], m(N) && 1 < S) R ? L = N.clone(1, 1) : r.append(N.clone(1, 1));
                ...
                F = null;
                L && (r.append(L), L = null);
                r.append(N.clone(1, 1))
              } else R ? (F || (F = k.createElement(I), r.append(F), n && F.setAttribute("dir", E)), D && F.setAttribute("style", D), J && F.setAttribute("class",
                J), L && (F.append(L), L = null), F.append(N.clone(1, 1))) : r.append(N.clone(1, 1));
              L && ((F || r).append(L), L = null);
              r.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && y != a.length - 1 && (CKEDITOR.env.needsBrFiller && (E = r.getLast()) && E.type == CKEDITOR.NODE_ELEMENT && E.is("br") && E.remove(), (E = r.getLast(f)) && E.type == CKEDITOR.NODE_ELEMENT && E.is(CKEDITOR.dtd.$block) || r.append(k.createElement("br")));
              E = r.$.nodeName.toLowerCase();
              "div" != E && "p" != E || r.appendBogus();
              l.append(r);
              n = null;
              y++
            } else return null;
      ...
      e.prototype = {
        exec: function (b) {
          ...
          for (var d = e.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0;
            (l = h.getNextRange()) && ++n;) {
            ...
            B.type == CKEDITOR.NODE_ELEMENT && "td" == B.getName() && l.setEndAt(r.endNode, CKEDITOR.POSITION_BEFORE_END);
            l = l.createIterator();
            for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; r = l.getNextParagraph();)
              if (!r.getCustomData("list_block")) {
                CKEDITOR.dom.element.setMarker(m, r, "list_block", 1);
                for (var G = b.elementPath(r), y = G.elements, B = 0, G = G.blockLimit, E, F = y.length - 1; 0 <= F && (E = y[F]); F--)
                  if (g[E.getName()] && G.contains(E)) {
                    G.removeCustomData("list_group_object_" +
                      n);
                    (y = E.getCustomData("list_group_object")) ? y.contents.push(r): (y = {
                      root: E,
                      contents: [r]
                    }, k.push(y), CKEDITOR.dom.element.setMarker(m, E, "list_group_object", y));
                    B = 1;
                    break
                  } B || (B = G, B.getCustomData("list_group_object_" + n) ? B.getCustomData("list_group_object_" + n).contents.push(r) : (y = {
                  root: B,
                  contents: [r]
                }, CKEDITOR.dom.element.setMarker(m, B, "list_group_object_" + n, y), k.push(y)))
              }
          }
          for (E = []; 0 < k.length;)
            if (y = k.shift(), this.state == CKEDITOR.TRISTATE_OFF)
              if (g[y.root.getName()]) {
                ...
                B = CKEDITOR.plugins.list.listToArray(n.root,
                  y);
                G = [];
                for (r = 0; r < n.contents.length; r++) F = n.contents[r], (F = F.getAscendant("li", !0)) && !F.getCustomData("list_item_processed") && (G.push(F), CKEDITOR.dom.element.setMarker(y, F, "list_item_processed", !0));
                for (var F = n.root.getDocument(), I = void 0, H = void 0, r = 0; r < G.length; r++) {
                  var K = G[r].getCustomData("listarray_index"),
                    I = B[K].parent;
                  I.is(this.type) || (H = F.createElement(this.type), I.copyAttributes(H, {
                    start: 1,
                    type: 1
                  }), H.removeStyle("list-style-type"), B[K].parent = H)
                }
                y = CKEDITOR.plugins.list.arrayToList(B, y, null,
                  h.config.enterMode);
                B = void 0;
                G = y.listNode.getChildCount();
                for (r = 0; r < G && (B = y.listNode.getChild(r)); r++) B.getName() == this.type && l.push(B);
                y.listNode.replace(n.root);
                ...
                n = [];
                1 == G.length && G[0].equals(l.root) && (y = h.createElement("div"), G[0].moveChildren && G[0].moveChildren(y), G[0].append(y), G[0] = y);
                ...
                for (F = 0; F < G.length; F++)
                  for (H = G[F]; K = H.getParent();) {
                    if (K.equals(l)) {
                      n.push(H);
                      !B && H.getDirection() && (B = 1);
                      H = H.getDirection(I);
                      null !== y && (y = y && y != H ? null : H);
                      break
                    }
                    H = K
                  }
                if (!(1 > n.length)) {
                  ...
                  r.push(F);
                  for (I = r = void 0; n.length;) r = n.shift(), I = h.createElement("li"), H = r, H.is("pre") || p.test(H.getName()) || "false" == H.getAttribute("contenteditable") ? r.appendTo(I) : (r.copyAttributes(I), y && r.getDirection() && (I.removeStyle("direction"), I.removeAttribute("dir")),
                    r.moveChildren(I), r.remove()), I.appendTo(F);
                  y && B && F.setAttribute("dir", y);
                  G ? F.insertBefore(G) : F.appendTo(l)
                }
              }
          else this.state == CKEDITOR.TRISTATE_ON && g[y.root.getName()] && a.call(this, b, y, m);
          ...
          a.blockless || (a.addCommand("numberedlist", new e("numberedlist", "ol")), a.addCommand("bulletedlist", new e("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton("NumberedList", {
            ...
            if ("wysiwyg" == a.mode &&
              ...
              if (h && h.collapsed) {
                var p = 8 == c,
                  w = a.editable(),
                  r = new CKEDITOR.dom.walker(h.clone());
                r.evaluator = function (a) {
                  return f(a) && !n(a)
                };
                r.guard = function (a, b) {
                  return !(b && a.type == CKEDITOR.NODE_ELEMENT && a.is("table"))
                };
                c = h.clone();
                if (p) {
                  var y;
                  (y = m.contains(g)) && h.checkBoundaryOfElement(y, CKEDITOR.START) && (y = y.getParent()) && y.is("li") && (y = k(y)) ? (e = y, y = y.getPrevious(f), c.moveToPosition(y && n(y) ? y : e, CKEDITOR.POSITION_BEFORE_START)) : (r.range.setStartAt(w,
                    CKEDITOR.POSITION_AFTER_START), r.range.setEnd(h.startContainer, h.startOffset), (y = r.previous()) && y.type == CKEDITOR.NODE_ELEMENT && (y.getName() in g || y.is("li")) && (y.is("li") || (r.range.selectNodeContents(y), r.reset(), r.evaluator = d, y = r.previous()), e = y, c.moveToElementEditEnd(e), c.moveToPosition(c.endPath().block, CKEDITOR.POSITION_BEFORE_END)));
                  if (e) l(a, c, h), b.cancel();
                  else {
                    var B = m.contains(g);
                    B && h.checkBoundaryOfElement(B, CKEDITOR.START) && (e = B.getFirst(f), h.checkBoundaryOfElement(e, CKEDITOR.START) && (y = B.getPrevious(f),
                      k(e) ? y && (h.moveToElementEditEnd(y), h.select()) : a.execCommand("outdent"), b.cancel()))
                  }
                } else if (e = m.contains("li")) {
                  if (r.range.setEndAt(w, CKEDITOR.POSITION_BEFORE_END), p = (w = e.getLast(f)) && d(w) ? w : e, m = 0, (y = r.next()) && y.type == CKEDITOR.NODE_ELEMENT && y.getName() in g && y.equals(w) ? (m = 1, y = r.next()) : h.checkBoundaryOfElement(p, CKEDITOR.END) && (m = 2), m && y) {
                    h = h.clone();
                ...
                } else r.range.setEndAt(w, CKEDITOR.POSITION_BEFORE_END), (y = r.next()) && y.type == CKEDITOR.NODE_ELEMENT && y.is(g) && (y = y.getFirst(f), m.block && h.checkStartOfBlock() && h.checkEndOfBlock() ? (m.block.remove(), h.moveToElementEditStart(y), h.select()) : k(y) ? (h.moveToElementEditStart(y), h.select()) :
    ...
    function () {
      function a(a, b, c) {
        ...
        if ("wysiwyg" == a.mode) {
          ...
          a.fire("saveSnapshot");
          b == CKEDITOR.ENTER_BR ? k(a, b, null, c) : g(a, b, null, c);
          a.fire("saveSnapshot")
        }
      }
      ...
      CKEDITOR.plugins.enterkey = {
        enterBlock: function (a, f, g, l) {
          if (g = g || e(a)) {
            g = b(g);
            var r = g.document,
              v = g.checkStartOfBlock(),
              x = g.checkEndOfBlock(),
              q = a.elementPath(g.startContainer),
              t = q.block,
              u = f == CKEDITOR.ENTER_DIV ? "div" : "p",
              A;
            if (v && x) {
              if (t && (t.is("li") || t.getParent().is("li"))) {
                ...
                var z = !t.hasNext(),
                  ...
                  y = A.getDirection(1) != v;
                a = a.enterMode != CKEDITOR.ENTER_BR || y || C || x;
                if (A.is("li")) l || z ? (l && z && g.remove(), t[z ? "insertAfter" : "insertBefore"](A)) : t.breakParent(A);
                else {
                  if (a)
                    if (q.block.is("li") ? (A = r.createElement(f == CKEDITOR.ENTER_P ? "p" : "div"), y && A.setAttribute("dir", v), C && A.setAttribute("style", C), x && A.setAttribute("class", x), t.moveChildren(A)) : A = q.block, l || z) A[l ? "insertBefore" : "insertAfter"](g);
                    else t.breakParent(g), A.insertAfter(g);
                  else if (t.appendBogus(!0), l || z)
                    for (; r = t[l ? "getFirst" : "getLast"]();) r[l ? "insertBefore" : "insertAfter"](g);
                  else
                    for (t.breakParent(g); r = t.getLast();) r.insertAfter(g);
                  t.remove()
                }
                u.selectBookmarks(w);
                return
            ...
            if (v = g.splitBlock(u)) {
              ...
              q = v.wasStartOfBlock;
              a = v.wasEndOfBlock;
              t ? (w = t.getParent(), w.is("li") && (t.breakParent(w), t.move(t.getNext(), 1))) : f && (w = f.getParent()) && w.is("li") && (f.breakParent(w), w = f.getNext(), g.moveToElementEditStart(w), f.move(f.getPrevious()));
              if (q || a) {
                if (f) {
                  if (f.is("li") || !h.test(f.getName()) && !f.is("pre")) A = f.clone()
                } else t && (A = t.clone());
                A ? l && !A.is("li") && A.renameNode(u) : w && w.is("li") ? A = w : (A = r.createElement(u), f && (z = f.getDirection()) &&
                  A.setAttribute("dir", z));
                if (r = v.elementPath)
                  for (l = 0, u = r.elements.length; l < u; l++) {
                    w = r.elements[l];
                    if (w.equals(r.block) || w.equals(r.blockLimit)) break;
                    CKEDITOR.dtd.$removeEmpty[w.getName()] && (w = w.clone(), A.moveChildren(w), A.append(w))
                  }
                A.appendBogus();
                A.getParent() || g.insertNode(A);
                A.is("li") && A.removeAttribute("value");
                !CKEDITOR.env.ie || !q || a && f.getChildCount() || (g.moveToElementEditStart(a ? f : A), g.select());
                g.moveToElementEditStart(q && !a ? t : A)
                ...
                }, (w = A.next()) && w.type == CKEDITOR.NODE_ELEMENT && w.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? r.createElement("br") : r.createText(" ")).insertBefore(w)), t && g.moveToElementEditStart(t);
              g.select();
              g.scrollIntoView()
            }
          }
        ...
        enterBr: function (a, b, c, d) {
          if (c = c || e(a)) {
            var k = c.document,
              l = c.checkEndOfBlock(),
              x = new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()),
              q = x.block,
              t = q && x.block.getName();
            d || "li" != t ? (!d && l && h.test(t) ? (l = q.getDirection()) ? (k = k.createElement("div"), k.setAttribute("dir", l), k.insertAfter(q), c.setStart(k, 0)) : (k.createElement("br").insertAfter(q), CKEDITOR.env.gecko && k.createText("").insertAfter(q), c.setStartAt(q.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (a = "pre" == t && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? k.createText("\r") : k.createElement("br"), c.deleteContents(), c.insertNode(a), CKEDITOR.env.needsBrFiller ?
              (k.createText("﻿").insertAfter(a), l && (q || x.blockLimit).appendBogus(), a.getNext().$.nodeValue = "", c.setStartAt(a.getNext(), CKEDITOR.POSITION_AFTER_START)) : c.setStartAt(a, CKEDITOR.POSITION_AFTER_END)), c.collapse(!0), c.select(), c.scrollIntoView()) : g(a, b, c, d)
          }
        }
      };
    ...
    function () {
      ...
      CKEDITOR.plugins.add("entities", {
        afterInit: function (e) {
          ...
          function c(a) {
            return "force" != d.entities_processNumerical && k[a] ? k[a] : "\x26#" + a.charCodeAt(0) + ";"
          }
          var d = e.config;
          if (e =
            ...
            var k = a(l.join(",")),
              g = k.regex ? "[" + k.regex + "]" : "a^";
            delete k.regex;
            d.entities && d.entities_processNumerical && (g = "[^ -~]|" + g);
            var g = new RegExp(g, "g"),
              h = a("nbsp,gt,lt,amp,shy", !0),
              m = new RegExp(h.regex, "g");
            e.addRules({
              text: function (a) {
                return a.replace(m, b).replace(g, c)
              }
            }, {
              applyToAll: !0,
    ...
    CKEDITOR.config.entities_additional = "#39", CKEDITOR.plugins.add("popup"), CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      popup: function (a, e, b, c) {
        ...
        if (!k) return !1;
        try {
          -1 == navigator.userAgent.toLowerCase().indexOf(" chrome/") && (k.moveTo(l, d), k.resizeTo(e, b)), k.focus(), k.location.href = a
        } catch (g) {
    ...
    function () {
      ...
      function e(a, c, e) {
        var g = a.config.fileTools_defaultFileName;
        this.editor = a;
        this.lang = a.lang;
        ...
        e ? this.fileName = e : this.file.name ? this.fileName = this.file.name : (a = this.file.type.split("/"), g && (a[0] = g), this.fileName = a.join("."));
        this.uploaded = 0;
      ...
      function b(a) {
        ...
        var e = [],
          g, h, m, f;
        for (g = 0; g < a.length; g += 512) {
          h = a.slice(g, g + 512);
          m = Array(h.length);
          for (f = 0; f < h.length; f++) m[f] = h.charCodeAt(f);
          h = new Uint8Array(m);
          e.push(h)
        }
        return new Blob(e, {
        ...
        beforeInit: function (b) {
          ...
          b.on("fileUploadRequest",
            function (a) {
              ...
              var h = b.config.fileTools_requestHeaders,
                m, f;
              for (f in a) {
                var n = a[f];
                "object" === typeof n && n.file ? e.append(f, n.file, n.name) : e.append(f, n)
              }
              e.append("ckCsrfToken", CKEDITOR.tools.getCsrfToken());
              if (h)
                for (m in h) c.xhr.setRequestHeader(m, h[m]);
              c.xhr.send(e)
            }, null, null, 999);
      ...
      e.prototype = {
        ...
        attachRequestListeners: function () {
          ...
          }, e.upload.onerror = a, e.upload.onabort = b) : (c.uploadTotal = c.total, c.update());
          e.onload = function () {
            c.update();
            if ("abort" != c.status)
              if (c.uploaded = c.uploadTotal, 200 > e.status || 299 < e.status) c.message = c.lang.filetools["httpError" + e.status], c.message || (c.message = c.lang.filetools.httpError.replace("%1",
                ...
                for (var a = {
                    fileLoader: c
                  }, b = ["message", "fileName", "url"], d = c.editor.fire("fileUploadResponse", a), l = 0; l < b.length; l++) {
                  var p = b[l];
                  "string" === typeof a[p] && (c[p] = a[p])
                }
                c.responseData = a;
                delete c.responseData.fileLoader;
                !1 === d ? c.changeStatus("error") : c.changeStatus("uploaded")
              }
          }
        },
    ...
    function () {
      ...
      function c() {
        ...
        f.CKEditor = d.name;
        f.CKEditorFuncNum = d._.filebrowserFn;
        f.langCode ||
          (f.langCode = d.langCode);
        f = a(this.filebrowser.url, f);
        d.popup(f, e, c, d.config.filebrowserWindowFeatures || d.config.fileBrowserWindowFeatures)
      }
      ...
      function g(a, m, r, v) {
        if (v && v.length)
          for (var x, q = v.length; q--;)
            if (x = v[q], "hbox" != x.type && "vbox" != x.type && "fieldset" != x.type || g(a, m, r, x.children), x.filebrowser)
              if ("string" == typeof x.filebrowser && (x.filebrowser = {
                  action: "fileButton" ==
                    x.type ? "QuickUpload" : "Browse",
                  target: x.filebrowser
                }), "Browse" == x.filebrowser.action) {
                var t = x.filebrowser.url;
                void 0 === t && (t = a.config["filebrowser" + b(m) + "BrowseUrl"], void 0 === t && (t = a.config.filebrowserBrowseUrl));
                t && (x.onClick = c, x.filebrowser.url = t, x.hidden = !1)
              } else if ("QuickUpload" == x.filebrowser.action && x["for"] && (t = x.filebrowser.url, void 0 === t && (t = a.config["filebrowser" + b(m) + "UploadUrl"], void 0 === t && (t = a.config.filebrowserUploadUrl)), t)) {
          var u = x.onClick;
          x.onClick = function (b) {
            var c = b.sender,
              g = c.getDialog().getContentElement(this["for"][0],
                this["for"][1]).getInputElement(),
              k = CKEDITOR.fileTools && CKEDITOR.fileTools.isFileUploadSupported;
            if (u && !1 === u.call(c, b)) return !1;
            if (l.call(c, b)) {
              if ("form" !== a.config.filebrowserUploadMethod && k) return b = a.uploadRepository.create(g.$.files[0]), b.on("uploaded", function (a) {
                var b = a.sender.responseData;
                f.call(a.sender.editor, b.url, b.message)
              }), b.on("error", h.bind(this)), b.on("abort", h.bind(this)), b.loadAndUpload(e(t)), "xhr";
              d(g);
              return !0
            }
            return !1
          ...
          x.filebrowser.url = t;
          x.hidden = !1;
          k(a, r.getContents(x["for"][0]).get(x["for"][1]),
            x.filebrowser)
        }
      }
        ...
        function (a) {
          if (a.editor.plugins.filebrowser)
            for (var b = a.data.definition, c, d = 0; d < b.contents.length; ++d)
              if (c = b.contents[d]) g(a.editor, a.data.name, b, c.elements), c.hidden && c.filebrowser && (c.hidden = !m(b, c.id, c.filebrowser))
        })
    }(),
    function () {
      function a(a) {
            ...
            function g(a) {
              ...
              switch (a) {
                ...
                case "pin":
                  ...
                  break;
                case "bottom":
                  f("absolute", "top", b.y + (q.height || q.bottom - q.top) + w)
              }
              l = a
            }
            var l, m, x, q, t, u, A, z = d.floatSpaceDockedOffsetX || 0,
              w = d.floatSpaceDockedOffsetY || 0,
              C = d.floatSpacePinnedOffsetX || 0,
              y = d.floatSpacePinnedOffsetY || 0;
            return function (f) {
              if (m = a.editable()) {
                ...
                t = e.getViewPaneSize();
                u = x.height;
                A = "pageXOffset" in e.$ ? e.$.pageXOffset : CKEDITOR.document.$.documentElement.scrollLeft;
        ...
        if (l) {
          ...
          a.on("blur", function () {
            ...
            a.removeListener("change",
              m.input);
            e.removeListener("scroll", f.input);
            e.removeListener("resize", f.input)
          });
          a.on("destroy", function () {
            e.removeListener("scroll", f.input);
            e.removeListener("resize", f.input);
          ...
          proto: {
            ...
            focus: function (a) {
              ...
              var b = this.element.getElementsByTag("a"),
                c, e = -1;
              if (a)
                for (c = this.element.getDocument().getById(this._.items[a]).getFirst(); a = b.getItem(++e);) {
                  if (a.equals(c)) {
                    this._.focusIndex = e;
                    break
                  }
        ...
        proto: {
          ...
          render: function (a, c) {
            ...
            var l =
              CKEDITOR.env,
              k = "cke_" + this.id,
              g = CKEDITOR.tools.addFunction(function (c) {
          ...
          createPanel: function (a) {
            if (!this._.panel) {
              var c = this._.panelDefinition,
                ...
                g = new CKEDITOR.ui.floatPanel(a, e, c),
                c = g.addListBlock(this.id, d),
                h = this;
              g.onShow = function () {
              ...
              this._.panel = g;
              this._.list = c;
              g.getBlock(this.id).onHide = function () {
                h._.on = 0;
      ...
      init: function (a) {
        if (!a.blockless) {
          for (var e = a.config, b = a.lang.format, c = e.format_tags.split(";"), d = {}, l = 0, k = [], g = 0; g < c.length; g++) {
            var h = c[g],
              m = new CKEDITOR.style(e["format_" + h]);
          ...
          function c(c) {
            ...
            if (l) {
              if ("left" == c || "right" == c) l.on("exec", function (k) {
                var g = a(b),
                  h;
                g && (h = e(g), h == c ? (g.removeStyle("float"), c == e(g) && g.removeAttribute("align")) :
                  g.setStyle("float", c), k.cancel())
              });
              l.on("refresh", function (k) {
                var g = a(b);
                g && (g = e(g), this.setState(g == c ? CKEDITOR.TRISTATE_ON : "right" == c || "left" == c ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED), k.cancel())
              })
            }
          }
    ...
    function () {
      ...
      CKEDITOR.editor.prototype.createFakeElement = function (a, c, d, h) {
        ...
        h && (c["data-cke-resizable"] =
          h, d = new e, h = a.getAttribute("width"), a = a.getAttribute("height"), h && (d.rules.width = b(h)), a && (d.rules.height = b(a)), d.populate(c));
      ...
      CKEDITOR.plugins.link = {
        ...
        parseLinkAttributes: function (a, b) {
          var c = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
            ...
            w, C = {};
          c.match(d) && ("encode" == z ? c = c.replace(n, function (a, b, c) {
            c = c || "";
            return "mailto:" + String.fromCharCode.apply(String,
              b.split(",")) + c.replace(/\\'/g, "'")
            ...
            if (b == e.name) {
              ...
              b = /(^')|('$)/g;
              c = c.match(/[^,\s]+/g);
              for (var d = c.length, f, g, h = 0; h < d; h++) f = decodeURIComponent, g = c[h].replace(b, "").replace(/\\'/g, "'"), g = f(g), f = e.params[h].toLowerCase(), a[f] = g;
              a.address = [a.name, a.domain].join("@")
            }
          }));
          if (!C.type)
            if (z = c.match(h)) C.type = "anchor", C.anchor = {}, C.anchor.name = C.anchor.id = z[1];
            else if (z = c.match(l)) {
            w = c.match(k);
            c = c.match(g);
            C.type = "email";
            ...
            y.address =
              z[1];
            w && (y.subject = decodeURIComponent(w[1]));
            c && (y.body = decodeURIComponent(c[1]))
          } else c && (w = c.match(m)) && (C.type = "url", C.url = {}, C.url.protocol = w[1], C.url.url = w[2]);
          if (b) {
            if (c = b.getAttribute("target")) C.target = {
              type: c.match(f) ? c : "frame",
              name: c
            };
              ...
              for (C.target = {
                  type: "popup",
                  name: c[1]
                }; z = v.exec(c[2]);) "yes" != z[2] && "1" != z[2] || z[1] in {
                height: 1,
                width: 1,
                top: 1,
                left: 1
              } ? isFinite(z[2]) && (C.target[z[1]] = z[2]) : C.target[z[1]] = !0;
            null !==
              b.getAttribute("download") && (C.download = !0);
            var c = {},
              B;
            for (B in x)(z = b.getAttribute(B)) && (c[x[B]] = z);
        ...
        getLinkAttributes: function (c, d) {
            ...
            case "email":
              ...
              switch (f) {
                ...
                case "encode":
                  ...
                  "encode" == f ? (f = ["javascript:void(location.href\x3d'mailto:'+", e(h)], k && f.push("+'", a(k), "'"), f.push(")")) : f = ["mailto:", h, k];
                  break;
                default:
                  f = h.split("@", 2), k.name = f[0], k.domain = f[1], f = ["javascript:", b(c,
                    k)]
              }
          ...
          if (d.target)
            if ("popup" == d.target.type) {
              for (var f = ["window.open(this.href, '", d.target.name || "", "', '"], n = "resizable status location toolbar menubar fullscreen scrollbars dependent".split(" "), h = n.length, m = function (a) {
            ...
            } else "notSet" != d.target.type && d.target.name &&
              (g.target = d.target.name);
          d.download && (g.download = "");
          if (d.advanced) {
            for (var p in x)(f = d.advanced[x[p]]) && (g[p] = f);
          ...
          d.advanced && CKEDITOR.tools.extend(p, x);
        ...
        exec: function (a) {
          if (CKEDITOR.env.ie) {
            var b = a.getSelection().getRanges()[0],
              ...
              d;
            b.collapsed && c && (d = b.createBookmark(), b.selectNodeContents(c),
              b.select())
          }
    ...
    function () {
      ...
      function d(a, b, c) {
        return b =
          b[c ? "getPrevious" : "getNext"](function (b) {
            return b && b.type == CKEDITOR.NODE_TEXT && !aa(b) || n(b) && !p(b) && !f(a, b)
          })
      }
      ...
      function g(a) {
        var b = a.doc,
          c = E('\x3cspan contenteditable\x3d"false" data-cke-magic-line\x3d"1" style\x3d"' + U + "position:absolute;border-top:1px dashed " + a.boxColor + '"\x3e\x3c/span\x3e',
            b),
        ...
        B(c, {
          ...
          lineChildren: [B(E('\x3cspan title\x3d"' + a.editor.lang.magicline.title + '" contenteditable\x3d"false"\x3e\x26#8629;\x3c/span\x3e', b), {
            base: U + "height:17px;width:17px;" + (a.rtl ? "left" : "right") + ":17px;background:url(" + d + ") center no-repeat " + a.boxColor + ";cursor:pointer;" + (F.hc ? "font-size: 15px;line-height:14px;border:1px solid #fff;text-align:center;" :
              "") + (F.hidpi ? "background-size: 9px 10px;" : ""),
      ...
      function h(a, b, c) {
        var d = new CKEDITOR.dom.range(a.doc),
          e = a.editor,
          f;
        F.ie && a.enterMode == CKEDITOR.ENTER_BR ? f = a.doc.createText(Z) : (f = (f = k(a.element, !0)) && f.data("cke-enter-mode") || a.enterMode, f = new G(K[f], a.doc), f.is("br") || a.doc.createText(Z).appendTo(f));
        ...
        return {
          ...
          exec: function () {
            ...
            return function (f) {
              ...
              if (!x(a, f) && f && !f.equals(a.editable) && !f.contains(a.editable)) {
                (g = k(f)) && "false" == g.getAttribute("contenteditable") && (f = g);
                a.element = f;
                g = d(a, f, !c);
                var h;
                n(g) && g.is(a.triggers) && g.is(P) && (!d(a, g, !c) || (h = d(a, g, !c)) && n(h) && h.is(a.triggers)) ? e(g) : (h = b(a, f), n(h) && (d(a, h, !c) ? (f = d(a, h, !c)) && n(f) && f.is(a.triggers) && e(h) : e(h)))
              }
            }
          }()
        }
      ...
      function t(a) {
        ...
        if (!b) return null;
        f(a, b) && (b = a.line.wrap[h ? "getPrevious" : "getNext"](function (a) {
          return !(aa(a) || ba(a))
        }));
        if (!n(b) ||
          p(b) || !v(a, b)) return null;
        z(a, b);
        return !h && 0 <= b.size.top && l(c.y, 0, b.size.top + g) ? (a = a.inInlineMode || 0 === d.scroll.y ? S : V, new e([null, b, J, N, a])) : h && b.size.bottom <= d.pane.height && l(c.y, b.size.bottom - g, d.pane.height) ? (a = a.inInlineMode || l(b.size.bottom, d.pane.height - g, d.pane.height) ? L : V, new e([b, null, D, N, a])) : null
      }
      ...
      function u(a) {
        ...
        var g = Math.min(g, 0 | h.size.outerHeight / 2),
          k = [],
          m, O;
        if (l(c.y, h.size.top - 1, h.size.top + g)) O = !1;
        else if (l(c.y,
            h.size.bottom - g, h.size.bottom + 1)) O = !0;
        else return null;
        if (p(h) || q(a, h, O) || h.getParent().is(X)) return null;
        var y = d(a, h, !O);
        if (y) {
          if (y && y.type == CKEDITOR.NODE_TEXT) return null;
          if (n(y)) {
            if (p(y) || !v(a, y) || y.getParent().is(X)) return null;
            k = [y, h][O ? "reverse" : "concat"]().concat([R, N])
          }
        } else h.equals(a.editable[O ? "getLast" : "getFirst"](a.isRelevant)) ? (w(a), O && l(c.y, h.size.bottom - g, f.pane.height) && l(h.size.bottom, f.pane.height - g, f.pane.height) ? m = L : l(c.y, 0, h.size.top + g) && (m = S)) : m = V, k = [null, h][O ? "reverse" : "concat"]().concat([O ?
          D : J, N, m, h.equals(a.editable[O ? "getLast" : "getFirst"](a.isRelevant)) ? O ? L : S : V
        ]);
        return 0 in k ? new e(k) : null
      }

      function A(a, b, c, d) {
        for (var e = b.getDocumentPosition(), f = {}, g = {}, h = {}, k = {}, m = ca.length; m--;) f[ca[m]] = parseInt(b.getComputedStyle.call(b, "border-" + ca[m] + "-width"), 10) || 0, h[ca[m]] = parseInt(b.getComputedStyle.call(b, "padding-" + ca[m]), 10) || 0, g[ca[m]] = parseInt(b.getComputedStyle.call(b, "margin-" + ca[m]), 10) || 0;
        c && !d || C(a, d);
        ...
        init: function (a) {
          ...
          a.on("contentDom", function () {
            ...
            k.is(H.$inline) || (l.inInlineMode && !r(k) && k.setStyles({
                ...
                top: null,
                left: null
              }), g.call(this, l), C(l), k.attachListener(a, "beforeUndoImage", function () {
                l.line.detach()
              }),
              k.attachListener(a, "beforeGetData", function () {
                ...
                y = !0;
                if ("wysiwyg" == a.mode && !a.readOnly && !q) {
                  var c = {
                    x: b.data.$.clientX,
                    y: b.data.$.clientY
                  };
                  q = setTimeout(function () {
                    ...
                    q = l.trigger = null;
                    C(l);
                    y && !l.hiddenMode && a.focusManager.hasFocus && !l.line.mouseNear() && (l.element =
                      W(l, !0)) && ((l.trigger = t(l) || u(l) || Y(l)) && !x(l, l.trigger.upper || l.trigger.lower) ? l.line.attach().place() : (l.trigger = null, l.line.detach()), y = !1)
                  }, 30)
                }
              }), k.attachListener(p, "scroll", function () {
                "wysiwyg" == a.mode && (l.line.detach(), F.webkit && (l.hiddenMode = 1, clearTimeout(O), O = setTimeout(function () {
      ...
      var W = function () {
        ...
        Y = function () {
          function b(e) {
            ...
            for (var f = Number.MAX_VALUE, m, O, w, q; h && !h.equals(g) && (O = g.getNext(e.isRelevant));) m = Math.abs(c(e, g, O) - e.mouse.y), m < f && (f = m, w = g, q = O), g = O, z(e, g);
            if (!w || !q || !l(e.mouse.y, w.size.top, q.size.bottom)) return null;
            k.upper = w;
            k.lower = q;
            return k.set(R, 8)
          }
          ...
          function d(a, b) {
            return !(b && b.type == CKEDITOR.NODE_TEXT || ba(b) || p(b) || f(a, b) || b.type == CKEDITOR.NODE_ELEMENT && b.$ && b.is("br"))
          }
          return function (c) {
            var d = b(c),
              e;
    ...
    function () {
      ...
      function b(b, c) {
        var d = a(b),
          h = {},
          m = b.$;
        c || (h["class"] = m.className || "", m.className = "");
        h.inline = m.style.cssText || "";
            ...
            a.addCommand("maximize", {
              ...
              exec: function () {
                ...
                if ("wysiwyg" == a.mode) {
                  ...
                  var t = a.editable().$;
                  f = !CKEDITOR.env.ie && [t.selectionStart, t.selectionEnd];
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                  ...
                  h.getDocumentElement().setStyles(x);
                  !CKEDITOR.env.gecko && h.getDocumentElement().setStyle("position", "fixed");
                  CKEDITOR.env.gecko && CKEDITOR.env.quirks || h.getBody().setStyles(x);
                  ...
                  for (var q = [x, v], u = 0; u < q.length; u++) c(q[u], q[u].getCustomData("maximize_saved_styles")), q[u].removeCustomData("maximize_saved_styles");
                  ...
                  a.fire("resize", {
                    outerHeight: a.container.$.offsetHeight,
                    contentsHeight: x.$.offsetHeight,
                    outerWidth: a.container.$.offsetWidth
                  })
                }
                this.toggleState();
                if (q = this.uiItems[0]) x = this.state == CKEDITOR.TRISTATE_OFF ? g.maximize.maximize : g.maximize.minimize, q = CKEDITOR.document.getById(q._.id), q.getChild(1).setHtml(x), q.setAttribute("title", x), q.setAttribute("href", 'javascript:void("' +
                  x + '");');
                "wysiwyg" == a.mode ? f ? (CKEDITOR.env.gecko && d(a), a.getSelection().selectRanges(f), (t = a.getSelection().getStartElement()) && t.scrollIntoView(!0)) : m.$.scrollTo(n.x, n.y) : (f && (t.selectionStart = f[0], t.selectionEnd = f[1]), t.scrollLeft = n[0], t.scrollTop = n[1]);
                f = n = null;
                r = this.state;
    ...
    function () {
      function a(a, b, c) {
        ...
        d ? c() : (a = CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile || b + "filter/default.js"), CKEDITOR.scriptLoader.load(a, c, null, !0));
        return !d
      }
        ...
        init: function (e) {
          function b(a) {
            var b = CKEDITOR.plugins.pastefromword && CKEDITOR.plugins.pastefromword.images,
              c, d = [];
            if (b && a.editor.filter.check("img[src]") && (c = b.extractTagsFromHtml(a.data.dataValue),
                0 !== c.length && (b = b.extractFromRtf(a.data.dataTransfer["text/rtf"]), 0 !== b.length && (CKEDITOR.tools.array.forEach(b, function (a) {
          ...
          e.on("paste", function (b) {
            var g = b.data,
              h = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ? g.dataTransfer.getData("text/html", !0) : null,
              m = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ?
              g.dataTransfer.getData("text/rtf") : null,
              h = h || g.dataValue,
              f = {
                dataValue: h,
                dataTransfer: {
              ...
              m = /<meta\s*name=(?:\"|\')?generator(?:\"|\')?\s*content=(?:\"|\')?microsoft/gi.test(h) || m.test(h);
            if (h && (c || m) && (!1 !== e.fire("pasteFromWord", f) || c)) {
              g.dontFilter = !0;
              var l = a(e, d, function () {
                if (l) e.fire("paste", g);
                else if (!e.config.pasteFromWordPromptCleanup || c || confirm(e.lang.pastefromword.confirmCleanup)) f.dataValue = CKEDITOR.cleanWord(f.dataValue,
                  e), e.fire("afterPasteFromWord", f), g.dataValue = f.dataValue, !0 === e.config.forcePasteAsPlainText ? g.type = "text" : CKEDITOR.env.ie && "allow-word" === e.config.forcePasteAsPlainText && (g.type = "html");
                c = 0
              });
              l && b.cancel()
            }
    ...
    function () {
      var a = {
        ...
        exec: function (a, b) {
          var c = a.lang,
            d = CKEDITOR.tools.keystrokeToString(c.common.keyboard, a.getCommandKeystroke(CKEDITOR.env.ie ? a.commands.paste : this)),
            l = b && "undefined" !== typeof b.notification ? b.notification : !b || !b.from || "keystrokeHandler" === b.from && CKEDITOR.env.ie,
            c = l && "string" === typeof l ? l : c.pastetext.pasteNotification.replace(/%1/, '\x3ckbd aria-label\x3d"' + d.aria + '"\x3e' + d.display + "\x3c/kbd\x3e");
          a.execCommand("paste", {
            type: "text",
            notification: l ? c : !1
          })
      ...
      commands: {
        removeformat: {
          exec: function (a) {
            for (var e = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), c = CKEDITOR.plugins.removeformat.filter, d = a.getSelection().getRanges(), l = d.createIterator(), k = function (a) {
                return a.type ==
                  CKEDITOR.NODE_ELEMENT
              }, g; g = l.getNextRange();) {
              g.collapsed || g.enlarge(CKEDITOR.ENLARGE_ELEMENT);
              var h = g.createBookmark(),
                m = h.startNode,
                f = h.endNode,
                n = function (b) {
                  for (var d = a.elementPath(b), f = d.elements, g = 1, h;
                    (h = f[g]) && !h.equals(d.block) && !h.equals(d.blockLimit); g++) e.test(h.getName()) && c(a, h) && b.breakParent(h)
                };
              n(m);
              if (f)
                for (n(f), m = m.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); m && !m.equals(f);)
                  if (m.isReadOnly()) {
                    if (m.getPosition(f) & CKEDITOR.POSITION_CONTAINS) break;
                    m = m.getNext(k)
                  } else n = m.getNextSourceNode(!1,
                    CKEDITOR.NODE_ELEMENT), "img" == m.getName() && m.data("cke-realelement") || !c(a, m) || (e.test(m.getName()) ? m.remove(1) : (m.removeAttributes(b), a.fire("removeFormatCleanup", m))), m = n;
              g.moveToBookmark(h)
            }
            a.forceNextSelectionCheck();
    ...
    CKEDITOR.config.removeFormatTags = "b,big,cite,code,del,dfn,em,font,i,ins,kbd,q,s,samp,small,span,strike,strong,sub,sup,tt,u,var", CKEDITOR.config.removeFormatAttributes = "class,style,lang,width,height,align,hspace,valign", CKEDITOR.plugins.add("resize", {
      init: function (a) {
        function e(b) {
          var d = h.width,
            e = h.height,
            k = d + (b.data.$.screenX - g.x) * ("rtl" == l ? -1 : 1);
          b = e + (b.data.$.screenY - g.y);
          m && (d = Math.max(c.resize_minWidth, Math.min(k, c.resize_maxWidth)));
          f && (e = Math.max(c.resize_minHeight, Math.min(b, c.resize_maxHeight)));
          a.resize(m ? d : null, e)
        }
        ...
        void 0 === c.resize_minWidth && (c.resize_minWidth =
          750);
        void 0 === c.resize_minHeight && (c.resize_minHeight = 250);
        if (!1 !== c.resize_enabled) {
          var k = null,
            g, h, m = ("both" == c.resize_dir || "horizontal" == c.resize_dir) && c.resize_minWidth != c.resize_maxWidth,
            f = ("both" == c.resize_dir || "vertical" == c.resize_dir) && c.resize_minHeight != c.resize_maxHeight,
            n = CKEDITOR.tools.addFunction(function (d) {
              ...
              c.resize_minHeight >
                h.height && (c.resize_minHeight = h.height);
          ...
          a.on("uiSpace", function (b) {
            if ("bottom" == b.data.space) {
              ...
              var e = '\x3cspan id\x3d"' + d + '" class\x3d"cke_resizer' + c + " cke_resizer_" + l + '" title\x3d"' +
                CKEDITOR.tools.htmlEncode(a.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event)"\x3e' + ("ltr" == l ? "◢" : "◣") + "\x3c/span\x3e";
      ...
      onLoad: function () {
        var a = function (a) {
          var b = this._,
            c = b.menu;
          b.state !== CKEDITOR.TRISTATE_DISABLED && (b.on && c ? c.hide() : (b.previousState =
            b.state, c || (c = b.menu = new CKEDITOR.menu(a, {
              panel: {
                className: "cke_menu_panel",
                attributes: {
      ...
      onLoad: function (a) {
        ...
        "moono-lisa" == (CKEDITOR.skinName ||
          a.config.skin) && CKEDITOR.document.appendStyleSheet(this.path + "skins/" + CKEDITOR.skin.name + "/scayt.css");
      ...
      init: function (a) {
        ...
        a.ui.add("Scayt", CKEDITOR.UI_MENUBUTTON, {
          ...
          onMenu: function () {
            ...
            c && !CKEDITOR.plugins.scayt.isNewUdSupported(c) &&
        ...
        a.contextMenu && a.addMenuItems && (a.contextMenu.addListener(function (b, c) {
          var d = a.scayt,
            h, m;
          d && (m = d.getSelectionNode()) && (h = e.menuGenerator(a, m), d.showBanner("." + a.contextMenu._.definition.panel.className.split(" ").join(" .")));
          return h
      ...
      addMenuItems: function (a) {
        ...
        for (var c = a.config.scayt_contextMenuItemsOrder.split("|"), d = 0; d < c.length; d++) c[d] = "scayt_" + c[d];
        if ((c = ["grayt_description", "grayt_suggest", "grayt_control"].concat(c)) && c.length)
          for (d = 0; d < c.length; d++) a.addMenuGroup(c[d], d - 10);
      ...
      bindEvents: function (a) {
          ...
          l = function () {
            ...
            c.attachListener(c, "focus", function (c) {
              ...
              if ((b || c) && a._.savedSelection) {
                ...
                for (var g = 0; g < c.length; g++) f = c[g], "string" === typeof f.startContainer.$.nodeValue && (e = f.startContainer.getText().length, (e < f.startOffset || e < f.endOffset) && a.unlockSelection(!1))
              }
            }, this, null, -10)
          },
          k = function () {
        ...
        a.on("readOnly", function (b) {
          var c;
          b && (c = a.scayt, !0 === b.editor.readOnly ? c && c.fire("removeMarkupInDocument", {}) : c ? e.reloadMarkup(c) : "wysiwyg" == b.editor.mode && !0 === e.state.scayt[b.editor.name] &&
        ...
        a.on("reloadMarkupScayt", function (b) {
          ...
          k && setTimeout(function () {
            f && (c.selectionNode = a.plugins.language.getCurrentLangElement(a), c.selectionNode = c.selectionNode && c.selectionNode.$ || null);
      ...
      parseConfig: function (a) {
        ...
        if (a.config.scayt_disableOptionsStorage) {
          var e = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ? [a.config.scayt_disableOptionsStorage] : void 0,
            ...
            g = CKEDITOR.tools.indexOf;
          a.config.scayt_disableOptionsStorage = function (a) {
            for (var b = [], c = 0; c < a.length; c++) {
              var e = a[c],
                p = !!k(a, "options");
              if (!k(d, e) || p && k(l, function (a) {
                  if ("lang" === a) return !1
                })) return;
              k(l, e) && l.splice(g(l, e), 1);
      ...
      addRule: function (a) {
        var e = CKEDITOR.plugins.scayt,
          ...
          g = function (b) {
            var c = !0;
            a.scayt && (b.hasAttribute(e.options.data_attribute_name) ||
              b.hasAttribute(e.options.problem_grammar_data_attribute)) && (c = !1);
            return c
          };
        d && d.push(k);
        b && b.addRules({
        ...
        if (0 < e.length && "no_any_suggestions" !== e[0])
          if (b)
            for (b =
              ...
              for (b = 0; b < e.length; b++) h = "grayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[b].replace(" ", "_"), a.addCommand(h, this.createCommand(CKEDITOR.plugins.scayt.suggestions[b], l, k)), a.addMenuItem(h, {
                label: e[b],
                command: h,
                group: "grayt_suggest",
                order: b + 1
            ...
            label: g.getLocal("btn_noSuggestions") || "no_scayt_suggest",
      ...
      menuGenerator: function (a, e) {
        var b = a.scayt,
          ...
          k = e.getAttribute(b.getLangAttribute()) || b.getLang(),
          g, h, m;
        g = b.isScaytNode(e);
        h = b.isGraytNode(e);
        g ? (c = c.scayt, d = e.getAttribute(b.getScaytNodeAttributeName()), b.fire("getSuggestionsList", {
          lang: k,
          word: d
        }), d = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions,
          g)) : h && (c = c.grayt, d = e.getAttribute(b.getGraytNodeAttributeName()), m = b.getProblemDescriptionText(d, k), c.grayt_problemdescription && m && (c.grayt_problemdescription.label = m), b.fire("getGrammarSuggestionsList", {
          lang: k,
          phrase: d
        }), d = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, g));
        if (g && "off" == a.config.scayt_contextCommands) return d;
        for (var f in c) g && -1 == CKEDITOR.tools.indexOf(l, f.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || h && "grayt_problemdescription" !== f && -1 == CKEDITOR.tools.indexOf(l,
          f.replace("grayt_", "")) && "all" != a.config.scayt_contextCommands || (d[f] = "undefined" != typeof c[f].state ? c[f].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof c[f].verification || c[f].verification(a) || delete d[f], a.addCommand(f, {
          exec: c[f].exec
        }), a.addMenuItem(f, {
          label: a.lang.scayt[c[f].label] || c[f].label,
          command: f,
          group: c[f].group,
          order: c[f].order
        }));
        ...
        this.loadScaytLibrary(a, function (a) {
          ...
          if (l) {
            ...
            try {
              ...
              e.alarmCompatibilityMessage(), delete l.charsToObserve, k = d(l)
            }
            k.subscribe("suggestionListSend", function (a) {
              for (var b = {}, c = [], d = 0; d < a.suggestionList.length; d++) b["word_" + a.suggestionList[d]] || (b["word_" + a.suggestionList[d]] =
                a.suggestionList[d], c.push(a.suggestionList[d]));
              CKEDITOR.plugins.scayt.suggestions = c
            });
            k.subscribe("selectionIsChanged", function (b) {
              a.getSelection().isLocked && "restoreSelection" !== b.action && a.lockSelection();
      ...
      "scaytDialog" !== e && "checkspell" !== e && (a.on("show", function (a) {
        a = a.sender && a.sender.getParentEditor();
        var c = CKEDITOR.plugins.scayt,
          d = a.scayt;
        d && c.state.scayt[a.name] && d.setMarkupPaused && d.setMarkupPaused(!0)
        ...
        a[e] = CKEDITOR.tools.override(a[e], function (a) {
          return function (c) {
            var d = c.editor.scayt,
              ...
              k = c.contents,
              g = null;
            CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state.scayt[c.editor.name] && c.editor.scayt && (this.contents = d.removeMarkupFromString(e) || "", c.contents = d.removeMarkupFromString(k) || "");
      ...
      init: function (a) {
        ...
        a.addCommand("specialchar", {
          exec: function () {
            var b = a.langCode,
              b = e.availableLangs[b] ? b : e.availableLangs[b.replace(/-.*/, "")] ? b.replace(/-.*/, "") : "en";
            CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(e.path + "dialogs/lang/" +
              b + ".js"), function () {
        ...
        init: function (a) {
          ...
          a.on("stylesSet", function (b) {
            if (b = b.data.styles) {
              for (var g, h, m, f = 0, n = b.length; f < n; f++)(g = b[f], a.blockless && g.element in CKEDITOR.dtd.$block || "string" == typeof g.type && !CKEDITOR.style.customHandlers[g.type] || (h = g.name, g = new CKEDITOR.style(g), a.filter.customConfig && !a.filter.check(g))) || (g._name = h, g._.enterMode = e.enterMode, g._.type = m = g.assignedTo || g.type, g._.weight =
                f + 1E3 * (m == CKEDITOR.STYLE_OBJECT ? 1 : m == CKEDITOR.STYLE_BLOCK ? 2 : 3), c[h] = g, d.push(g), l.push(g));
              d.sort(function (a, b) {
          ...
          a.ui.addRichCombo("Styles", {
            ...
            init: function () {
              var a, c, e, m, f, l;
              f = 0;
              for (l = d.length; f < l; f++) a = d[f], c = a._name, m = a._.type, m != e && (this.startGroup(b["panelTitle" + String(m)]),
                e = m), this.add(c, a.type == CKEDITOR.STYLE_OBJECT ? c : a.buildPreview(), c);
              this.commit()
            },
            onClick: function (b) {
              a.focus();
            ...
            onRender: function () {
              a.on("selectionChange", function (b) {
                ...
                for (var e = 0, m = b.length, f; e < m; e++) {
                  f = b[e];
                  for (var l in c)
            ...
            onOpen: function () {
              ...
              for (var h in c) {
                var m = c[h],
                  f = m._.type;
                m.checkApplicable(d, a, a.activeFilter) ? e[f]++ : this.hideItem(h);
                m.checkActive(d, a) && this.mark(h)
              }
    ...
    function () {
          ...
          exec: function (b) {
            if (b.editable().hasFocus) {
              ...
              if (e = (new CKEDITOR.dom.elementPath(c.getCommonAncestor(), c.root)).contains({
                ...
                if (h || a)
                  if (h) h = new CKEDITOR.dom.element(h), c.moveToElementEditStart(h), c.checkStartOfBlock() && c.checkEndOfBlock() || c.selectNodeContents(h);
                  else return !0;
                else {
                  for (var m = e.getAscendant("table").$, h = e.getParent().$.cells, m =
                      new CKEDITOR.dom.element(m.insertRow(-1), b.document), f = 0, n = h.length; f < n; f++) m.append((new CKEDITOR.dom.element(h[f], b.document)).clone(!1, !1)).appendBogus();
      ...
      CKEDITOR.plugins.add("tab", {
        init: function (d) {
          for (var l = !1 !== d.config.enableTabKeyTools, k = d.config.tabSpaces || 0,
              g = ""; k--;) g += " ";
          if (g) d.on("key", function (a) {
            9 == a.data.keyCode && (d.insertText(g), a.cancel())
          });
      ...
      for (var b = void 0 === e ? this.getTabIndex() : e, c, d, l, k = 0, g, h = this.getDocument().getBody().getLast(); h = h.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT);) {
        ...
        if (h.isVisible() && !(0 > (g = h.getTabIndex())))
          if (0 >= b) {
            if (c && 0 === g) {
              l = h;
              break
    ...
    function () {
      ...
      function e(b, c) {
        for (var d = x(b) ? b : a(b), e = d[0], f = e.getAscendant("table"), e = e.getDocument(), g = d[0].getParent(), h = g.$.rowIndex, d = d[d.length - 1], k = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = new CKEDITOR.dom.element(f.$.rows[k]), h = c ? h : k, g = c ? g : d, d = CKEDITOR.tools.buildTableMap(f), f = d[h], h = c ? d[h - 1] : d[h + 1], d = d[0].length, e = e.createElement("tr"), k = 0; f[k] && k < d; k++) {
          var m;
          1 < f[k].rowSpan && h && f[k] == h[k] ? (m = f[k], m.rowSpan += 1) : (m = (new CKEDITOR.dom.element(f[k])).clone(), m.removeAttribute("rowSpan"), m.appendBogus(), e.append(m),
            m = m.$);
          k += m.colSpan - 1
        }
      ...
      function b(c) {
        if (c instanceof CKEDITOR.dom.selection) {
          ...
          c.reset();
          for (c = h; c <= k; c++) {
            for (var m = g[c], l = new CKEDITOR.dom.element(f.$.rows[c]), n = 0; n < m.length; n++) {
              var p = new CKEDITOR.dom.element(m[n]),
                r = p.getParent().$.rowIndex;
              1 == p.$.rowSpan ? p.remove() : (--p.$.rowSpan,
                r == c && (r = g[c + 1], r[n - 1] ? p.insertAfter(new CKEDITOR.dom.element(r[n - 1])) : (new CKEDITOR.dom.element(f.$.rows[c + 1])).append(p, 1)));
              n += p.$.colSpan - 1
            }
            e.push(l)
          }
      ...
      function l(b, c) {
        for (var e = x(b) ? b : a(b), f = e[0].getAscendant("table"), g = d(e, 1), e = d(e), h = c ? g : e, k = CKEDITOR.tools.buildTableMap(f), f = [], g = [], e = [], m = k.length, l = 0; l < m; l++) f.push(k[l][h]), g.push(c ? k[l][h - 1] : k[l][h + 1]);
      ...
      function k(b) {
        ...
        for (b = h.length; n < b; n++)
          for (var p = 0, r = h[n].length; p < r; p++) void 0 === k && h[n][p] == f.$ && (k = p), h[n][p] == g.$ && (m = p);
        for (n = k; n <= m; n++)
      ...
      function n(b, c, d) {
        var e = a(b),
          g;
        if ((c ? 1 != e.length : 2 > e.length) || (g = b.getCommonAncestor()) && g.type == CKEDITOR.NODE_ELEMENT && g.is("table")) return !1;
        var h;
        b = e[0];
        ...
        if (c) {
          ...
          try {
            ...
            r = k["up" == c ? n - v : "down" == c ? n + v : n]["left" == c ? p - h : "right" == c ? p + h : p]
          } catch (x) {
            return !1
          }
          if (!r || b.$ == r) return !1;
        ...
        for (c = 0; c < e.length; c++) {
          ...
          var R = h.getParent(),
            ...
            v = Math.max(v, V - p + S);
          r = Math.max(r, R - n + L);
          d || (S = h, (L = S.getBogus()) && L.remove(),
            S.trim(), h.getChildren().count() && (R == K || !N || N.isBlockBoundary && N.isBlockBoundary({
              br: 1
        ...
        J.moveChildren(b);
        b.appendBogus();
        v >= l ? b.removeAttribute("rowSpan") : b.$.rowSpan = r;
        r >= m ? b.removeAttribute("colSpan") : b.$.colSpan = v;
        d = new CKEDITOR.dom.nodeList(g.$.rows);
        e = d.count();
        for (c = e - 1; 0 <= c; c--) g = d.getItem(c), g.$.cells.length || (g.remove(), e++);
        return b
      }
      ...
      function p(b, c) {
        ...
        if (1 < l) {
          n = Math.ceil(l / 2);
          for (var l = Math.floor(l / 2), e = k + n, g = new CKEDITOR.dom.element(g.$.rows[e]), h = f(h, e), p, e = d.clone(), k = 0; k < h.length; k++)
            if (p = h[k], p.parentNode == g.$ && k > m) {
              e.insertBefore(new CKEDITOR.dom.element(p));
              break
            } else p = null;
          p || g.append(e)
        } else
          for (l = n = 1, g = e.clone(), g.insertAfter(e), g.append(e = d.clone()),
            p = f(h, k), m = 0; m < p.length; m++) p[m].rowSpan++;
        e.appendBogus();
        d.$.rowSpan = n;
        e.$.rowSpan = l;
      ...
      function r(b, c) {
        ...
        if (1 < k) e = Math.ceil(k / 2), k = Math.floor(k / 2);
          ...
          for (var k = e = 1, m = [], l = 0; l < g.length; l++) {
            var n = g[l];
            m.push(n[h]);
            1 < n[h].rowSpan && (l += n[h].rowSpan - 1)
          }
          for (g =
            0; g < m.length; g++) m[g].colSpan++
        }
        g = d.clone();
        g.insertAfter(d);
        g.appendBogus();
      ...
      CKEDITOR.plugins.tabletools = {
        ...
        init: function (c) {
          ...
          f("cellProperties", new CKEDITOR.dialogCommand("cellProperties", d({
          ...
          c.addMenuItems && c.addMenuItems({
            tablecell: {
              ...
              getItems: function () {
                ...
                return {
                  ...
                  tablecell_split_vertical: r(b, !0) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
            ...
            tablecell_insertBefore: {
              label: v.cell.insertBefore,
              group: "tablecell",
              command: "cellInsertBefore",
              order: 5
            },
            tablecell_insertAfter: {
              label: v.cell.insertAfter,
              group: "tablecell",
              command: "cellInsertAfter",
              order: 10
            },
            tablecell_delete: {
              label: v.cell.deleteCell,
              group: "tablecell",
              command: "cellDelete",
              order: 15
            },
            ...
            tablecell_merge_right: {
              label: v.cell.mergeRight,
              group: "tablecell",
              command: "cellMergeRight",
              order: 17
            },
            tablecell_merge_down: {
              label: v.cell.mergeDown,
              group: "tablecell",
              command: "cellMergeDown",
              order: 18
            },
            tablecell_split_horizontal: {
              label: v.cell.splitHorizontal,
              group: "tablecell",
              command: "cellHorizontalSplit",
              order: 19
            },
            tablecell_split_vertical: {
              label: v.cell.splitVertical,
              group: "tablecell",
            ...
            tablerow_insertBefore: {
              label: v.row.insertBefore,
              group: "tablerow",
              command: "rowInsertBefore",
              order: 5
            },
            tablerow_insertAfter: {
              label: v.row.insertAfter,
              group: "tablerow",
              command: "rowInsertAfter",
              order: 10
            },
            tablerow_delete: {
              label: v.row.deleteRow,
              group: "tablerow",
              command: "rowDelete",
              order: 15
            },
            ...
            tablecolumn_insertBefore: {
              label: v.column.insertBefore,
              group: "tablecolumn",
              command: "columnInsertBefore",
              order: 5
            },
            tablecolumn_insertAfter: {
              label: v.column.insertAfter,
              group: "tablecolumn",
              command: "columnInsertAfter",
              order: 10
            },
            tablecolumn_delete: {
              label: v.column.deleteColumn,
              group: "tablecolumn",
      ...
      for (e = e || 0; e <= c; e++) {
        l++;
        !k[l] && (k[l] = []);
        for (var g = -1, h = b; h <= (-1 === d ? a[e].cells.length - 1 : d); h++) {
          var m =
            a[e].cells[h];
          if (!m) break;
          for (g++; k[l][g];) g++;
          for (var f = isNaN(m.colSpan) ? 1 : m.colSpan, m = isNaN(m.rowSpan) ? 1 : m.rowSpan, n = 0; n < m && !(e + n > c); n++) {
            k[l + n] || (k[l + n] = []);
            for (var p = 0; p < f; p++) k[l + n][g + p] = a[e].cells[h]
          }
          g += f - 1;
          if (-1 !== d && g >= d) break
        }
    ...
    function () {
      ...
      function e(a, b) {
        ...
        for (c = f; c <= g; c++)
          for (f = l; f <= n; f++) d = new CKEDITOR.dom.element(e[c][f]), d.$ && !d.getCustomData("selected_cell") && (h.push(d), CKEDITOR.dom.element.setMarker(k, d, "selected_cell", !0));
        CKEDITOR.dom.element.clearAllMarkers(k);
        return h
      }
      ...
      function g(b, c, f) {
        ...
        c = c.is("table") ? null : c;
        var h;
        (h = q.active && !q.first) && !(h = c) && (h = b.getSelection().getRanges(), h = 1 < g.length || h[0] &&
          !h[0].collapsed ? !0 : !1);
        if (h) q.first = c || g[0], q.dirty = c ? !1 : 1 !== g.length;
        else if (q.active && c && q.first.getAscendant("table").equals(c.getAscendant("table"))) {
          g = e(q.first, c);
          if (!q.dirty && 1 === g.length && !a(f.data.getTarget())) return d(b, "mouseup" === f.name);
          q.dirty = !0;
          q.last = c;
          l(b, g)
        }
      ...
      function f(b) {
        ...
        function m(a, b, c, d) {
          return ("mousedown" !== a.name || CKEDITOR.tools.getMouseButton(a) !== CKEDITOR.MOUSE_BUTTON_LEFT && d) && ("mouseup" !== a.name || h(a.data.getTarget()) || e(c, d)) ? !1 : !0
        }
        if (b.data.getTarget().getName && ("mouseup" === b.name || !a(b.data.getTarget()))) {
          ...
          m(b, n, p, v) && d(l, !0);
          !q.active && "mousedown" ===
            b.name && CKEDITOR.tools.getMouseButton(b) === CKEDITOR.MOUSE_BUTTON_LEFT && v && (q = {
              active: !0
            }, CKEDITOR.document.on("mouseup", f, null, {
              editor: l
            }));
          (r || v) && g(l, r || v, b);
          "mouseup" === b.name && (CKEDITOR.tools.getMouseButton(b) === CKEDITOR.MOUSE_BUTTON_LEFT && (h(b.data.getTarget()) || e(p, v)) && k(l), q = {
            active: !1
      ...
      function p(a,
        ...
        f.getById("cke_table_copybin") || (l = f.createElement(m), n = f.createElement(m), n.setAttributes({
          ...
          height: "1px",
          overflow: "hidden"
        }), l.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right",
          "-5000px"), l.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), n.append(l), a.editable().append(n), v = a.on("selectionChange", c, null, null, 0), k && (p = h.scrollTop), g.selectNodeContents(l), g.select(), k && (h.scrollTop = p), setTimeout(function () {
          n.remove();
          d.selectBookmarks(e);
          v.removeListener();
          a.fire("unlockSnapshot");
      ...
      v.prototype.insertRow = function (a, b, c) {
        ...
        for (var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, f = c ? [] : this.cells.all, g, h = 0; h < a; h++) g = z(c ? this.cells.all : f, b), g = CKEDITOR.tools.array.filter(g.find("td, th").toArray(), function (a) {
      ...
      v.prototype.insertColumn = function (a) {
        ...
        for (var c = this.cells, d = c.all, e = m(c.first), f = m(c.last), c = 0; c < a; c++) d = d.concat(CKEDITOR.tools.array.filter(w(d), b));
      ...
      var C = {
        onPaste: function (a) {
          ...
          var f = a.editor,
            ...
            n, p;
          !h.length || 1 === h.length && !b(g.getRanges()[0]) && !m || m && !k || (h = h[0].getAscendant("table"), n = new v(u(g, h)), f.once("afterPaste", function () {
            var a;
            if (p) {
              a = new CKEDITOR.dom.element(p[0][0]);
              var b = p[p.length - 1];
              a = e(a, new CKEDITOR.dom.element(b[b.length -
                1]))
            } else a = n.cells.all;
            l(f, a)
          }), k ? (a.stop(), m ? (n.insertRow(1, 1 === m, !0), g.selectElement(n.rows.first)) : (n.emptyCells(), l(f, n.cells.all)), a = n.getTableMap(), p = CKEDITOR.tools.buildTableMap(k), n.insertRow(p.length - a.length), n.insertColumn(c(p) - c(a)), a = n.getTableMap(), this.pasteTable(n, a, p), f.fire("saveSnapshot"), setTimeout(function () {
            f.fire("afterPaste")
          }, 0)) : (d(n.cells.first), f.once("afterPaste", function () {
            f.fire("lockSnapshot");
          ...
          for (m = 0; m < c.length; m++)
            for (h = new CKEDITOR.dom.element(f.$.rows[a.rows.first.$.rowIndex + m]), l = 0; l < c[m].length; l++)
              if (k = new CKEDITOR.dom.element(c[m][l]), d = b[m] && b[m][l] ? new CKEDITOR.dom.element(b[m][l]) : null, k && !k.getCustomData("processed")) {
                ...
                else if (0 === l || c[m][l - 1])(d = 0 !== l ? new CKEDITOR.dom.element(c[m][l - 1]) : null) && h.equals(d.getParent()) ? k.insertAfter(d) : 0 < e ? h.$.cells[e] ? k.insertAfter(new CKEDITOR.dom.element(h.$.cells[e])) : h.append(k) :
                  h.append(k, !0);
          ...
          c.attachListener(c, "keydown", function (a) {
            function c(b, d) {
              ...
              if (k && k.is && k.is(e)) {
                ...
                !l && h && h.is && !h.is("table") && h.getNext() && (l = h.getNext().findOne("td, th"),
                  n = !0);
            ...
            return function (e) {
              ...
              if (d[f] && (g = a.getSelection()) && g.isInTable() && g.isFake)
                if (k = g.getRanges(), m = k[0]._getTableElement(), l = k[k.length -
                    1]._getTableElement(), e.data.preventDefault(), e.cancel(), 8 < f && 46 > f) k[0].moveToElementEditablePosition(h ? m : l, !h), g.selectRanges([k[0]]);
                else {
                  for (e = 0; e < k.length; e++) b(k[e]);
                  (e = c(m, k)) ? k = e: k[0].moveToElementEditablePosition(m);
                  g.selectRanges(k);
                  a.fire("saveSnapshot")
                }
            }
      ...
      CKEDITOR.plugins.add("tableselection", {
        ...
        init: function (a) {
          CKEDITOR.plugins.tableselection.isSupportedEnvironment &&
            ...
            }), a.on("paste", C.onPaste, C), x(a, "rowInsertBefore rowInsertAfter columnInsertBefore columnInsertAfter cellInsertBefore cellInsertAfter".split(" "), function (a, b) {
              l(a, b.selectedCells)
            }), x(a, ["cellMerge", "cellMergeRight", "cellMergeDown"], function (a, b) {
              l(a, [b.commandData.cell])
            }), x(a, ["cellDelete"], function (a) {
              d(a, !0)
            }))
        }
      })
    ...
    function () {
      ...
      CKEDITOR.plugins.add("undo", {
        init: function (c) {
          ...
          f.onChange = function () {
            p.setState(f.undoable() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED);
            r.setState(f.redoable() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED)
          };
      ...
      b.prototype = {
        ...
        update: function (a) {
          if (!this.locked) {
            ...
            for (var b = this.index, d = this.snapshots; 0 < b && this.currentImage.equalsContent(d[b -
                1]);) --b;
    ...
    function () {
      ...
      function b(a, b) {
        ...
        this.lineTpl = (new CKEDITOR.template('\x3cdiv data-cke-lineutils-line\x3d"1" class\x3d"cke_reset_all" style\x3d"{lineStyle}"\x3e\x3cspan style\x3d"{tipLeftStyle}"\x3e\x26nbsp;\x3c/span\x3e\x3cspan style\x3d"{tipRightStyle}"\x3e\x26nbsp;\x3c/span\x3e\x3c/div\x3e')).output({
          lineStyle: CKEDITOR.tools.writeCssText(CKEDITOR.tools.extend({},
            l, this.lineStyle, !0)),
          tipLeftStyle: CKEDITOR.tools.writeCssText(CKEDITOR.tools.extend({}, d, {
            left: "0px",
      ...
      a.prototype = {
        start: function (a) {
          var b = this,
            c = this.editor,
            d = this.doc,
            e, g, k, l, q = CKEDITOR.tools.eventsBuffer(50, function () {
              c.readOnly || "wysiwyg" != c.mode || (b.relations = {}, (g = d.$.elementFromPoint(k, l)) && g.nodeType && (e = new CKEDITOR.dom.element(g), b.traverseSearch(e), isNaN(k + l) || b.pixelSearch(e, k, l), a && a(b.relations, k, l)))
            });
        ...
        traverseSearch: function (a) {
          var b, d, e;
          do
            if (e = a.$["data-cke-expando"],
              !(e && e in this.relations)) {
        ...
        pixelSearch: function () {
          function a(d, e, g, h, k) {
            for (var l = 0, q; k(g);) {
              g += h;
              if (25 == ++l) break;
              if (q = this.doc.$.elementFromPoint(e, g))
                if (q == d) l = 0;
                else if (b(d, q) && (l = 0, c(q = new CKEDITOR.dom.element(q)))) return q
            }
          }
          ...
          return function (b, d, e) {
            var g = this.win.getViewPaneSize().height,
              k = a.call(this, b.$, d, e, -1, function (a) {
                return 0 < a
              });
            d = a.call(this, b.$, d, e, 1, function (a) {
              return a < g
            });
            if (k)
              for (this.traverseSearch(k); !k.getParent().equals(b);) k = k.getParent();
            if (d)
              for (this.traverseSearch(d); !d.getParent().equals(b);) d = d.getParent();
            for (; k || d;) {
              k && (k = k.getNext(c));
      ...
      e.prototype = {
        locate: function () {
          ...
          return function (b) {
            var c;
            this.locations = {};
            for (var d in b) c = b[d], c.elementRect = c.element.getClientRect(), c.type & CKEDITOR.LINEUTILS_BEFORE && this.store(d, CKEDITOR.LINEUTILS_BEFORE, a(c, CKEDITOR.LINEUTILS_BEFORE)), c.type & CKEDITOR.LINEUTILS_AFTER && this.store(d, CKEDITOR.LINEUTILS_AFTER, a(c, CKEDITOR.LINEUTILS_AFTER)), c.type &
              CKEDITOR.LINEUTILS_INSIDE && this.store(d, CKEDITOR.LINEUTILS_INSIDE, (c.elementRect.top + c.elementRect.bottom) / 2);
        ...
        sort: function () {
          ...
          return function (e, g) {
            ...
            for (var k in a)
              for (var l in a[k])
                if (c = Math.abs(e - a[k][l]), b.length) {
                  for (d = 0; d < b.length; d++)
                    if (c < b[d].dist) {
                      b.splice(d, 0, {
                        uid: +k,
      ...
      b.prototype = {
        ...
        getStyle: function (a, b) {
          ...
          this.inline ?
            e.left = c.elementRect.left - this.rect.relativeX : (0 < c.elementRect.left ? e.left = this.rect.left + c.elementRect.left : (e.width += c.elementRect.left, e.left = this.rect.left), 0 < (c = e.left + e.width - (this.rect.left + this.winPane.width)) && (e.width -= c));
      ...
      CKEDITOR.plugins.widgetselection = {
        ...
        addFillers: function (e) {
          ...
          if (!this.isWholeContentSelected(e) && 0 < e.getChildCount()) {
            ...
            d && d.type == CKEDITOR.NODE_ELEMENT && !d.isEditable() && (this.endFiller = this.createFiller(!0), e.append(this.endFiller, 0));
    ...
    function () {
      ...
      function d(a, b) {
        ...
        function d(b, c, e) {
          ...
          a._.upcasts.splice(f, 0, [CKEDITOR.tools.bind(b,
            c), c.name, e])
        }
        var e = b.upcast,
      ...
      function g(a) {
        if ("undefined" != typeof a.attributes && a.attributes["data-widget"]) {
          var b = h(a),
            c = m(a),
            d = !1;
          b && b.value && b.value.match(/^\s/g) && (b.parent.attributes["data-cke-white-space-first"] = 1, b.value = b.value.replace(/^\s/g,
            "\x26nbsp;"), d = !0);
      ...
      function f(a, b, c) {
        ...
        a = d[b];
        a || (a = c.allowedContent ?
          new CKEDITOR.filter(c.allowedContent) : this.editor.filter.clone(), d[b] = a, c.disallowedContent && a.disallow(c.disallowedContent));
        return a
      }
            ...
            if (l = c.length) {
              ...
              for (f = d.length; k < f; ++k)
                if (!1 ===
                  d[k](a)) return;
              for (k = 0; k < l; ++k)
                if (f = c[k], h = {}, g = f[0](a, h)) return g instanceof CKEDITOR.htmlParser.element && (a = g), a.attributes["data-cke-widget-data"] = encodeURIComponent(JSON.stringify(h)), a.attributes["data-cke-widget-upcasted"] = 1, b.push([a, f[1]]), !1
            }
          }
        }
      }
      ...
      function A(a) {
        ...
        b.on("dragstart", function (c) {
          var d = c.data.target;
          e.isDomDragHandler(d) && (d = a.getByElement(d), c.data.dataTransfer.setData("cke/widget-id", d.id), b.focus(), d.focus())
        });
        b.on("drop", function (c) {
          var d = c.data.dataTransfer,
            ...
            d = b.createRange();
          "" !== e && f === CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? c.cancel() : "" !== e && f == CKEDITOR.DATA_TRANSFER_INTERNAL && (e = a.instances[e]) && (d.setStartBefore(e.wrapper), d.setEndAfter(e.wrapper), c.data.dragRange =
      ...
      function z(a) {
        ...
        b.on("contentDom", function () {
          ...
          c.attachListener(d, "mousedown", function (c) {
            ...
            g = 0;
            f && (f.inline && d.type == CKEDITOR.NODE_ELEMENT && d.hasAttribute("data-cke-widget-drag-handler") ? (g = 1, a.focused != f && b.getSelection().removeAllRanges()) : e.getNestedEditable(f.wrapper, d) ? f = null : (c.data.preventDefault(), CKEDITOR.env.ie || f.focus()))
          });
        ...
        b.on("doubleclick", function (b) {
          ...
          if (c && !e.getNestedEditable(c.wrapper, b.data.element)) return c.fire("doubleclick", {
      ...
      function w(a) {
        a.editor.on("key", function (b) {
          ...
          c ? e = c.fire("key", {
            ...
            d = d.editor.createRange(), d.selectNodeContents(b), c && d.setEndAt(c, CKEDITOR.POSITION_BEFORE_START), d.select(), e = !1) : 8 == c || 46 == c ? (e = d.editor.getSelection().getRanges(), d = e[0], e = !(1 == e.length && d.collapsed && d.checkBoundaryOfElement(b, CKEDITOR[8 == c ? "START" : "END"]))) : e = void 0);
          return e
        }, null, null, 1)
      }
      ...
      function y(a) {
        ...
        b.on("selectionChange", function (c) {
          var d = (c = e.getNestedEditable(b.editable(), c.data.selection.getStartElement())) && a.getByElement(c),
            f = a.widgetHoldingFocusedEditable;
          f ? f === d && f.focusedEditable.equals(c) || (q(a, f, null), d && c && q(a, d, c)) : d && c && q(a, d, c)
        });
        ...
        b.on("blur", function () {
          var b;
          (b = a.focused) && l(a, b);
          (b = a.widgetHoldingFocusedEditable) && q(a, b, null)
        })
      }
      ...
      function B(a) {
        ...
        b.on("toDataFormat", function (b) {
          var d = CKEDITOR.tools.getNextNumber(),
            f = [];
          b.data.downcastingSessionId = d;
          c[d] = f;
          b.data.dataValue.forEach(function (b) {
            ...
            if ("data-cke-widget-white-space" in c) {
              ...
              g.parent.attributes["data-cke-white-space-last"] && (g.value = g.value.replace(/&nbsp;$/g, " "))
            }
            if ("data-cke-widget-id" in c) {
              if (c = a.instances[c["data-cke-widget-id"]]) d =
                b.getFirst(e.isParserWidgetElement), f.push({
                  wrapper: b,
                  element: d,
                  widget: c,
                  editables: {}
        ...
        b.on("toDataFormat", function (a) {
          if (a.data.downcastingSessionId) {
            ...
            for (var b, d, e, f, g, h; b = a.shift();) {
              d = b.widget;
              e = b.element;
              f = d._.downcastFn && d._.downcastFn.call(d,
                e);
      ...
      function G(a) {
        ...
        b.on("paste", function (a) {
          a = a.data;
          a.dataValue = a.dataValue.replace(U, u);
          a.range && (a = e.getNestedEditable(b.editable(), a.range.startContainer)) && (a = CKEDITOR.filter.instances[a.data("cke-filter")]) && b.setActiveFilter(a)
        });
      ...
      function H(a, b) {
        ...
        if (!d.getById("cke_copybin")) {
          ...
          var k = c.on("selectionChange", I, null, null, 0),
            l = a.repository.on("checkSelection", I, null, null, 0);
      ...
      function S(a) {
        if (a.draggable) {
          ...
          a.wrapper.on("mouseenter",
            a.updateDragHandlerPosition, a);
          setTimeout(function () {
            a.on("data", a.updateDragHandlerPosition, a)
          }, 50);
          if (!a.inline && (d.on("mousedown", L, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version)) d.on("dragstart", function (a) {
            a.data.preventDefault(!0)
          });
      ...
      function L(a) {
        function b() {
          ...
          CKEDITOR.tools.isEmpty(f.visible) || (d = e.getRange(d[0]),
            this.focus(), g.fire("drop", {
              dropRange: d,
        ...
        if (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT) {
          ...
          var n = c.greedySearch(),
            p = CKEDITOR.tools.eventsBuffer(50, function () {
              l = d.locate(n);
              k = d.sort(m, 1);
              k.length && (e.prepare(n, l), e.placeLine(k[0]),
                e.cleanup())
            });
      ...
      a.prototype = {
        ...
        destroy: function (a, b) {
          this.widgetHoldingFocusedEditable === a && q(this, a, null, b);
          a.destroy(b);
      ...
      e.prototype = {
        ...
        initEditable: function (a, c) {
          ...
          return d && d.is(CKEDITOR.dtd.$editable) ? (d = new b(this.editor, d, {
            ...
            }), d.filter && d.data("cke-filter", d.filter.id), d.addClass("cke_widget_editable"), d.removeClass("cke_widget_editable_focused"), c.pathName && d.data("cke-display-name", c.pathName), this.editor.focusManager.add(d), d.on("focus", D, this), CKEDITOR.env.ie && d.on("blur", J, this), d._.initialSetData = !0, d.setData(d.getHtml()), !0) : !1
        },
        _findOneNotNested: function (a) {
          a = this.wrapper.find(a);
          for (var b, c, d = 0; d < a.count(); d++)
            if (b =
              a.getItem(d), c = b.getAscendant(e.isDomWidgetWrapper), this.wrapper.equals(c)) return b;
          return null
        },
        isInited: function () {
    ...
    function () {
      ...
      a.prototype = {
        ...
        _removeTask: function (a) {
          var c = CKEDITOR.tools.indexOf(this._tasks, a); - 1 !== c && (a._doneWeight && (this._doneWeights -= a._doneWeight), this._totalWeights -= a._weight, this._tasks.splice(c, 1), this.update())
        },
      ...
      CKEDITOR.tools.extend(CKEDITOR.fileTools, {
        addUploadWidget: function (a, e, b) {
          ...
          if (b.fileToElement) a.on("paste", function (b) {
            ...
            if (!b.dataValue && l)
              for (p = 0; p < l; p++)
                if (n = h.getFile(p), !g.supportedTypes || c.isTypeSupported(n, g.supportedTypes)) {
                  var r = g.fileToElement(n);
                  n = d.create(n, void 0, g.loaderType);
                  r && (n[f](g.uploadUrl, g.additionalRequestParameters), CKEDITOR.fileTools.markElement(r, e, n.id), "loadAndUpload" != f && "upload" != f || g.skipNotifications || CKEDITOR.fileTools.bindNotifications(a, n), b.dataValue += r.getOuterHtml())
                }
          }, null, null, l);
          CKEDITOR.tools.extend(b, {
            ...
            init: function () {
              var b = this,
                ...
                f, n;
              e.on("update", function (d) {
                if (b.wrapper && b.wrapper.getParent()) {
                  a.fire("lockSnapshot");
                  d = "on" + l(e.status);
                  if ("function" !== typeof b[d] || !1 !== b[d](e)) n = "cke_upload_" + e.status, b.wrapper && n != f && (f && b.wrapper.removeClass(f), b.wrapper.addClass(n), f = n), "error" != e.status && "abort" != e.status || a.widgets.del(b);
                  a.fire("unlockSnapshot")
        ...
        bindNotifications: function (a, e) {
          function b() {
            ...
            if (!c || c.isFinished()) c = a._.uploadWidgetNotificaionAggregator = new CKEDITOR.plugins.notificationAggregator(a, a.lang.uploadwidget.uploadMany, a.lang.uploadwidget.uploadOne), c.once("finished",
              function () {
                var b = c.getTaskCount();
                0 === b ? c.notification.hide() : c.notification.update({
          ...
          e.on("update", function () {
            !d && e.uploadTotal && (b(), d = c.createTask({
              weight: e.uploadTotal
            }));
            d && "uploading" == e.status && d.update(e.uploaded)
          });
    ...
    function () {
      ...
      function e(c) {
        ...
        b += 1;
        return "image-" + CKEDITOR.tools.array.map(d, a).join("") + "-" + b + "." + c
      }
      var b = 0;
            ...
            l && (b.addUploadWidget(a, "uploadimage", {
              ...
              if (k.data.dataValue.match(/<img[\s\S]+data:/i)) {
                ...
                var g = document.implementation.createHTMLDocument(""),
                  g = new CKEDITOR.dom.element(g.body),
                  h, m, f;
                g.data("cke-editable", 1);
                g.appendHtml(k.dataValue);
                h = g.find("img");
                for (f = 0; f < h.count(); f++) {
                  m = h.getItem(f);
                  var n = m.getAttribute("src"),
                    p = n && "data:" == n.substring(0, 5),
                    r = null === m.data("cke-realelement");
                  p && r && !m.data("cke-upload-id") && !m.isReadOnly(1) && (p = (p = n.match(/image\/([a-z]+?);/i)) && p[1] || "jpg", n = a.uploadRepository.create(n, e(p)), n.upload(l), b.markElement(m, "uploadimage", n.id), b.bindNotifications(a, n))
                }
    ...
    function () {
      function a(a) {
        function b(a) {
          var c = !1;
          f.attachListener(f, "keydown", function () {
            var b = g.getBody().getElementsByTag(a);
            if (!c) {
        ...
        var c = this.editor,
          g = a.document,
          h = g.body,
          m = g.getElementById("cke_actscrpt");
        m && m.parentNode.removeChild(m);
        (m = g.getElementById("cke_shimscrpt")) && m.parentNode.removeChild(m);
        (m = g.getElementById("cke_basetagscrpt")) && m.parentNode.removeChild(m);
        h.contentEditable = !0;
        ...
        var f = this;
        CKEDITOR.env.ie &&
          !CKEDITOR.env.edge && g.getDocumentElement().addClass(g.$.compatMode);
        ...
        if (CKEDITOR.env.webkit || CKEDITOR.env.ie && 10 < CKEDITOR.env.version) g.getDocumentElement().on("mousedown", function (a) {
        ...
        CKEDITOR.env.iOS &&
          this.attachListener(g, "touchend", function () {
            a.focus()
          });
      ...
      CKEDITOR.plugins.add("wysiwygarea", {
        init: function (a) {
          ...
          a.addMode("wysiwyg", function (b) {
            ...
            var g = "document.open();" + (CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain + ")();" : "") + "document.close();",
              g = CKEDITOR.env.air ? "javascript:void(0)" : CKEDITOR.env.ie && !CKEDITOR.env.edge ? "javascript:void(function(){" + encodeURIComponent(g) + "}())" : "",
              h = CKEDITOR.dom.element.createFromHtml('\x3ciframe src\x3d"' + g + '" frameBorder\x3d"0"\x3e\x3c/iframe\x3e');
            h.setStyles({
              width: "100%",
              height: "100%"
            });
        ...
        proto: {
          setData: function (a, c) {
            ...
            if (c) this.setHtml(a), this.fixInitialSelection(), e.fire("dataReady");
              ...
              h || (f += CKEDITOR.tools.buildStyleHtml(e.config.contentsCss));
              var n = g.baseHref ? '\x3cbase href\x3d"' +
                g.baseHref + '" data-cke-temp\x3d"1" /\x3e' : "";
              ...
              CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (g += '\x3cscript id\x3d"cke_shimscrpt"\x3ewindow.parent.CKEDITOR.tools.enableHtml5Elements(document)\x3c/script\x3e');
              n && CKEDITOR.env.ie && 10 > CKEDITOR.env.version && (g += '\x3cscript id\x3d"cke_basetagscrpt"\x3evar baseTag \x3d document.querySelector( "base" );baseTag.href \x3d baseTag.href;\x3c/script\x3e');
