(function () {
  ...
  var m = function (a) {
      var b = [];
      if (Array.prototype.indexOf) return a = b.indexOf(a), "number" == typeof a ? a : -1;
    ...
    N = function (a) {
      ...
      for (c in a)
        if (a.hasOwnProperty(c)) {
          var d = a[c];
          void 0 !== d && d === d && null !== d && "[object Object]" !== d.toString() && (b.push(c), b.push(E(String(d))))
        } a = b.join("*");
      return ["1", M(a), a].join("*")
    },
    M = function (a, b) {
      ...
      G = b;
      b = 4294967295;
      for (c = 0; c < a.length; c++) b = b >>> 8 ^ G[(b ^ a.charCodeAt(c)) & 255];
  ...
  function U(a, b) {
    if (b && b.action) {
      ...
      } else "post" === c && (a = S(a, b.action), r.test(a) && (b.action = a))
    }
  }
  var W = function (a) {
      try {
...
(function () {
  ...
  var Fa, Ga, fb, Ab, ja = /^https?:\/\/[^/]*cdn\.ampproject\.org\//,
    ...
    da = function (a) {
      ...
      if (b && !1 !== a[Kd] && (void 0 === Ab && (b = (b = De.get()) && b._ga || void 0) && (Ab = b, J(81)), void 0 !== Ab)) return a[Q] || (a[Q] = Ab),
      !1;
      if (a[Kd]) {
        J(67);
        ...
        if (void 0 !== Ab) a[Q] || (a[Q] = Ab);
          ...
          a: if (b = String(a[W] || xa()), c = String(a[Yb] || "/"), d = Ca(String(a[U] || "_ga")), b = na(d, b, c), !b || jd.test(b)) b = !0;
  ...
  var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
    ...
    Jc = function (a, b) {
      ...
      if (a.get(Hd) && (c = be("_ga", a.get(cc)), d = be("_gl", a.get(cc)), e = De.get(a.get(cc)), g = e._ga, d && 0 < d.indexOf("_ga") && !g && J(30), c || g))
